...
| `blr` | Blang | ブラン語 | Austroasiatic (Palaungic, Waic) | ~40K (Blang nationality ~120K) |
...
| `rbb` | De'ang (Rumai) | ドアン語（汝買） | Austroasiatic (Palaungic) | ~20K in China, more in Myanmar |
...
| `srh` | Sarikoli | サリコリ語 | Indo-European (Eastern Iranian, Pamir) | ~20K |
