...
| `ak` | Akan | アカン語 | Niger-Congo (Kwa) | ~9M (Akan ~22M) |
| `akb` | Batak Angkola | バタック・アンコラ語 | Austronesian | ~750K |
| `ake` | Akawaio | アカワイオ語 | Cariban | ~5–6.4K |
| `akk` | Akkadian | アッカド語 | Afro-Asiatic (Semitic, East) | Extinct |
| `ale` | Aleut | アリュート語 | Eskimo-Aleut (Aleut) | ~150 (severely endangered) |
| `aln` | Gheg Albanian | ゲグ・アルバニア語 | Indo-European (Albanian, Gheg — one of the two primary dialect groups alongside Tosk) | ~4.1M |
...
| `aoc` | Pemón | ペモン語 | Cariban | ~35–45K (Venezuela) |
...
| `atb` | Zaiwa | ザイワ語 | Sino-Tibetan (Burmish) | ~100K |
...
| `bor` | Bororo | ボロロ語 | Macro-Jê (Bororoan) | ~1–1.5K (unconfirmed) |
| `bpy` | Bishnupriya Manipuri | ビシュヌプリヤ・マニプリ語 | Indo-European | ~120–140K |
...
| `cag` | Nivaclé | ニバクレ語 | Matacoan | ~12K (Paraguay, Argentina) |
| `cak` | Kaqchikel | カクチケル語 | Mayan (Quichean, Kaqchikelan) | ~400–500K |
...
| `cia` | Cia-Cia | チアチア語 | Austronesian (Malayo-Polynesian, Celebic, Muna-Buton) | ~80–105K (Ethnologue 6b: threatened) |
| `cic` | Chickasaw | チカショー語 | Muskogean | ~50 (UNESCO: critically endangered) |
| `cja` | Western Cham | 西チャム語 | Austronesian (Malayo-Polynesian, Chamic) | ~190K |
| `cjm` | Eastern Cham | 東チャム語 | Austronesian (Malayo-Polynesian, Chamic) | ~73–132K |
| `cjs` | Shor | ショル語 | Turkic (Siberian) | ~2.8K L1 |
| `cjy` | Jin | 晋語 | Sinitic (Jin) | ~63M |
...
| `cni` | Asháninka | アシャニンカ語 | Arawakan (Southern, Kampan) | ~25–50K |
...
| `crt` | Chorote | チョローテ語 | Matacoan | ~3K (Argentina, Paraguay, Bolivia) |
...
| `de_ch` | Swiss Standard German | スイス標準ドイツ語 | Germanic | ~5M |
...
| `djk` | Aukan | アウカン語 | English-based creole | ~30K (Suriname) + ~15K (French Guiana) |
| `djr` | Djambarrpuyngu | ジャンバルプイング語 | Pama-Nyungan (Yolŋu, Dhuwal) | ~3.8K |
| `dlg` | Dolgan | ドルガン語 | Turkic (Siberian) | ~4–5K |
| `dng` | Dungan | 東干語 | Sino-Tibetan (Sinitic, Mandarin — Central Plains/Lanyin) | ~110–150K |
| `dnj` | Dan | ダン語 | Niger-Congo (Mande, Eastern, Southern) | ~1.6M |
| `doi` | Dogri | ドグリ語 | Indo-Aryan (Northwestern, Pahari) | ~2.6M |
| `drs` | Gedeo | ゲデオ語 | Afro-Asiatic | ~1.8–2M |
| `dru` | Rukai | ルカイ語 | Austronesian (Formosan, Rukai — own primary branch) | ~10K |
| `dsb` | Lower Sorbian | 低地ソルブ語 | Slavic (West, Sorbian) | ~7K |
| `dsh` | Daasanach | ダーサナック語 | Afro-Asiatic | ~50–65K |
| `dta` | Daur | ダグール語 | Mongolic | ~96K |
| `dtp` | Kadazan-Dusun | カダザン・ドゥスン語 | Austronesian (Sabahan) | ~570K (Kadazan + Dusun varieties combined) |
| `dtp_kzj` | Coastal Kadazan | 沿岸カダザン語 | Austronesian (Dusunic, Sabahan) | ~150K |
| `dty` | Dotyali | ドティアーリ語 | Indo-European (Indo-Aryan, Northern, Pahari) | ~800K |
| `dur` | Dii | ディー語 | Atlantic-Congo (Adamawa, Mbum-Day) | ~50K |
| `duu` | Drung | ドゥルン語 | Sino-Tibetan (Nungish) | ~7.3–14K |
| `dv` | Dhivehi | ディベヒ語 | Indo-Aryan | ~340K |
| `dyo` | Jola-Fonyi | ジョラ・フォニー語 | Niger-Congo (Atlantic, Bak) | ~600K |
| `dyu` | Dyula | ジュラ語 | Niger-Congo (Mande, Manding) | ~5M L1 + ~10M (lingua franca) |
...
| `en_ng2` | Ghanaian English | ガーナ英語 | Germanic | ~12–15M L2 (Ghana) |
...
| `es_sgl` | Golden Age Spanish | 黄金世紀スペイン語 | Indo-European (Italic, Romance, Ibero-Romance, Castilian; Siglo de Oro) | Historical literary form (~1500–1681 CE); pedagogical use in Spanish lit |
...
| `eve` | Even | エヴェン語 | Tungusic (Northern) | ~5K |
...
| `fia` | Nobiin | ノビーン語 | Nilo-Saharan (Eastern Sudanic, Nubian, Northern) | ~685K |
| `fit` | Meänkieli | メアンキエリ | Uralic (Finnic) | ~50K (severely endangered) |
| `fj` | Fijian | フィジー語 | Austronesian | ~640K |
| `fkv` | Kven Finnish | クヴェン語 | Uralic (Finnic) | ~2–8K (severely endangered) |
...
| `gan` | Gan | 贛語 | Sinitic (Gan) | ~22M |
| `gan_fz` | Fuzhou Gan | 撫州贛語 | Sino-Tibetan (Sinitic, Gan — 抚广片) | ~1–2M (Fuzhou Gan) |
| `gan_ja` | Jiʼan Gan | 吉安贛語 | Sino-Tibetan (Sinitic, Gan — 吉茶片) | ~0.5–1M (Jiʼan, not separately documented) |
...
| `gcr` | French Guianese Creole | フランス領ギアナ・クレオール語 | French creole | ~60–150K (French Guiana) |
| `gd` | Scottish Gaelic | スコットランド・ゲール語 | Celtic | ~57K |
| `gej` | Gen | ゲン語 | Niger-Congo | ~400–500K |
...
| `gqu` | Central Gelao | 中部仡佬語 | Kra-Dai (Kra) | ~3K (Gelao nationality ~550K) |
...
| `h_tagalog` | Old Tagalog | 古タガログ語 | Austronesian (Central Philippine) | Extinct as classical form (~16c. CE; modern Tagalog descends) |
| `h_vedic` | Vedic Sanskrit | ヴェーダ語 | Indo-European (Indo-Iranian, Indo-Aryan; Old Indo-Aryan) | Extinct (liturgical use, no native speakers) |
| `ha` | Hausa | ハウサ語 | Afro-Asiatic (Chadic) | ~80M (~40M L1 + ~40M L2) |
| `hai` | Haida | ハイダ語 | isolate | ~50–100 fluent + ~250–300 total |
...
| `har` | Harari | ハラリ語 | Afro-Asiatic (Semitic) | ~26–27K L1 |
...
| `hop` | Hopi | ホピ語 | Uto-Aztecan | ~5–7.1K L1 (declining) |
| `hot` | Hote | ホテ語 | Austronesian | ~3–4K |
| `hr` | Croatian | クロアチア語 | Slavic | ~5M |
| `hsb` | Upper Sorbian | 高地ソルブ語 | Slavic (West, Sorbian) | ~13K |
| `hsn` | Xiang | 湘語 | Sinitic (Xiang) | ~36M |
| `hsn_hy` | Hengyang Xiang | 衡陽湘語 | Sino-Tibetan (Sinitic, Xiang — 衡州片) | ~1.5M (Hengyang City, southwestern Hunan) |
...
| `hup` | Hupa | フーパ語 | Na-Dené (Athabaskan, Pacific Coast) | ~10 L1 + ~100 L2 (revitalization active) |
...
| `ie` | Interlingue | インテルリングエ | Constructed (auxiliary, naturalistic) | ~100 active |
| `ig` | Igbo | イグボ語 | Niger-Congo | ~24M |
| `ii` | Yi | イ語 | Sino-Tibetan (Loloish) | ~2M |
| `ik` | Inupiaq | イヌピアック語 | Eskimo-Aleut (Inuit) | ~2K (definitely endangered) |
| `ilo` | Ilocano | イロカノ語 | Austronesian | ~10M |
| `inh` | Ingush | イングーシ語 | NE Caucasian (Nakh) | ~400K |
| `io` | Ido | イド語 | Constructed (auxiliary, Esperantido) | ~1–5K |
...
| `ium` | Iu Mien | イウ・ミエン語 | Hmong-Mien (Mienic branch) | ~800K |
...
| `kdt` | Kuy | クイ語 | Austroasiatic (Katuic) | ~450–500K |
| `kea` | Cape Verdean Creole | カーボベルデ・クレオール | Portuguese-based creole | ~1M |
| `kek` | Qʼeqchiʼ | ケクチ語 | Mayan (Quichean) | ~800K |
| `ker` | Kera | ケラ語 | Afro-Asiatic (Chadic, East, A subgroup — Kera-Kwang sub-cluster) | ~50–80K |
...
| `kim` | Tofa | トファ語 | Turkic (Sayan Turkic, Northern) | ~40 (critically endangered) |
| `kio` | Kiowa | カイオワ語 | Kiowa-Tanoan | ~50 (critically endangered) |
| `kj` | Kuanyama | クワニヤマ語 | Atlantic-Congo (Bantu, Oshiwambo) | ~280K |
| `kjb` | Q'anjob'al | カンジョバル語 | Mayan | ~80–100K (Guatemala + significant USA diaspora) |
| `kjg` | Khmu | クム語 | Austroasiatic (Mon-Khmer, Khmuic) | ~700K |
...
| `kwa` | Dâw | ダウ語 | Nadahup | ~140 (Brazil) |
...
| `lb` | Luxembourgish | ルクセンブルク語 | Germanic (West) | ~400K |
...
| `lrc` | Lurish | ロル語 | Iranian (Southwestern) | ~5M (all Lurish varieties) |
| `lt` | Lithuanian | リトアニア語 | Baltic | ~3M |
| `ltg` | Latgalian | ラトガレ語 | Indo-European (Balto-Slavic, Baltic, Eastern Baltic) | ~165K |
| `lua` | Luba-Kasai | ルバ・カサイ語 | Atlantic-Congo (Bantu) | ~6M |
| `lue` | Luvale | ルヴァレ語 | Atlantic-Congo (Bantu, Chokwe-Luchazi / K.10 group) | ~600K |
| `lun` | Lunda | ルンダ語 | Niger-Congo (Atlantic-Congo, Benue-Congo, Bantu, Guthrie zone L.52) | ~600K |
...
| `luz` | Southern Luri | 南ロル語 | Indo-European (Iranian — Southwestern, Luri-Bakhtiari) | ~1M |
...
| `maz` | Mazahua | マサワ語 | Oto-Manguean (Otomian) | ~150K |
...
| `mwl` | Mirandese | ミランデース語 | Indo-European (Romance, Ibero-Romance, Astur-Leonese) | ~10–15K |
...
| `mxv` | Metlatónoc Mixtec | メトラトノク・ミシュテコ語 | Oto-Manguean (Mixtecan) | ~25K |
...
| `myz` | Mandaic | マンダ語 | Afro-Asiatic (Semitic, Northwest, Aramaic, Eastern, Mandaic) | ~5K liturgical + ~50 fluent (Modern Mandaic) |
| `mzh` | Wichí | ウィチ語 | Mataco-Mataguayan | ~50–60K |
| `mzn` | Mazandarani | マーザンダラーン語 | Indo-European (Iranian, NW Caspian) | ~4M |
| `na` | Nauruan | ナウル語 | Austronesian (Micronesian) | ~9.4–10K |
...
| `naq` | Nama | ナマ語 | Khoe-Kwadi (Khoisan) | ~250K |
...
| `nez` | Nez Perce | ニズパース語 | Sahaptian | ~30–40 (UNESCO: critically endangered) |
...
| `nhx` | Isthmus Nahuatl | イスムス・ナワトル語 | Uto-Aztecan | ~25K Veracruz (~1.7M Nahuan total) |
...
| `nmn` | Taa | タア語 | Tuu (formerly Southern Khoisan) | ~2.5K |
...
| `nrf_gg` | Guernésiais | ゲルネジエ語 | Indo-European (Romance, Oïl, Norman) | ~200 (critically endangered) |
| `nso` | Northern Sotho | 北ソト語 | Atlantic-Congo (Bantu, Sotho-Tswana) | ~5M |
| `nuf` | Nusu | ヌス語 | Sino-Tibetan (Nungish / Loloish, branch debated) | ~9K (Nu nationality ~37K) |
...
| `oar` | Old Aramaic | 古アラム語 | Afro-Asiatic (Northwest Semitic, Aramaic) | Extinct (ancestor of Imperial Aramaic) |
...
| `ocm` | Old Cham | 古チャム語 | Austronesian (Malayo-Polynesian, Chamic) | Extinct (historical, ancestor of modern Cham) |
...
| `ono` | Onondaga | オノンダガ語 | Iroquoian (Northern, Five Nations) | ~20 fluent + heritage learners |
...
| `orh` | Oroqen | 鄂倫春語 | Tungusic (Northern) | ~1.2K (Oroqen nationality ~9K) |
...
| `osc` | Oscan | オスク語 | Indo-European (Italic, Sabellic, Oscan) | Extinct by c. 1c CE (last inscriptions pre-79 CE) |
| `osn` | Old Sundanese | 古スンダ語 | Austronesian (Malayo-Polynesian, Sundic) | Extinct as L1 |
...
| `otq` | Querétaro Otomi | ケレタロ・オトミ語 | Oto-Manguean (Otomian) | ~30K (vulnerable) |
...
| `p_viet` | Proto-Vietic | ヴィエト祖語 | Proto-language (reconstructed) | Extinct (hypothetical) |
...
| `paus` | Proto-Austronesian | オーストロネシア祖語 | Proto-language (reconstructed) | Extinct (hypothetical) |
| `pban` | Proto-Bantu | バントゥ祖語 | Proto-language (reconstructed) | Extinct (hypothetical) |
...
| `peh` | Bonan | 保安語 | Mongolic (Shirongolic) | ~6K (Bonan nationality ~20K) |
...
| `pmi` | Northern Pumi | 北部プミ語 | Sino-Tibetan (Qiangic) | ~54K (Pumi nationality ~43K) |
| `pmng` | Proto-Mongolic | モンゴル祖語 | Proto-language (reconstructed) | Extinct (hypothetical) |
| `pms` | Piedmontese | ピエモンテ語 | Indo-European (Romance, Italo-Western, Gallo-Italic) | ~1–2M |
| `pmt` | Tuamotuan | トゥアモトゥアン語 | Austronesian (Polynesian) | ~6K |
| `pmy` | Papuan Malay | パプア・マレー語 | Austronesian (Malayic creole / Eastern Malay) | ~1M (L1+L2) |
...
| `pot` | Potawatomi | ポタワトミ語 | Algic (Algonquian, Central Algonquian, Ojibwe-Potawatomi) | ~30 L1 + ~200 L2 (severely endangered) |
...
| `prk` | Parauk Wa | パラウク・ワ語 | Austroasiatic (Palaungic) | ~399–849K |
...
| `qwc` | Classical Quechua | 古典ケチュア語 | Quechuan | Extinct (~15-16c. CE; modern Quechua dialects descend) |
...
| `rmf` | Finnish Romani | フィンランド・ロマ語 | Indo-European (Indo-Aryan, Romani, Northern, Romanichal-Kaale subgroup) | ~10–12K (Finland) |
| `rmt` | Domari | ドマリ語 | Indo-European (Indo-Aryan, Central) | ~280K (severely endangered) |
...
| `rup` | Aromanian | アルーマニア語 | Indo-European (Italic, Romance, Eastern Romance / Balkan Romance) | ~250K (~100–350K) |
...
| `saq` | Samburu | サンブル語 | Nilo-Saharan (Eastern Nilotic, Maa cluster — sister to Maasai mas) | ~150–180K |
...
| `sdo` | Bukar-Sadong Bidayuh | ブカル＝サドン・ビダユ語 | Austronesian (Land Dayak, Bidayuhic) | ~50K |
...
| `slr` | Salar | サラル語 | Turkic (Oghuz) | ~60–95K L1 |
...
| `sva` | Svan | スヴァン語 | Kartvelian (Svan branch — sister to Zan-Georgian) | ~14–30K |
| `sw` | Swahili | スワヒリ語 | Bantu | ~100M (~20M L1 + ~80M L2) |
| `swb` | Maore Comorian | マオレ・コモロ語 | Niger-Congo (Bantu, Sabaki) | ~80–152K (Mayotte) |
| `swg` | Swabian | シュヴァーベン語 | Indo-European | ~800K |
| `swi` | Sui | 水語 | Kra-Dai (Kam-Sui) | ~300K (Sui nationality ~496K) |
...
| `szl` | Silesian | シレジア語 | Indo-European (Slavic, West, Lechitic) | ~509K (self-identified) |
...
| `ter` | Terena | テレナ語 | Arawakan | ~9–15K |
...
| `tpn` | Tupinambá | トゥピナンバ語 | Tupian (Tupi-Guarani, Subgroup III) | Extinct (~1700s as L1; basis of Língua Geral / Nheengatu) |
| `tpy` | Trumai | トゥルマイ語 | Language isolate (Trumai) | ~50 (Upper Xingu, Brazil) |
| `tr` | Turkish | トルコ語 | Turkic | ~85M |
| `trm` | Tregami | トレガミ語 | Indo-European | ~3.5K |
| `trn` | Trinitario Mojeño | トリニタリオ・モヘーニョ語 | Arawakan | ~3–3.1K L1 (Beni) |
| `tru` | Turoyo | トゥロヨ語 | Afro-Asiatic | ~50–100K |
...
| `tsj` | Tshangla | ツァンラ語 | Sino-Tibetan (Tibeto-Burman, Bodish — close to but not descended from Classical Tibetan) | ~170K |
| `tsu` | Tsou | ツォウ語 | Austronesian (Tsouic) | ~4K (~2K daily L1, severely endangered) |
| `tsz` | Purépecha | プレペチャ語 | isolate | ~142K L1 |
...
| `wic` | Wichita | ウィチタ語 | Caddoan (Northern Caddoan) | ~3 L1 (critically endangered, last speaker d. 2016) |
| `win` | Ho-Chunk | ホーチャンク語 | Siouan | ~40 fluent + ~250 L1 |
...
| `xag` | Caucasian Albanian | カフカース・アルバニア語 | Northeast Caucasian (Lezgic; ancestor/sister of modern Udi) | Extinct as literary language (~12c CE, descendant Udi ~6K) |
...
| `xht` | Hattic | ハッティ語 | Language isolate (unclassified; sometimes tentatively linked to the Northwest Caucasian languages) | Extinct (last attested 2nd millennium BCE) |
...
| `xli` | Liburnian | リブルニア語 | Paleo-Balkan (unclassified; possibly Indo-European and Illyrian-related, possibly pre-IE) | †extinct (~1c CE, Romanized) |
...
| `xpg` | Phrygian | フリュギア語 | Indo-European (Paleo-Balkan, isolated branch — closest to Greek/Armenian per current consensus) | Extinct (last attested c. 5th c. CE) |
...
| `ybe` | Western Yugur | 西裕固語 | Turkic (Siberian) | ~3.6–5K L1 (critically endangered) |
| `ygr` | Yagaria | ヤガリア語 | Trans-New Guinea (Eastern Highlands) | ~10K |
| `yi` | Yiddish | イディッシュ語 | Germanic | ~600K |
| `yiz` | Azhe | アジェ語 | Sino-Tibetan | ~50K |
...
| `yrl` | Nheengatu | ニェンガトゥ語 | Tupian | ~6–8K |
...
| `zts` | Tlacolula Zapotec | トラコルラ・サポテク語 | Oto-Manguean (Zapotecan) | ~6K |
