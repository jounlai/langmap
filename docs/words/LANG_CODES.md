...
| `luz` | Northern Luri | 北部ルーリー語 | Indo-European (Iranian) | ~300–400K |
...
| `paa` | Proto-Austroasiatic | オーストロアジア祖語 | Proto-language (reconstructed) | Extinct (hypothetical) |
...
| `pdr` | Proto-Dravidian | ドラヴィダ祖語 | Proto-language (reconstructed) | Extinct (hypothetical) |
...
| `phm` | Proto-Hmong-Mien | 苗瑶祖語 | Proto-language (reconstructed) | Extinct (hypothetical) |
...
| `pkd` | Proto-Kra-Dai | クラ・ダイ祖語 | Proto-language (reconstructed) | Extinct (hypothetical) |
| `pko` | Proto-Koreanic | 朝鮮祖語 | Proto-language (reconstructed) | Extinct (hypothetical) |
...
| `pry` | Proto-Ryukyuan | 琉球祖語 | Japonic (Ryukyuan) | Reconstructed proto-language (no speakers; split from Japonic ~7–8c. CE) |
...
| `pst` | Proto-Sino-Tibetan | 漢蔵祖語 | Proto-language (reconstructed) | Extinct (hypothetical) |
...
| `ptg` | Proto-Tungusic | ツングース祖語 | Proto-language (reconstructed) | Extinct (hypothetical) |
...
| `uun` | Kulon-Pazeh | クーロン・パゼヘ語 | Austronesian (Formosan, Western Plains) | Dormant (~0 L1, last speaker died 2010) |
...
| `vsa` | Vedic Sanskrit | ヴェーダ語 | Indo-European (Indo-Iranian, Indo-Aryan; Old Indo-Aryan) | Extinct (liturgical use, no native speakers) |
...
| `wch` | Wichita | ウィチタ語 | Caddoan (Northern Caddoan) | ~3 L1 (critically endangered, last speaker d. 2016) |
...
| `xtm` | Mixtepec Mixtec | ミクステペック・ミクステコ語 | Oto-Manguean (Mixtecan) | ~7–15K |
