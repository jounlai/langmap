...
| `lic` | Hlai (Ha) | 黎語（哈方言） | Kra-Dai (Hlai) | ~670K (Li nationality ~1.5M) |
...
| `mmd` | Maonan | 毛南語 | Kra-Dai (Kam-Sui) | ~30K (Maonan nationality ~110K) |
...
| `swi` | Sui | 水語 | Kra-Dai (Kam-Sui) | ~300K (Sui nationality ~410K) |
...
| `twm` | Tshona Monpa (Dakpa) | 錯那モンパ語（ダクパ） | Sino-Tibetan (East Bodish) | ~10K in China (Monpa nationality ~11K) |
