...
(function () {
    ...
    var LEVEL_DESC = {
        ...
        yue: { A1: '識少少單詞同招呼', A2: '簡單嘅日常對答', B1: '可以進行日常對話', B2: '應付得到複雜同工作話題', C1: '幾乎任何場合都流利', C2: '接近母語水平' },
        vi: { A1: 'Biết vài từ và lời chào', A2: 'Trao đổi đơn giản hằng ngày', B1: 'Trò chuyện thường ngày được', B2: 'Thoải mái với chủ đề phức tạp và công việc', C1: 'Lưu loát trong hầu hết mọi tình huống', C2: 'Gần như người bản ngữ' },
        th: { A1: 'รู้คำศัพท์และคำทักทายเล็กน้อย', A2: 'สนทนาง่าย ๆ ในชีวิตประจำวัน', B1: 'สนทนาในชีวิตประจำวันได้', B2: 'รับมือหัวข้อซับซ้อนและเรื่องงานได้', C1: 'คล่องแคล่วในเกือบทุกสถานการณ์', C2: 'ใกล้เคียงเจ้าของภาษา' },
        id: { A1: 'Beberapa kata dan sapaan', A2: 'Percakapan sehari-hari sederhana', B1: 'Bisa mengobrol sehari-hari', B2: 'Nyaman dengan topik rumit dan pekerjaan', C1: 'Lancar di hampir semua situasi', C2: 'Nyaris seperti penutur asli' },
        hi: { A1: 'कुछ शब्द और अभिवादन', A2: 'सरल रोज़मर्रा की बातचीत', B1: 'रोज़मर्रा की बातचीत कर सकते हैं', B2: 'जटिल और कामकाजी विषयों में सहज', C1: 'लगभग हर स्थिति में धाराप्रवाह', C2: 'लगभग मातृभाषी जैसा' },
        de: { A1: 'Ein paar Wörter und Grußformeln', A2: 'Einfache Alltagsgespräche', B1: 'Kann sich im Alltag unterhalten', B2: 'Kommt mit komplexen und beruflichen Themen zurecht', C1: 'Fließend in fast jeder Situation', C2: 'Nahezu muttersprachlich' },
        fr: { A1: 'Quelques mots et salutations', A2: 'Échanges simples du quotidien', B1: 'Peut tenir une conversation courante', B2: 'À l’aise avec les sujets complexes et professionnels', C1: 'Courant dans presque toutes les situations', C2: 'Proche d’un locuteur natif' },
        it: { A1: 'Qualche parola e saluto', A2: 'Scambi semplici di tutti i giorni', B1: 'Regge una conversazione quotidiana', B2: 'A proprio agio con temi complessi e di lavoro', C1: 'Fluente in quasi ogni situazione', C2: 'Quasi da madrelingua' },
        es: { A1: 'Unas pocas palabras y saludos', A2: 'Intercambios sencillos del día a día', B1: 'Puede mantener una conversación cotidiana', B2: 'Cómodo con temas complejos y de trabajo', C1: 'Fluido en casi cualquier situación', C2: 'Casi como un nativo' },
        pt: { A1: 'Algumas palavras e saudações', A2: 'Trocas simples do dia a dia', B1: 'Consegue manter uma conversa do quotidiano', B2: 'À vontade com temas complexos e de trabalho', C1: 'Fluente em quase todas as situações', C2: 'Quase como um falante nativo' },
        ru: { A1: 'Несколько слов и приветствий', A2: 'Простой повседневный разговор', B1: 'Может поддержать бытовую беседу', B2: 'Справляется со сложными и рабочими темами', C1: 'Свободно почти в любой ситуации', C2: 'Почти как носитель языка' },
        uk: { A1: 'Кілька слів і вітань', A2: 'Проста повсякденна розмова', B1: 'Може підтримати побутову бесіду', B2: 'Дає раду складним і робочим темам', C1: 'Вільно майже в будь-якій ситуації', C2: 'Майже як носій мови' },
        ar: { A1: 'بضع كلمات وتحيات', A2: 'تبادلات يومية بسيطة', B1: 'يستطيع إجراء محادثة يومية', B2: 'مرتاح مع المواضيع المعقّدة والعملية', C1: 'طليق في معظم المواقف', C2: 'قريب من مستوى الناطق الأصلي' },
        he: { A1: 'כמה מילים וברכות', A2: 'שיחות יומיומיות פשוטות', B1: 'מסוגל לנהל שיחת יום-יום', B2: 'מסתדר עם נושאים מורכבים ומקצועיים', C1: 'שוטף כמעט בכל מצב', C2: 'כמעט ברמת שפת אם' },
        sw: { A1: 'Maneno machache na salamu', A2: 'Mazungumzo rahisi ya kila siku', B1: 'Anaweza kuendesha mazungumzo ya kila siku', B2: 'Anamudu mada tata na za kazi', C1: 'Fasaha karibu katika hali yoyote', C2: 'Karibu kama mzawa' },
    };
    ...
    var STR = {
        ...
        yue: { btn: '語言護照', title: '語言護照', name_ph: '你嘅名（可以唔填）', add_ph: '加一種你識講嘅語言…', no_results: '搵唔到相符嘅語言', empty: '加入你識講嘅語言，睇吓你可以接觸到幾多人。', intro: '揀出你識講嘅語言，睇吓你可以接觸到世界幾多人——再分享你嘅語言護照。', s_langs: '種語言', s_reach: '接觸人口', s_world: '佔世界人口', s_countries: '個國家', s_families: '個語系', plot: '喺地圖標示', clear_plot: '清除地圖', make_img: '製作我嘅護照', download: '下載', share: '分享', close: '閂', back: '返去', folded: '≈ 已計入 {name}', card_my: '我嘅語言護照', card_of: '種語言', card_reach: '我可以接觸嘅人', card_world: '佔世界人口', card_note: '累計人數，可能有重疊', card_countries: '個國家', card_families: '個語系', spk: '使用者', res_ph: '你住喺邊（可以唔填）', card_langs: '識講嘅語言', card_more: '仲有 {n} 種', card_foot: '識幾多種話，就有幾多個世界。下一站去邊？', share_text: '我嘅語言護照 🌍 我可以接觸到世界 {pct} 嘅人！', copy: '複製連結', copied: '已複製連結！', share_img: '分享圖片' },
        vi: { btn: 'Hộ chiếu ngôn ngữ', title: 'Hộ chiếu ngôn ngữ', name_ph: 'Tên bạn (không bắt buộc)', add_ph: 'Thêm một ngôn ngữ bạn nói…', no_results: 'Không tìm thấy ngôn ngữ phù hợp', empty: 'Thêm những ngôn ngữ bạn nói để xem bạn có thể đến được với bao nhiêu người.', intro: 'Chọn những ngôn ngữ bạn nói và xem bạn có thể đến được với bao nhiêu phần của thế giới — rồi chia sẻ hộ chiếu ngôn ngữ của bạn.', s_langs: 'ngôn ngữ', s_reach: 'người tiếp cận được', s_world: 'dân số thế giới', s_countries: 'quốc gia', s_families: 'ngữ hệ', plot: 'Hiện trên bản đồ', clear_plot: 'Xoá bản đồ', make_img: 'Tạo hộ chiếu của tôi', download: 'Tải về', share: 'Chia sẻ', close: 'Đóng', back: 'Quay lại', folded: '≈ đã tính trong {name}', card_my: 'Hộ chiếu ngôn ngữ của tôi', card_of: 'ngôn ngữ', card_reach: 'số người tôi tiếp cận được', card_world: 'dân số thế giới', card_note: 'tổng cộng — có thể trùng lặp', card_countries: 'quốc gia', card_families: 'ngữ hệ', spk: 'người nói', res_ph: 'Nơi bạn sống (không bắt buộc)', card_langs: 'Ngôn ngữ', card_more: '+{n} nữa', card_foot: 'Biết bao nhiêu tiếng, có bấy nhiêu thế giới. Tiếp theo là đâu?', share_text: 'Hộ chiếu ngôn ngữ của tôi 🌍 Tôi tiếp cận được {pct} dân số thế giới!', copy: 'Sao chép liên kết', copied: 'Đã sao chép!', share_img: 'Chia sẻ ảnh' },
        th: { btn: 'พาสปอร์ตภาษา', title: 'พาสปอร์ตภาษา', name_ph: 'ชื่อของคุณ (ไม่บังคับ)', add_ph: 'เพิ่มภาษาที่คุณพูดได้…', no_results: 'ไม่พบภาษาที่ตรงกัน', empty: 'เพิ่มภาษาที่คุณพูดได้ เพื่อดูว่าคุณสื่อสารกับคนได้กี่คน', intro: 'เลือกภาษาที่คุณพูดได้ แล้วดูว่าคุณเข้าถึงโลกได้มากแค่ไหน — จากนั้นแบ่งปันพาสปอร์ตภาษาของคุณ', s_langs: 'ภาษา', s_reach: 'คนที่เข้าถึงได้', s_world: 'ของประชากรโลก', s_countries: 'ประเทศ', s_families: 'ตระกูลภาษา', plot: 'แสดงบนแผนที่', clear_plot: 'ล้างแผนที่', make_img: 'สร้างพาสปอร์ตของฉัน', download: 'ดาวน์โหลด', share: 'แบ่งปัน', close: 'ปิด', back: 'ย้อนกลับ', folded: '≈ นับรวมอยู่ใน {name}', card_my: 'พาสปอร์ตภาษาของฉัน', card_of: 'ภาษา', card_reach: 'จำนวนคนที่ฉันเข้าถึงได้', card_world: 'ของประชากรโลก', card_note: 'ยอดรวม อาจมีการนับซ้ำ', card_countries: 'ประเทศ', card_families: 'ตระกูลภาษา', spk: 'ผู้พูด', res_ph: 'ที่คุณอาศัยอยู่ (ไม่บังคับ)', card_langs: 'ภาษาที่พูดได้', card_more: 'และอีก {n} ภาษา', card_foot: 'รู้กี่ภาษา ก็มีโลกกี่ใบ แล้วต่อไปที่ไหนดี', share_text: 'พาสปอร์ตภาษาของฉัน 🌍 ฉันเข้าถึงประชากรโลกได้ {pct}!', copy: 'คัดลอกลิงก์', copied: 'คัดลอกลิงก์แล้ว!', share_img: 'แบ่งปันรูปภาพ' },
        id: { btn: 'Paspor Bahasa', title: 'Paspor Bahasa', name_ph: 'Nama Anda (opsional)', add_ph: 'Tambahkan bahasa yang Anda kuasai…', no_results: 'Tidak ada bahasa yang cocok', empty: 'Tambahkan bahasa yang Anda kuasai untuk melihat berapa banyak orang yang bisa Anda jangkau.', intro: 'Pilih bahasa yang Anda kuasai dan lihat seberapa luas dunia yang bisa Anda jangkau — lalu bagikan Paspor Bahasa Anda.', s_langs: 'bahasa', s_reach: 'orang terjangkau', s_world: 'dari penduduk dunia', s_countries: 'negara', s_families: 'rumpun', plot: 'Tampilkan di peta', clear_plot: 'Bersihkan peta', make_img: 'Buat paspor saya', download: 'Unduh', share: 'Bagikan', close: 'Tutup', back: 'Kembali', folded: '≈ sudah termasuk dalam {name}', card_my: 'Paspor Bahasa Saya', card_of: 'bahasa', card_reach: 'orang yang bisa saya jangkau', card_world: 'dari penduduk dunia', card_note: 'jumlah kumulatif — mungkin tumpang tindih', card_countries: 'negara', card_families: 'rumpun', spk: 'penutur', res_ph: 'Tempat tinggal Anda (opsional)', card_langs: 'Bahasa', card_more: '+{n} lagi', card_foot: 'Sebanyak bahasa yang Anda kuasai, sebanyak itu dunia yang terbuka. Ke mana berikutnya?', share_text: 'Paspor Bahasa saya 🌍 Saya menjangkau {pct} penduduk dunia!', copy: 'Salin tautan', copied: 'Tautan disalin!', share_img: 'Bagikan gambar' },
        hi: { btn: 'भाषा पासपोर्ट', title: 'भाषा पासपोर्ट', name_ph: 'आपका नाम (वैकल्पिक)', add_ph: 'आप जो भाषा बोलते हैं जोड़ें…', no_results: 'कोई मेल खाती भाषा नहीं', empty: 'आप जो भाषाएँ बोलते हैं उन्हें जोड़ें और देखें कि आप कितने लोगों तक पहुँच सकते हैं।', intro: 'आप जो भाषाएँ बोलते हैं चुनिए और देखिए आप दुनिया के कितने हिस्से तक पहुँच सकते हैं — फिर अपना भाषा पासपोर्ट साझा कीजिए।', s_langs: 'भाषाएँ', s_reach: 'लोगों तक पहुँच', s_world: 'विश्व जनसंख्या का', s_countries: 'देश', s_families: 'भाषा-परिवार', plot: 'मानचित्र पर दिखाएँ', clear_plot: 'मानचित्र साफ़ करें', make_img: 'मेरा पासपोर्ट बनाएँ', download: 'डाउनलोड', share: 'साझा करें', close: 'बंद करें', back: 'वापस', folded: '≈ {name} में गिना गया', card_my: 'मेरा भाषा पासपोर्ट', card_of: 'भाषाएँ', card_reach: 'जिन लोगों तक मैं पहुँच सकता/सकती हूँ', card_world: 'विश्व जनसंख्या का', card_note: 'कुल पहुँच — दोहराव संभव', card_countries: 'देश', card_families: 'भाषा-परिवार', spk: 'वक्ता', res_ph: 'आप कहाँ रहते हैं (वैकल्पिक)', card_langs: 'भाषाएँ', card_more: '+{n} और', card_foot: 'जितनी भाषाएँ, उतनी दुनियाएँ। अब कहाँ?', share_text: 'मेरा भाषा पासपोर्ट 🌍 मैं दुनिया के {pct} तक पहुँच सकता/सकती हूँ!', copy: 'लिंक कॉपी करें', copied: 'लिंक कॉपी हो गया!', share_img: 'छवि साझा करें' },
        de: { btn: 'Sprachenpass', title: 'Sprachenpass', name_ph: 'Ihr Name (optional)', add_ph: 'Eine Sprache hinzufügen, die Sie sprechen…', no_results: 'Keine passende Sprache', empty: 'Fügen Sie die Sprachen hinzu, die Sie sprechen, und sehen Sie, wie viele Menschen Sie erreichen.', intro: 'Wählen Sie die Sprachen, die Sie sprechen, und sehen Sie, wie viel von der Welt Sie erreichen — und teilen Sie dann Ihren Sprachenpass.', s_langs: 'Sprachen', s_reach: 'erreichte Menschen', s_world: 'der Weltbevölkerung', s_countries: 'Länder', s_families: 'Sprachfamilien', plot: 'Auf der Karte zeigen', clear_plot: 'Karte leeren', make_img: 'Meinen Pass erstellen', download: 'Herunterladen', share: 'Teilen', close: 'Schließen', back: 'Zurück', folded: '≈ in {name} mitgezählt', card_my: 'Mein Sprachenpass', card_of: 'Sprachen', card_reach: 'Menschen, die ich erreiche', card_world: 'der Weltbevölkerung', card_note: 'Summe — Überschneidungen möglich', card_countries: 'Länder', card_families: 'Sprachfamilien', spk: 'Sprecher', res_ph: 'Wo Sie leben (optional)', card_langs: 'Sprachen', card_more: '+{n} weitere', card_foot: 'So viele Welten wie Sprachen, die Sie sprechen. Wohin als Nächstes?', share_text: 'Mein Sprachenpass 🌍 Ich erreiche {pct} der Weltbevölkerung!', copy: 'Link kopieren', copied: 'Link kopiert!', share_img: 'Bild teilen' },
        fr: { btn: 'Passeport linguistique', title: 'Passeport linguistique', name_ph: 'Votre nom (facultatif)', add_ph: 'Ajouter une langue que vous parlez…', no_results: 'Aucune langue correspondante', empty: 'Ajoutez les langues que vous parlez pour voir combien de personnes vous pouvez atteindre.', intro: 'Choisissez les langues que vous parlez et voyez quelle part du monde vous pouvez atteindre — puis partagez votre passeport linguistique.', s_langs: 'langues', s_reach: 'personnes atteintes', s_world: 'de la population mondiale', s_countries: 'pays', s_families: 'familles', plot: 'Afficher sur la carte', clear_plot: 'Effacer la carte', make_img: 'Créer mon passeport', download: 'Télécharger', share: 'Partager', close: 'Fermer', back: 'Retour', folded: '≈ compté dans {name}', card_my: 'Mon passeport linguistique', card_of: 'langues', card_reach: 'personnes que je peux atteindre', card_world: 'de la population mondiale', card_note: 'total cumulé — recoupements possibles', card_countries: 'pays', card_families: 'familles', spk: 'locuteurs', res_ph: 'Où vous vivez (facultatif)', card_langs: 'Langues', card_more: '+{n} autres', card_foot: 'Autant de mondes que de langues parlées. Et maintenant, où ?', share_text: 'Mon passeport linguistique 🌍 J’atteins {pct} de la population mondiale !', copy: 'Copier le lien', copied: 'Lien copié !', share_img: 'Partager l’image' },
        it: { btn: 'Passaporto linguistico', title: 'Passaporto linguistico', name_ph: 'Il tuo nome (facoltativo)', add_ph: 'Aggiungi una lingua che parli…', no_results: 'Nessuna lingua corrispondente', empty: 'Aggiungi le lingue che parli per vedere quante persone puoi raggiungere.', intro: 'Scegli le lingue che parli e scopri quanta parte del mondo puoi raggiungere — poi condividi il tuo passaporto linguistico.', s_langs: 'lingue', s_reach: 'persone raggiunte', s_world: 'della popolazione mondiale', s_countries: 'paesi', s_families: 'famiglie', plot: 'Mostra sulla mappa', clear_plot: 'Cancella la mappa', make_img: 'Crea il mio passaporto', download: 'Scarica', share: 'Condividi', close: 'Chiudi', back: 'Indietro', folded: '≈ conteggiato in {name}', card_my: 'Il mio passaporto linguistico', card_of: 'lingue', card_reach: 'persone che posso raggiungere', card_world: 'della popolazione mondiale', card_note: 'totale cumulato — possibili sovrapposizioni', card_countries: 'paesi', card_families: 'famiglie', spk: 'parlanti', res_ph: 'Dove vivi (facoltativo)', card_langs: 'Lingue', card_more: '+{n} altre', card_foot: 'Tanti mondi quante sono le lingue che parli. E adesso dove?', share_text: 'Il mio passaporto linguistico 🌍 Raggiungo il {pct} della popolazione mondiale!', copy: 'Copia il link', copied: 'Link copiato!', share_img: 'Condividi immagine' },
        es: { btn: 'Pasaporte lingüístico', title: 'Pasaporte lingüístico', name_ph: 'Tu nombre (opcional)', add_ph: 'Añade un idioma que hablas…', no_results: 'Ningún idioma coincidente', empty: 'Añade los idiomas que hablas para ver a cuántas personas puedes llegar.', intro: 'Elige los idiomas que hablas y descubre a qué parte del mundo puedes llegar — luego comparte tu pasaporte lingüístico.', s_langs: 'idiomas', s_reach: 'personas alcanzadas', s_world: 'de la población mundial', s_countries: 'países', s_families: 'familias', plot: 'Mostrar en el mapa', clear_plot: 'Limpiar el mapa', make_img: 'Crear mi pasaporte', download: 'Descargar', share: 'Compartir', close: 'Cerrar', back: 'Atrás', folded: '≈ contado dentro de {name}', card_my: 'Mi pasaporte lingüístico', card_of: 'idiomas', card_reach: 'personas a las que puedo llegar', card_world: 'de la población mundial', card_note: 'alcance acumulado — puede haber solapamientos', card_countries: 'países', card_families: 'familias', spk: 'hablantes', res_ph: 'Dónde vives (opcional)', card_langs: 'Idiomas', card_more: '+{n} más', card_foot: 'Tantos mundos como lenguas hablas. ¿Y ahora adónde?', share_text: 'Mi pasaporte lingüístico 🌍 ¡Llego al {pct} de la población mundial!', copy: 'Copiar enlace', copied: '¡Enlace copiado!', share_img: 'Compartir imagen' },
        pt: { btn: 'Passaporte linguístico', title: 'Passaporte linguístico', name_ph: 'O seu nome (opcional)', add_ph: 'Adicione uma língua que fala…', no_results: 'Nenhuma língua correspondente', empty: 'Adicione as línguas que fala para ver quantas pessoas consegue alcançar.', intro: 'Escolha as línguas que fala e veja que parte do mundo consegue alcançar — depois partilhe o seu passaporte linguístico.', s_langs: 'línguas', s_reach: 'pessoas alcançadas', s_world: 'da população mundial', s_countries: 'países', s_families: 'famílias', plot: 'Mostrar no mapa', clear_plot: 'Limpar o mapa', make_img: 'Criar o meu passaporte', download: 'Descarregar', share: 'Partilhar', close: 'Fechar', back: 'Voltar', folded: '≈ contado dentro de {name}', card_my: 'O meu passaporte linguístico', card_of: 'línguas', card_reach: 'pessoas que consigo alcançar', card_world: 'da população mundial', card_note: 'alcance acumulado — pode haver sobreposições', card_countries: 'países', card_families: 'famílias', spk: 'falantes', res_ph: 'Onde vive (opcional)', card_langs: 'Línguas', card_more: '+{n} mais', card_foot: 'Tantos mundos quantas as línguas que fala. Para onde a seguir?', share_text: 'O meu passaporte linguístico 🌍 Alcanço {pct} da população mundial!', copy: 'Copiar ligação', copied: 'Ligação copiada!', share_img: 'Partilhar imagem' },
        ru: { btn: 'Языковой паспорт', title: 'Языковой паспорт', name_ph: 'Ваше имя (необязательно)', add_ph: 'Добавьте язык, которым вы владеете…', no_results: 'Подходящих языков нет', empty: 'Добавьте языки, которыми вы владеете, и узнайте, скольких людей вы можете охватить.', intro: 'Выберите языки, которыми вы владеете, и посмотрите, какую часть мира вы охватываете, — а затем поделитесь своим языковым паспортом.', s_langs: 'языков', s_reach: 'человек охвачено', s_world: 'населения мира', s_countries: 'стран', s_families: 'семей', plot: 'Показать на карте', clear_plot: 'Очистить карту', make_img: 'Создать паспорт', download: 'Скачать', share: 'Поделиться', close: 'Закрыть', back: 'Назад', folded: '≈ учтено в составе {name}', card_my: 'Мой языковой паспорт', card_of: 'языков', card_reach: 'людей, до которых я дотянусь', card_world: 'населения мира', card_note: 'суммарный охват — возможны пересечения', card_countries: 'стран', card_families: 'семей', spk: 'говорящих', res_ph: 'Где вы живёте (необязательно)', card_langs: 'Языки', card_more: 'и ещё {n}', card_foot: 'Сколько языков — столько и миров. Куда дальше?', share_text: 'Мой языковой паспорт 🌍 Я охватываю {pct} населения мира!', copy: 'Копировать ссылку', copied: 'Ссылка скопирована!', share_img: 'Поделиться картинкой' },
        uk: { btn: 'Мовний паспорт', title: 'Мовний паспорт', name_ph: 'Ваше ім’я (необов’язково)', add_ph: 'Додайте мову, якою ви володієте…', no_results: 'Відповідних мов немає', empty: 'Додайте мови, якими ви володієте, і побачите, скількох людей ви можете охопити.', intro: 'Оберіть мови, якими ви володієте, і подивіться, яку частину світу ви охоплюєте — а потім поділіться своїм мовним паспортом.', s_langs: 'мов', s_reach: 'людей охоплено', s_world: 'населення світу', s_countries: 'країн', s_families: 'родин', plot: 'Показати на карті', clear_plot: 'Очистити карту', make_img: 'Створити паспорт', download: 'Завантажити', share: 'Поділитися', close: 'Закрити', back: 'Назад', folded: '≈ враховано в складі {name}', card_my: 'Мій мовний паспорт', card_of: 'мов', card_reach: 'людей, яких я охоплюю', card_world: 'населення світу', card_note: 'сумарне охоплення — можливі перетини', card_countries: 'країн', card_families: 'родин', spk: 'мовців', res_ph: 'Де ви живете (необов’язково)', card_langs: 'Мови', card_more: 'і ще {n}', card_foot: 'Скільки мов — стільки й світів. Куди далі?', share_text: 'Мій мовний паспорт 🌍 Я охоплюю {pct} населення світу!', copy: 'Копіювати посилання', copied: 'Посилання скопійовано!', share_img: 'Поділитися зображенням' },
        ar: { btn: 'جواز اللغات', title: 'جواز اللغات', name_ph: 'اسمك (اختياري)', add_ph: 'أضف لغة تتحدثها…', no_results: 'لا توجد لغة مطابقة', empty: 'أضف اللغات التي تتحدثها لترى كم شخصًا يمكنك الوصول إليه.', intro: 'اختر اللغات التي تتحدثها وانظر كم من العالم يمكنك الوصول إليه — ثم شارك جواز لغاتك.', s_langs: 'لغات', s_reach: 'شخصًا يمكن الوصول إليهم', s_world: 'من سكان العالم', s_countries: 'دولة', s_families: 'عائلة لغوية', plot: 'إظهار على الخريطة', clear_plot: 'مسح الخريطة', make_img: 'أنشئ جوازي', download: 'تنزيل', share: 'مشاركة', close: 'إغلاق', back: 'رجوع', folded: '≈ محسوب ضمن {name}', card_my: 'جواز لغاتي', card_of: 'لغات', card_reach: 'عدد من أستطيع الوصول إليهم', card_world: 'من سكان العالم', card_note: 'المجموع التراكمي — قد يوجد تداخل', card_countries: 'دولة', card_families: 'عائلة لغوية', spk: 'متحدث', res_ph: 'مكان إقامتك (اختياري)', card_langs: 'اللغات', card_more: 'و{n} أخرى', card_foot: 'بقدر ما تتكلم من لغات تنفتح لك عوالم. إلى أين بعد؟', share_text: 'جواز لغاتي 🌍 أصل إلى {pct} من سكان العالم!', copy: 'نسخ الرابط', copied: 'تم نسخ الرابط!', share_img: 'مشاركة الصورة' },
        he: { btn: 'דרכון שפות', title: 'דרכון שפות', name_ph: 'השם שלך (לא חובה)', add_ph: 'הוסיפו שפה שאתם דוברים…', no_results: 'לא נמצאה שפה מתאימה', empty: 'הוסיפו את השפות שאתם דוברים כדי לראות לכמה אנשים אתם יכולים להגיע.', intro: 'בחרו את השפות שאתם דוברים וראו לאיזה חלק מהעולם אתם מגיעים — ואז שתפו את דרכון השפות שלכם.', s_langs: 'שפות', s_reach: 'אנשים בהישג', s_world: 'מאוכלוסיית העולם', s_countries: 'מדינות', s_families: 'משפחות', plot: 'להציג על המפה', clear_plot: 'לנקות את המפה', make_img: 'ליצור את הדרכון שלי', download: 'הורדה', share: 'שיתוף', close: 'סגירה', back: 'חזרה', folded: '≈ נספר בתוך {name}', card_my: 'דרכון השפות שלי', card_of: 'שפות', card_reach: 'אנשים שאני יכול להגיע אליהם', card_world: 'מאוכלוסיית העולם', card_note: 'סך מצטבר — ייתכנו חפיפות', card_countries: 'מדינות', card_families: 'משפחות', spk: 'דוברים', res_ph: 'היכן אתם גרים (לא חובה)', card_langs: 'שפות', card_more: 'ועוד {n}', card_foot: 'כמספר השפות שאתם דוברים, כך מספר העולמות. לאן הלאה?', share_text: 'דרכון השפות שלי 🌍 אני מגיע ל־{pct} מאוכלוסיית העולם!', copy: 'העתקת קישור', copied: 'הקישור הועתק!', share_img: 'שיתוף תמונה' },
        sw: { btn: 'Pasi ya Lugha', title: 'Pasi ya Lugha', name_ph: 'Jina lako (si lazima)', add_ph: 'Ongeza lugha unayoizungumza…', no_results: 'Hakuna lugha inayolingana', empty: 'Ongeza lugha unazozungumza ili uone unaweza kuwafikia watu wangapi.', intro: 'Chagua lugha unazozungumza uone unaweza kufikia sehemu gani ya dunia — kisha shiriki Pasi yako ya Lugha.', s_langs: 'lugha', s_reach: 'watu wanaofikiwa', s_world: 'ya watu wa dunia', s_countries: 'nchi', s_families: 'familia', plot: 'Onyesha kwenye ramani', clear_plot: 'Futa ramani', make_img: 'Tengeneza pasi yangu', download: 'Pakua', share: 'Shiriki', close: 'Funga', back: 'Rudi', folded: '≈ imehesabiwa ndani ya {name}', card_my: 'Pasi Yangu ya Lugha', card_of: 'lugha', card_reach: 'watu ninaoweza kuwafikia', card_world: 'ya watu wa dunia', card_note: 'jumla — huenda kuna marudio', card_countries: 'nchi', card_families: 'familia', spk: 'wasemaji', res_ph: 'Unapoishi (si lazima)', card_langs: 'Lugha', card_more: 'na nyingine {n}', card_foot: 'Kadiri ya lugha unazojua, ndivyo dunia zinavyokuwa nyingi. Wapi tena?', share_text: 'Pasi yangu ya Lugha 🌍 Ninafikia {pct} ya watu wa dunia!', copy: 'Nakili kiungo', copied: 'Kiungo kimenakiliwa!', share_img: 'Shiriki picha' },
    };
    function ui() {
