...
const NM_UI = {
  en: {
    ...
    category:'Category', noForm:'No common form', random:'Random name', details:'Details', simpleDisplay:'Simple display',
  ...
  ja: {
    ...
    category:'分類', noForm:'一般的な対応形なし', random:'ランダムな名前', details:'詳細', simpleDisplay:'シンプル表示',
