...
const NM_LANGS = {
  ...
  pt_br: { name:{en:'Portuguese', ja:'ポルトガル語'}, country:{en:'Brazil',     ja:'ブラジル'},   lat:-10.0, lng:-52.0 },
...
NAMES.john = {
  ...
  forms:{
    ...
    pt_br: { form:'João', rom:'João',  ipa:'ʒuɐ̃w', freq:'very-common', people:['João Havelange'] },
...
NAMES.mary = {
  ...
  forms:{
    ...
    pt_br: { form:'Maria',  rom:'Maria',  ipa:'maˈɾiɐ', freq:'very-common' },
...
NAMES.muhammad = {
  ...
  forms:{
    ...
    hi:  { form:'मुहम्मद', rom:'Muhammad', ipa:'mʊɦəmməd̪', freq:'common' },
...
NAMES.joseph = {
  ...
  forms:{
    ...
    ko:  { form:'요셉', rom:'Yosep', ipa:'jo.sep̚', freq:'moderate', note:{en:'a real Korean given name (Christian baptismal)',ja:'実在する韓国人の名（キリスト教の洗礼名）'} },
...
NAMES.michael = {
  ...
  forms:{
    ...
    ga:  { form:'Mícheál', rom:'Mícheál', ipa:'ˈmʲiːçaːl', freq:'common', people:['Micheál Martin'] },
...
NAMES.george = {
  ...
  forms:{
    ...
    pt_br: { form:'Jorge',    rom:'Jorge',    ipa:'ˈʒɔʁʒi',  freq:'common',      people:['Jorge Amado','Jorge Ben Jor'] },
    ...
    hu:  { form:'György',   rom:'György',   ipa:'ɟørɟ',   freq:'common',      note:{en:'Gyuri dim.',ja:'愛称ジュリ'}, people:['György Ligeti','György Lukács'] },
    ...
    ar:  { form:'جرجس',     rom:'Jirjis',   ipa:'dʒirdʒis', freq:'moderate',  note:{en:'Saint George (Mār Jirjis); Christians also use Jūrj جورج',ja:'聖ゲオルギオス（マール・ジルジス）。キリスト教徒はジュルジ جورج も'} },
...
NAMES.sophia = {
  ...
  forms:{
    ...
    pt_br: { form:'Sofia',   rom:'Sofia',   ipa:'soˈfiɐ',   freq:'very-common' },
