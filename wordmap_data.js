...
const LANG_DATA = {
  ...
  ja_oki: { name: 'Okinawan', native: 'うちなーぐち', lat: 26.33, lng: 127.80,
    wordEvidence: {
      ...
      love:  { evidence: 'direct', source: '国立国語研究所『沖縄語辞典』(首里方言) — 「あいじょう〔愛情〕」→ sinasaki, zooee; headword sinasaki 名「なさけ。思いやり。また,男女の愛情。情愛」', note: 'reader report from @Soda_Limer on X (2026-08); replaces 愛 eː, which was simply wrong: the dictionary lists ?ee as (1) an interjection「おい。もし」, (2)「うち(のうち)」and (3)「藍」— indigo. Not love. Chose sinasaki over the reader\'s suggested nasaki because nasaki is glossed 〔文〕「情。あわれむ心」(literary compassion) while sinasaki is explicitly「男女の愛情。情愛」and is what the 愛情 index points to first' },
      good:  { evidence: 'direct', source: '国立国語研究所『沖縄語辞典』(首里方言) — ゆたしゃん (dictionary romanization \'jutasjaN) 形「1.よい。いい。よろしい。良好である。善良である」', note: 'kana reading follows 大琉球語辞典, which renders this 首里 headword ユタサン in both its いい and 良い result sets, and which distinguishes サン/シャン/シャ elsewhere (与論 ユタシャン, 伊江島 ユタシャ). The 沖縄語辞典 own romanization is \'jutasjaN, which would read ゆたしゃん — the discrepancy is recorded here rather than silently resolved. Replaces まし maɕi, which that same dictionary lists as a NOUN — masi ①名「まし。一方よりまさること。一方よりよいこと」— i.e. "better/preferable", not the general adjective "good". Citation form: adjectives are outside the Ryukyuan connective extension (verbs only). The 連用形 ゆたしく yutaɕiku confirms the ɕ in the stem' },
    } },
