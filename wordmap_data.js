...
const LANG_DATA = {
  ...
  oko: { name: 'Old Korean (Silla)', native: '古代韓國語', lat: 35.85, lng: 129.22, // Gyeongju (Silla capital)
    ...
    wordEvidence: {
      ...
      mother: { evidence: 'direct', source: '安民歌 (Anminga, 756 CE, Samguk Yusa) — 君隱父也 臣隱愛賜尸母史也 "the lord is father, the minister is a loving mother". 母史 is logogram 母 + phonogram 史 as 末音添記, the same pattern as this row\'s 月羅理 and 二肹', note: 'the cell previously read 阿米 *əmi, which is not attested anywhere; it was briefly blanked on the belief that no Silla-era attestation existed at all. Wrong on both counts — 母史 is in a dated hyangga. Note it is also a DIFFERENT WORD: Old Korean 어시 *əsi, which survives into MK as 어시 "parent", not 어미 *əmi "mother", whose earliest attestation is 丫彌 in the 鷄林類事 (1103) and now sits on ko_gor. The reading 어시 is the standard decipherment (Yang Ju-dong 1942, Kim Wan-jin 1980); 史 gives /s/, and ᅀ is taken to postdate this stage, so *əsi rather than *əzi' },
