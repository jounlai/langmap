...
const WM_UI = {
  ja: { native:'現地名', size:'サイズ', word:'表記', ipa:'発音', ipaCol:'発音/転写', wordCol:'表記', concept:'概念', name:'言語名', onlyCompare:'選択のみ', onlyCompareCol:'比較リストの言語だけ表示', pins:'ピン', back:'← LangMap', family:'語族', speakers:'話者数', countries:'使用国', official:'公用語', script:'文字', url:'langmaps.com/wordmap.html', modern:'現代言語', historical:'歴史言語' },
  ko: { native:'현지어', size:'크기', word:'표기', ipa:'발음', ipaCol:'발음/전사', wordCol:'표기', concept:'개념', name:'언어명', onlyCompare:'선택만', onlyCompareCol:'비교 목록의 언어만 표시', pins:'핀', back:'← LangMap', family:'어족', speakers:'화자 수', countries:'사용 국가', official:'공용어', script:'문자', url:'langmaps.com/wordmap.html', modern:'현대 언어', historical:'역사 언어' },
  zh: { native:'当地语', size:'大小', word:'写法', ipa:'发音', ipaCol:'发音/转写', wordCol:'写法', concept:'概念', name:'语言名', onlyCompare:'仅所选', onlyCompareCol:'只显示对比列表中的语言', pins:'地点', back:'← LangMap', family:'语族', speakers:'使用人数', countries:'使用国家', official:'官方语言', script:'文字', url:'langmaps.com/wordmap.html', modern:'现代语言', historical:'历史语言' },
  yue: { native:'當地語', size:'大細', word:'寫法', ipa:'發音', ipaCol:'發音/轉寫', wordCol:'寫法', concept:'概念', name:'語言名', onlyCompare:'淨係揀嘅', onlyCompareCol:'淨係顯示對比清單入面嘅語言', pins:'地點', back:'← LangMap', family:'語族', speakers:'使用人數', countries:'使用國家', official:'官方語言', script:'文字', url:'langmaps.com/wordmap.html', modern:'現代語言', historical:'歷史語言' },
  vi: { native:'Bản địa', size:'Cỡ', word:'Chữ viết', ipa:'Phiên âm', ipaCol:'Phiên âm / Ký âm', wordCol:'Chữ viết / Phiên tự', concept:'Khái niệm', name:'Tên ngôn ngữ', onlyCompare:'Chỉ chọn', onlyCompareCol:'Chỉ hiện các ngôn ngữ trong danh sách so sánh', pins:'Ghim', back:'← LangMap', family:'Ngữ hệ', speakers:'Số người nói', countries:'Quốc gia', official:'Ngôn ngữ chính thức', script:'Chữ viết', url:'langmaps.com/wordmap.html', modern:'Hiện đại', historical:'Ngôn ngữ lịch sử' },
  th: { native:'ท้องถิ่น', size:'ขนาด', word:'รูปเขียน', ipa:'สัทอักษร', ipaCol:'สัทอักษร / ถ่ายถอด', wordCol:'รูปเขียน', concept:'ความหมาย', name:'ชื่อภาษา', onlyCompare:'เฉพาะที่เลือก', onlyCompareCol:'แสดงเฉพาะภาษาในรายการเปรียบเทียบ', pins:'หมุด', back:'← LangMap', family:'ตระกูลภาษา', speakers:'ผู้พูด', countries:'ประเทศ', official:'ภาษาราชการ', script:'อักษร', url:'langmaps.com/wordmap.html', modern:'สมัยใหม่', historical:'ภาษาประวัติศาสตร์' },
  id: { native:'Lokal', size:'Ukuran', word:'Ejaan', ipa:'Lafal', ipaCol:'IPA / Transkripsi', wordCol:'Ejaan / Transliterasi', concept:'Konsep', name:'Nama bahasa', onlyCompare:'Hanya', onlyCompareCol:'Hanya tampilkan bahasa dalam daftar perbandingan', pins:'Pin', back:'← LangMap', family:'Rumpun bahasa', speakers:'Penutur', countries:'Negara', official:'Bahasa resmi', script:'Aksara', url:'langmaps.com/wordmap.html', modern:'Modern', historical:'Bahasa historis' },
  hi: { native:'स्थानीय', size:'आकार', word:'लेखन', ipa:'उच्चारण', ipaCol:'उच्चारण / लिप्यंतरण', wordCol:'लेखन / लिप्यंतरण', concept:'अवधारणा', name:'भाषा नाम', onlyCompare:'केवल चयनित', onlyCompareCol:'केवल तुलना सूची की भाषाएँ दिखाएँ', pins:'पिन', back:'← LangMap', family:'भाषा परिवार', speakers:'वक्ता', countries:'देश', official:'राजभाषा', script:'लिपि', url:'langmaps.com/wordmap.html', modern:'आधुनिक', historical:'ऐतिहासिक भाषा' },
  en: { native:'Native', size:'Size', word:'Form', ipa:'Pron.', ipaCol:'IPA / Transcription', wordCol:'Form / Transliteration', concept:'Concept', name:'Name', onlyCompare:'Only', onlyCompareCol:'Show only the languages in the comparison list', pins:'Pins', back:'← LangMap', family:'Language family', speakers:'Speakers', countries:'Countries', official:'Official in', script:'Script', url:'langmaps.com/wordmap.html', modern:'Modern', historical:'Historical' },
  de: { native:'Einheimisch', size:'Größe', word:'Form', ipa:'Aussprache', ipaCol:'IPA / Transkription', wordCol:'Form / Transliteration', concept:'Konzept', name:'Sprache', onlyCompare:'Nur', onlyCompareCol:'Nur die Sprachen aus der Vergleichsliste zeigen', pins:'Pins', back:'← LangMap', family:'Sprachfamilie', speakers:'Sprecher', countries:'Länder', official:'Amtssprache', script:'Schrift', url:'langmaps.com/wordmap.html', modern:'Modern', historical:'Historisch' },
  fr: { native:'Locale', size:'Taille', word:'Forme', ipa:'API', ipaCol:'API / Transcription', wordCol:'Forme / Translittération', concept:'Concept', name:'Nom', onlyCompare:'Seuls', onlyCompareCol:"N'afficher que les langues de la liste de comparaison", pins:'Repères', back:'← LangMap', family:'Famille', speakers:'Locuteurs', countries:'Pays', official:'Langue officielle', script:'Écriture', url:'langmaps.com/wordmap.html', modern:'Moderne', historical:'Historique' },
  it: { native:'Locale', size:'Dimensione', word:'Forma', ipa:'IPA', ipaCol:'IPA / Trascrizione', wordCol:'Forma / Traslitterazione', concept:'Concetto', name:'Nome', onlyCompare:'Solo', onlyCompareCol:"Mostra solo le lingue nell'elenco di confronto", pins:'Punti', back:'← LangMap', family:'Famiglia linguistica', speakers:'Parlanti', countries:'Paesi', official:'Lingua ufficiale', script:'Scrittura', url:'langmaps.com/wordmap.html', modern:'Moderno', historical:'Storico' },
  es_eu: { native:'Local', size:'Tamaño', word:'Forma', ipa:'AFI', ipaCol:'AFI / Transcripción', wordCol:'Forma / Transliteración', concept:'Concepto', name:'Nombre', onlyCompare:'Solo', onlyCompareCol:'Mostrar solo los idiomas de la lista de comparación', pins:'Puntos', back:'← LangMap', family:'Familia lingüística', speakers:'Hablantes', countries:'Países', official:'Idioma oficial', script:'Escritura', url:'langmaps.com/wordmap.html', modern:'Moderno', historical:'Histórico' },
  es_mx: { native:'Local', size:'Tamaño', word:'Forma', ipa:'AFI', ipaCol:'AFI / Transcripción', wordCol:'Forma / Transliteración', concept:'Concepto', name:'Nombre', onlyCompare:'Solo', onlyCompareCol:'Mostrar solo los idiomas de la lista de comparación', pins:'Puntos', back:'← LangMap', family:'Familia lingüística', speakers:'Hablantes', countries:'Países', official:'Idioma oficial', script:'Escritura', url:'langmaps.com/wordmap.html', modern:'Moderno', historical:'Histórico' },
  pt_eu: { native:'Local', size:'Tamanho', word:'Forma', ipa:'AFI', ipaCol:'AFI / Transcrição', wordCol:'Forma / Transliteração', concept:'Conceito', name:'Nome', onlyCompare:'Só', onlyCompareCol:'Mostrar apenas as línguas da lista de comparação', pins:'Pontos', back:'← LangMap', family:'Família linguística', speakers:'Falantes', countries:'Países', official:'Língua oficial', script:'Escrita', url:'langmaps.com/wordmap.html', modern:'Moderno', historical:'Histórico' },
  pt_br: { native:'Local', size:'Tamanho', word:'Forma', ipa:'AFI', ipaCol:'AFI / Transcrição', wordCol:'Forma / Transliteração', concept:'Conceito', name:'Nome', onlyCompare:'Só', onlyCompareCol:'Mostrar apenas os idiomas da lista de comparação', pins:'Pontos', back:'← LangMap', family:'Família linguística', speakers:'Falantes', countries:'Países', official:'Língua oficial', script:'Escrita', url:'langmaps.com/wordmap.html', modern:'Moderno', historical:'Histórico' },
  ru: { native:'Местный', size:'Размер', word:'Форма', ipa:'МФА', ipaCol:'МФА / Транскрипция', wordCol:'Форма / Транслитерация', concept:'Понятие', name:'Название', onlyCompare:'Только', onlyCompareCol:'Показывать только языки из списка сравнения', pins:'Точки', back:'← LangMap', family:'Языковая семья', speakers:'Носители', countries:'Страны', official:'Официальный', script:'Письменность', url:'langmaps.com/wordmap.html', modern:'Современные', historical:'Исторические' },
  uk: { native:'Місцева', size:'Розмір', word:'Форма', ipa:'МФА', ipaCol:'МФА / Транскрипція', wordCol:'Форма / Транслітерація', concept:'Поняття', name:'Назва', onlyCompare:'Лише', onlyCompareCol:'Показувати лише мови зі списку порівняння', pins:'Точки', back:'← LangMap', family:'Мовна сім\'я', speakers:'Носії', countries:'Країни', official:'Офіційна', script:'Писемність', url:'langmaps.com/wordmap.html', modern:'Сучасні', historical:'Історичні' },
  ar: { native:'محلي', size:'الحجم', word:'كتابة', ipa:'صوتي', ipaCol:'صوتي / نسخ', wordCol:'كتابة / حرفنة', concept:'مفهوم', name:'الاسم', onlyCompare:'المحددة فقط', onlyCompareCol:'إظهار لغات قائمة المقارنة فقط', pins:'نقاط', back:'← LangMap', family:'عائلة اللغة', speakers:'المتحدثون', countries:'البلدان', official:'رسمية في', script:'الخط', url:'langmaps.com/wordmap.html', modern:'حديثة', historical:'تاريخية' },
  he: { native:'מקומי', size:'גודל', word:'כתיב', ipa:'תעתיק', ipaCol:'תעתיק / תמלול', wordCol:'כתיב / תעתיק', concept:'מושג', name:'שם', onlyCompare:'רק אלה', onlyCompareCol:'להציג רק את השפות שברשימת ההשוואה', pins:'נקודות', back:'← LangMap', family:'משפחת שפות', speakers:'דוברים', countries:'מדינות', official:'רשמית ב', script:'כתב', url:'langmaps.com/wordmap.html', modern:'מודרניות', historical:'היסטוריות' },
  sw: { native:'Asili', size:'Ukubwa', word:'Umbo', ipa:'IPA', ipaCol:'IPA / Unukuzi', wordCol:'Umbo / Tafsiri', concept:'Dhana', name:'Jina', onlyCompare:'Zilizochaguliwa', onlyCompareCol:'Onyesha lugha za orodha ya kulinganisha pekee', pins:'Vituo', back:'← LangMap', family:'Familia ya lugha', speakers:'Wasemaji', countries:'Nchi', official:'Rasmi katika', script:'Hati', url:'langmaps.com/wordmap.html', modern:'Kisasa', historical:'Lugha za kihistoria' },
};
