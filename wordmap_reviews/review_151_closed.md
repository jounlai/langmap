...
- ✓ ACCEPT — verified live: words/hello.js `ja_mvi: ["んみゃーち", "n̩mjaːt͡ɕi"]` — proposed initial syllabic nasal n̩ is present.
- ✓ ACCEPT — verified live: words/one.js `ojp: ["比登都", "pitətu"]` — proposed kō-rui pi₁ (plain i) is present; otsu ï corrected.
...
| item | verdict |
|---|---|
| 1. ja_mvi — hello — ipa | ✓ ACCEPT (APPLIED verified) |
| 2. ojp — one — ipa | ✓ ACCEPT (APPLIED verified) |
