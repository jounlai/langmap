...
- ✓ ACCEPT — verified live: words/eye.js:146 `km: ["ភ្នែក", "pʰnɛːk"]` — proposed pʰnɛːk present (aspirated p-series ភ; matches sibling okz/kxm).
- ✓ ACCEPT — verified live: words/dog.js:146 `km: ["ឆ្កែ", "cʰkae"]` — proposed cʰkae present (first-series diphthong ae).
...
| item | verdict |
|------|---------|
| 1. km — eye — pʰnɛːk | ✓ ACCEPT (live: pʰnɛːk) |
| 2. km — dog — cʰkae | ✓ ACCEPT (live: cʰkae) |
