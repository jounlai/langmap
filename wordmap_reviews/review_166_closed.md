...
✓ ACCEPT — verified live: words/father.js line 489 `fy: ["heit", "hɛit"]` matches the review's Proposed value. The 'ei' digraph correctly renders the falling diphthong /ɛi/. `node validate_wordmap_data.js` → PASS.
...
| Item | Verdict |
|------|---------|
| 1. fy — father `["heit", "hɛit"]` | ✓ ACCEPT (verified live) |
