...
All four findings re-verified read-only against current live `words/*.js`.

- ✓ ACCEPT — verified live: `words/moon.js` hy = `["լուսին", "luˈsin"]` (proposed luˈsin present).
- ✓ ACCEPT — verified live: `words/cat.js` hy = `["կատու", "kɑˈtu"]` (proposed kɑˈtu present).
- ✓ ACCEPT — verified live: `words/hello.js` hy = `["բարև", "bɑˈɾev"]` (proposed bɑˈɾev present).
- ✓ ACCEPT — verified live: `words/sun.js` el = `["ήλιος", "ˈiʎos"]` (proposed ˈiʎos present).
...
| item | verdict |
|---|---|
| 1. hy moon luˈsin | ✓ ACCEPT |
| 2. hy cat kɑˈtu | ✓ ACCEPT |
| 3. hy hello bɑˈɾev | ✓ ACCEPT |
| 4. el sun ˈiʎos | ✓ ACCEPT |
