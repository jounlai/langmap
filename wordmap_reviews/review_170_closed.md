...
- ✓ ACCEPT — verified live: `words/eat.js:465` `gn: ["karu", "kaˈɾu"]` matches the review's Proposed value exactly. APPLIED edit confirmed (former 'kaʼu' = 'to get drunk' correctly replaced by intransitive 'to eat' = 'karu', final stress + tap). `node validate_wordmap_data.js` → PASS (0 failures).
...
| item | verdict |
|------|---------|
| 1. `gn` — eat — karu | ✓ ACCEPT (verified live) |
