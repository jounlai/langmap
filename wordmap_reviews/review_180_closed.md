...
- ✓ ACCEPT — verified live: words/hello.js `ur: ["السلام علیکم", "əsːalaːm əlaɪkʊm"]` matches the proposed value (APPLIED).
- ✓ ACCEPT — verified live: words/love.js `ur: ["محبت", "mʊhəbːət"]` matches the proposed value (APPLIED).
...
| item | verdict |
|------|---------|
| 1. `ur` hello ipa | ✓ ACCEPT (applied, verified live) |
| 2. `ur` love ipa | ✓ ACCEPT (applied, verified live) |
