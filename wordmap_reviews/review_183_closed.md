...
✓ ACCEPT — verified live: `words/hello.js:971` `ko_hg: ["안녕하시꼬마", "annjʌŋhaɕik͈oma"]`. Proposed fortis diacritic `k͈` is present (kː→k͈ applied). `node validate_wordmap_data.js` PASS.
...
| item | verdict |
|------|---------|
| 1. ko_hg hello ipa (kː→k͈) | ✓ ACCEPT |
