...
- ✓ ACCEPT — verified live: `words/good.js:311` `sl: ["dober", "doːbər"]` — matches proposed `doːbər`.
- ✓ ACCEPT — verified live: `words/moon.js:163` `uk: ["місяць", "ˈmʲisʲɑt͡sʲ"]` — matches proposed `ˈmʲisʲɑt͡sʲ`; sibling `rue` at `:757` `["місяць", "ˈmʲisʲat͡sʲ"]` confirms the /mʲ/ pattern.
...
| item | verdict |
|------|---------|
| 1. `sl` good ipa | ✓ ACCEPT |
| 2. `uk` moon ipa | ✓ ACCEPT |
