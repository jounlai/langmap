...
- ✓ ACCEPT — verified live: words/love.js:537 `nci: ["tlazōhtla", "tɬasoːhtɬa"]`. Saltillo [h] restored as proposed; consistent with sibling words/thanks.js:530 `nci: ["tlazōhcāmati", "tɬasoːhkaːmati"]`.
- ✓ ACCEPT — verified live: words/thanks.js:169 `eu: ["eskerrik asko", "esˈkerik ˈasko"]`. Geminate [rː] replaced by trill [r] as proposed; surface preserved.
...
| item | verdict |
|------|---------|
| 1. nci — love — ipa | ✓ ACCEPT |
| 2. eu — thanks — ipa | ✓ ACCEPT |
