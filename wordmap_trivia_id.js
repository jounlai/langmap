...
window.TRIVIA_I18N['id'] = {
  'piraha-no-numbers': {
    ...
    body: `
<p>Jauh di pedalaman Amazon Brasil, kurang dari 800 orang berbicara <strong>Pirahã</strong> (dilafalkan kira-kira <em>pii-da-HAN</em>). Bahasa ini adalah bahasa terisolasi — tidak ada kerabat terbukti di mana pun di Bumi — dan telah menjadi salah satu kasus paling sengit diperdebatkan dalam linguistik modern.</p>
