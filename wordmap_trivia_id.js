// === Linguistic trivia — Indonesian (id) translations ===
// Auto-generated translations of TRIVIA_ARTICLES into Bahasa Indonesia.
// Loaded after wordmap_trivia.js; the wordmap renderer picks language by UI lang.

window.TRIVIA_I18N = window.TRIVIA_I18N || {};
window.TRIVIA_I18N['id'] = {
  'piraha-no-numbers': {
    title: 'Pirahã — bahasa yang dikatakan tidak memiliki angka',
    summary: 'Bahasa terisolasi kecil di Amazon yang konon tidak memiliki kata bilangan, istilah warna dasar, maupun rekursi tata bahasa — dan mengguncang teori bahasa berusia 60 tahun.',
    body: `
<p>Jauh di pedalaman Amazon Brasil, beberapa ratus orang berbicara <strong>Pirahã</strong> (dilafalkan kira-kira <em>pii-da-HAN</em>). Bahasa ini adalah bahasa terisolasi — tidak ada kerabat terbukti di mana pun di Bumi — dan telah menjadi salah satu kasus paling sengit diperdebatkan dalam linguistik modern.</p>

<div class="trivia-actions">
  <button type="button" class="trivia-action" data-action="focus" data-code="myp" data-zoom="6">📍 Tampilkan Pirahã di peta</button>
  <button type="button" class="trivia-action" data-action="panto" data-lat="-5" data-lng="-62" data-zoom="4" data-codes="myp">🌳 Terbang ke cekungan Amazon</button>
</div>
...
<div class="trivia-actions">
  <button type="button" class="trivia-action" data-action="setword" data-word="one" data-code="myp">🔢 Lihat "satu" di berbagai bahasa</button>
...
<p>Yang kurang diperdebatkan, meski tetap dibahas, adalah norma budaya yang membatasi pembicaraan pada peristiwa yang dialami langsung serta transmisi multi-saluran Pirahã yang mencolok. Tidak peduli pihak mana yang menang dalam perang rekursi, Pirahã telah melakukan apa yang sangat sedikit bahasa pernah lakukan: membuat para linguis kembali mempertanyakan apakah bahasa membentuk pikiran — atau pikiran membentuk bahasa.</p>
  ...
  'silbo-gomero': {
    title: 'Silbo Gomero — bahasa Spanyol yang disiulkan melintasi jurang',
    summary: 'Di sebuah pulau vulkanik kecil di Atlantik, para gembala mengubah bahasa Spanyol menjadi siulan murni dan dapat berbicara melintasi jurang sejauh dua kilometer. UNESCO mendaftarkannya pada 2009; kini ia diajarkan di setiap sekolah dasar di La Gomera.',
    body: `
<p>Pulau <strong>La Gomera</strong> di Kepulauan Canary diukir oleh barranco yang dalam dan hampir vertikal — jurang begitu curam sehingga tetangga yang terlihat di seberang jurang mungkin berjarak satu jam berjalan kaki. Jauh sebelum telepon seluler, orang Gomera memecahkan ini dengan salah satu <strong>bahasa siulan</strong> paling rumit di dunia: <em>Silbo Gomero</em>, "siulan Gomera".</p>

<div class="trivia-actions">
  <button type="button" class="trivia-action" data-action="panto" data-lat="28.10" data-lng="-17.20" data-zoom="7">🗺️ Terbang ke La Gomera</button>
</div>

<p>Silbo bukanlah kode atau seperangkat sinyal. Ia adalah <strong>register bahasa Spanyol yang terartikulasi penuh</strong>: setiap kata Spanyol secara prinsip dapat disiulkan, dan seorang silbador yang fasih dapat melakukan percakapan tak terbatas tentang cuaca, harga ternak, atau pertandingan sepak bola tadi malam. Kuncinya adalah bahwa siulan mengurangi seluruh inventaris vokal dan konsonan bahasa Spanyol menjadi seperangkat <em>gerakan bernada</em> yang jauh lebih kecil:</p>

<ul>
  <li><strong>Dua "vokal"</strong> dibedakan oleh nada — nada lebih tinggi mencakup Spanyol <em>/i, e/</em> dan nada lebih rendah mencakup <em>/a, o, u/</em>.</li>
  <li><strong>Empat "konsonan"</strong> dibedakan berdasarkan apakah siulan terputus atau bersambung, dan apakah nada naik atau turun menuju vokal berikutnya.</li>
...
<div class="trivia-actions">
  ...
  <button type="button" class="trivia-action" data-action="panto" data-lat="-22" data-lng="20" data-zoom="5">🗺️ Terbang ke jantung Taa</button>
</div>

<p>Taa adalah <strong>bahasa Tuu</strong> (sebelumnya dikelompokkan dengan "Khoisan Selatan" yang kini ditolak) yang dituturkan di desa-desa tersebar di Kalahari barat daya, sebagian besar di Botswana dengan komunitas kecil di Namibia. Perkiraan menempatkan komunitas penutur sekitar <strong>2.500 orang</strong>, yang semuanya dwibahasa dalam Tswana, Afrikaans, atau Khoekhoegowab — jadi meskipun bahasa ini belum sekarat, setiap pewarisan generasi adalah lemparan koin.</p>

<p>Kemewahan fonologisnya memiliki tiga lapisan:</p>

<ul>
  <li><strong>Lima jenis klik utama.</strong> Dental <em>|</em>, lateral <em>||</em>, alveolar <em>!</em>, palatal <em>ǂ</em>, dan bilabial <em>ʘ</em>. Klik bilabial — dibuat dengan letupan mirip ciuman — bertahan hanya di segelintir bahasa di seluruh dunia; Taa adalah salah satunya.</li>
  <li><strong>Sekitar 17 pengiring klik.</strong> Setiap klik dapat bersuara, tak bersuara, beraspirasi, terglotalisasi, ternasalisasi, prenasalisasi, bersuara berdesah, atau dikombinasikan dengan pelepasan uvular dan ejektif. Kalikan 5 × 17 dan inventaris klik saja melebihi seluruh sistem konsonan Hawaii beberapa kali lipat.</li>
  <li><strong>Rangkaian konsonan non-klik terpisah</strong> hampir sebesar seluruh inventaris bahasa normal, dengan kontras langka seperti afrikat ejektif uvular <em>q'χ</em>.</li>
</ul>
...
<p>Taa secara umum digambarkan sebagai <strong>sangat terancam punah</strong>. Beberapa ratus anak yang masih memperolehnya tumbuh berdampingan dengan sekolah berbahasa Tswana dan gaya hidup yang semakin mobile. Jika Taa terdiam di generasi berikutnya, dunia kehilangan bukan hanya warisan satu komunitas tetapi laboratorium alami terkaya yang pernah dimiliki ilmu fonetik.</p>
  ...
  'rotokas-fewest-sounds': {
    title: 'Rotokas — bahasa dengan (hampir) bunyi paling sedikit',
    summary: 'Di pulau penghasil kakao Bougainville, dialek tengah Rotokas terkenal karena hanya memiliki sebelas fonem — enam konsonan dan lima vokal — pernah disebut sebagai inventaris fonem terkecil di dunia.',
    body: `
<p>Jika Taa adalah surga maksimalis, <strong>Rotokas</strong> adalah surga minimalis. Dituturkan oleh kira-kira 4.000 orang di pedalaman pegunungan <strong>Bougainville</strong>, pulau yang secara politis milik Papua Nugini tetapi secara geografis termasuk rantai Solomon, dialek tengah Rotokas memiliki hanya <strong>sebelas fonem berbeda</strong>: enam konsonan — <em>p, t, k, β, ɾ, ɡ</em> — dan lima vokal <em>a, e, i, o, u</em>, masing-masing dapat pendek atau panjang.</p>

<div class="trivia-actions">
  <button type="button" class="trivia-action" data-action="focus" data-code="roo" data-zoom="7">📍 Buka Rotokas di peta</button>
...
<p>Satu konsekuensi langsung adalah bahwa kata Rotokas cenderung <strong>lebih panjang</strong> daripada kata dalam bahasa yang kaya secara fonologis — kosakata kecil bunyi memerlukan lebih banyak kombinasi untuk memisahkan kata. Nama tempat seperti <em>Rotokas</em>, <em>Pipipaia</em>, <em>Togarao</em>, dan <em>Keriaka</em> memberikan rasanya: suku kata sederhana, pola berulang, hampir seperti lagu.</p>

<div class="trivia-actions">
  <button type="button" class="trivia-action" data-action="compare" data-codes="roo,haw,mi">🗣 Bandingkan Rotokas, Hawaii, dan Māori</button>
</div>
...
<div class="trivia-actions">
  <button type="button" class="trivia-action" data-action="panto" data-lat="-6.20" data-lng="155.30" data-zoom="8" data-tiles="terrain">🌋 Perbesar ke Pegunungan Crown Prince</button>
</div>

<p>Pelajaran dari Rotokas bukanlah bahwa bahasa yang lebih sederhana "lebih mudah" — setiap anak Rotokas masih memperoleh kefasihan asli dengan upaya yang sama yang dilakukan setiap bayi di mana pun untuk belajar bahasa. Sebaliknya, <strong>fakultas bahasa manusia memiliki ruang yang luar biasa di kedua arah</strong>. Dari sebelas bunyi hingga seratus enam puluh empat, sistem yang mendasarinya adalah sama.</p>
    `
  },
  'ubykh-last-speaker': {
...
<p>Yang membuat Ubykh luar biasa secara linguistik adalah inventaris fonemnya:</p>

<ul>
  <li><strong>84 konsonan fonemik.</strong> Berfaringalisasi, berlabialisasi, berpalatalisasi, ejektif — setiap parameter yang dapat melipatgandakan rangkaian konsonan, Ubykh menggunakannya. Beberapa hitungan publikasi mencapai 81, lainnya 83 atau 84; bahkan angka terendah lebih tinggi dari bahasa non-Khoisan mana pun.</li>
  <li><strong>Dua vokal fonemik.</strong> Hanya <em>/ə/</em> dan <em>/a/</em>, kadang dianalisis sebagai satu vokal yang mendasari yang warnanya ditentukan oleh konsonan sekitar. Kontras antara vokal pada dasarnya tidak melakukan kerja; konsonanlah yang melakukan segalanya.</li>
  <li><strong>Morfologi verba polipersonal.</strong> Satu bentuk verba Ubykh dapat mengkodekan subjek, objek langsung, objek tidak langsung, lokasi, arah, instrumen, dan argumen benefaktif dalam satu kata yang ditumpuk rapat — fitur struktural yang dimiliki bersama dengan sepupu Kaukasus Barat Laut-nya.</li>
</ul>
...
<p>Hari ini ada kelompok kecil etnis Ubykh di Turki, Yordania, dan Amerika Serikat yang mempelajari rekaman, mencoba revitalisasi terbatas, dan mempertahankan rasa identitas melalui organisasi solidaritas Sirkasia. Tetapi kefasihan fungsional, dengan 84 konsonan dan morfologi verbanya yang menjulang, belum kembali dan kemungkinan besar tidak akan. Ubykh tetap menjadi kasus teks buku tentang sebuah bahasa yang <strong>tertangkap dan dideskripsikan tepat pada waktunya</strong> — dan kemudian hilang pula.</p>
    `
  },
  'damin-secret-language': {
    title: 'Damin — register rahasia pria yang melanggar aturan fonologis Australia',
    summary: 'Digunakan hanya oleh pria yang telah diinisiasi di Pulau Mornington, Damin memampatkan seluruh kosakata Lardil menjadi sekitar 200 kata — dan melanggar setiap aturan bunyi Australia, dengan klik henti, lateral ingresif, dan ejektif yang tidak ditemukan di tempat lain di benua itu.',
    body: `
<p>Di seluruh benua Australia, lebih dari 250 bahasa pribumi berbagi, dengan konsistensi mengejutkan, palet bunyi tuturan yang kecil: henti tak bersuara di empat atau lima tempat artikulasi, nasal yang sesuai, beberapa lateral, dua rotik — dan sama sekali tidak ada klik, tidak ada ejektif, tidak ada implosif, tidak ada bunyi ingresif. Lalu datang <strong>Damin</strong>, dan aturan itu pecah.</p>

<div class="trivia-actions">
  <button type="button" class="trivia-action" data-action="focus" data-code="lbz_damin" data-zoom="6">🌍 Tampilkan Damin di peta</button>
  <button type="button" class="trivia-action" data-action="panto" data-lat="-16.6" data-lng="139.5" data-zoom="6">🗺️ Terbang ke Pulau Mornington</button>
</div>
...
<p>Fonologi, bagaimanapun, adalah tempat Damin melanggar norma kontinental. Ia berisi:</p>
...
<div class="trivia-actions">
  <button type="button" class="trivia-action" data-action="panto" data-lat="-16.55" data-lng="139.45" data-zoom="9">🪨 Perbesar ke Pulau Mornington</button>
</div>

<p>Damin tidak lagi ditransmisikan. Penutur terinisiasi terakhir meninggal pada 1980-an, dan tabu kerahasiaan yang mengelilingi register berarti bahwa komunitas Lardil sendiri tidak dapat begitu saja "menghidupkan kembali" dari rekaman tanpa melanggar fungsi sucinya. Yang bertahan adalah catatan lapangan Hale, sejumlah kecil pekerjaan lanjutan oleh <strong>Norvin Richards</strong> dan lainnya, dan tempat yang jauh lebih besar dalam imajinasi fonologis dunia. Untuk bahasa dengan hanya 200 kata, jejak Damin dalam teori linguistik sangat besar.</p>
    `
  },
  'khoisan-clicks': {
    title: 'Konsonan klik — lima keluarga bunyi yang menyeberangi perbatasan',
    summary: 'Lima jenis klik — dental, lateral, alveolar, palatal, dan bilabial — muncul dalam bahasa-bahasa keluarga Khoe dan Tuu Afrika selatan dan isolat Hadza, lalu melompat ke Zulu dan Xhosa Bantu melalui kontak berabad-abad dengan tetangga penutur Khoekhoe.',
    body: `
<p>Sebagian besar bahasa yang penutur bahasa Inggris pernah dengar "menggunakan" klik — tepukan bibir orang tua yang jengkel, klakan lidah tanda tidak setuju — tetapi menggunakannya secara <em>paralinguistik</em>, di luar inventaris fonem. Di <strong>Afrika selatan</strong>, sebaliknya, beberapa keluarga bahasa telah menjadikan klik sebagai konsonan nyata: blok bangunan kata sehari-hari, tidak dapat dibedakan statusnya dari <em>p</em> dan <em>t</em> dalam bahasa Inggris.</p>

<div class="trivia-actions">
  <button type="button" class="trivia-action" data-action="focus" data-code="hts" data-zoom="6">🌍 Tampilkan Hadza di peta</button>
</div>
...
<ul>
  <li><strong>Penyelarasan ergatif-absolutif.</strong> Basque menandai subjek verba transitif (sang "agen") dengan sufiks khusus <em>-k</em>, sementara objek dan subjek verba intransitif tidak ditandai. Ini langka di Eropa tetapi umum di seluruh dunia.</li>
  <li><strong>Kesesuaian polipersonal.</strong> Satu bentuk verba Basque dapat mengkodekan orang dan jumlah subjek, objek langsung, <em>dan</em> objek tidak langsung secara bersamaan: <em>dakarkiot</em> = "saya membawanya kepadanya".</li>
  <li><strong>Penghitungan vigesimal.</strong> Bilangan dibangun di atas 20: <em>hogei</em> "20", <em>berrogei</em> "40" (har. "dua-puluh"), <em>hirurogei</em> "60". Basis yang sama bertahan dalam bahasa Prancis <em>quatre-vingts</em> "80" — kemungkinan jejak substrat Basque.</li>
  <li><strong>Tidak ada gender gramatikal.</strong> Seperti bahasa Finlandia dan Turki, Basque tidak memiliki perbedaan maskulin/feminin pada nomina atau pronomina.</li>
</ul>

<div class="trivia-actions">
  <button type="button" class="trivia-action" data-action="setword" data-word="water" data-code="eu">💧 Lihat Basque "Air"</button>
...
<p>Revival itu telah berhasil: Basque kini berstatus resmi bersama bahasa Spanyol di Komunitas Otonomi Basque, diajarkan di seluruh sistem sekolah dalam tiga model imersi (A, B, D), dan digunakan di televisi, dalam sastra, dan daring. Ia tetap, seperti yang telah berlangsung selama ribuan tahun, suara pra-Indo-Eropa yang keras kepala dari Pyrenees barat — kapsul waktu linguistik dari sebuah Eropa yang tidak akan pernah kita dengar sebaliknya.</p>
    `
  },
...
<div class="trivia-actions">
  ...
  <button type="button" class="trivia-action" data-action="panto" data-lat="31.32" data-lng="45.64" data-zoom="7">𒀭 Terbang ke Uruk</button>
</div>

<p>Sumeria adalah <strong>bahasa isolat</strong>. Meskipun upaya satu abad, tidak ada kerabat terbukti yang ditemukan — tidak dalam Semit (tetangga Akkadia jauh kemudian), tidak dalam Indo-Eropa, tidak dalam Dravida, tidak dalam keluarga Kaukasus mana pun. Ia juga <strong>aglutinatif</strong> dan sebagian besar <strong>ergatif</strong>: makna dibangun dengan menumpuk morfem ke akar verbal dalam slot tetap, dan agen verba transitif mengambil akhiran kasus khusus. Rantai verbal khas terlihat seperti:</p>

<blockquote><em>i-mu-na-an-šúm</em> — "ia memberikannya kepadanya" (secara harfiah: aspek-ventif-3sg.datif-3sg.agen-beri)</blockquote>

<p>Penulisan dimulai sebagai akuntansi. Tablet paling awal — yang disebut <strong>proto-paku</strong> Uruk IV (sekitar 3200 SM) — adalah tanda terima dan daftar jatah: piktograf untuk domba, bir, minyak, dengan angka dalam sistem seksagesimal (basis-60) yang bertahan dalam jam 60 menit kita. Selama empat abad berikutnya piktograf diputar 90 derajat, distilisasi menjadi kesan berbentuk baji, dan memperoleh dimensi fonetik melalui <strong>prinsip rebus</strong>: tanda untuk sebuah objek juga mewakili bunyi namanya. Setelah sistem tulisan dapat mengeja bunyi, ia dapat mengeja apa saja — dan pada 2600 SM juru tulis Sumeria menulis sastra, hukum, dan doa.</p>
...
<div class="trivia-actions">
  <button type="button" class="trivia-action" data-action="setword" data-word="water" data-code="sux">💧 Lihat Sumeria "Air"</button>
  <button type="button" class="trivia-action" data-action="setword" data-word="house" data-code="sux">🏠 Lihat Sumeria "Rumah"</button>
</div>
...
<p>Hari ini <strong>Pennsylvania Sumerian Dictionary</strong> dan <strong>Electronic Text Corpus of Sumerian Literature</strong> (ETCSL, Oxford) memungkinkan membaca puisi tertua di dunia di ponsel. <strong>Epos Gilgamesh</strong>, dalam pendahulunya berbahasa Sumeria seperti "Gilgamesh dan Banteng Surga", termasuk kisah tertua yang pernah dituliskan umat manusia — dan masih sedang diterjemahkan.</p>
  ...
  'etruscan-mystery': {
    title: 'Etruska — bahasa yang dapat kita baca tetapi tidak bisa kita pahami',
    summary: 'Bahasa dominan Italia pra-Romawi: 13.000 inskripsi yang masih ada dalam alfabet turunan Yunani, sepenuhnya dapat dibaca secara fonetis — dan masih hanya sebagian diterjemahkan.',
    body: `
<p>Sebelum Roma adalah Roma, kekuatan dominan di Italia tengah adalah peradaban <strong>Etruska</strong> — dua belas negara-kota terbentang dari Arno hingga Tiber, ahli logam, pedagang laut, dan orang yang mengajari Romawi cara mendrapir toga, membangun lengkungan, dan mementaskan pertarungan gladiator. Mereka juga meninggalkan salah satu hadiah teraneh dari arkeologi: bahasa yang dapat kita <em>baca dengan keras</em> huruf demi huruf, tetapi hanya sebagian dipahami.</p>

<div class="trivia-actions">
  <button type="button" class="trivia-action" data-action="focus" data-code="ett" data-zoom="6">🌍 Tampilkan Etruska di peta</button>
  <button type="button" class="trivia-action" data-action="panto" data-lat="42.4" data-lng="11.9" data-zoom="7">𐌀 Terbang ke Etruria</button>
</div>

<p>Etruska ditulis dalam <strong>alfabet yang dipinjam dari Yunani Euboea</strong> sekitar 700 SM — alfabet Yunani barat yang sama yang, diteruskan melalui tangan Etruska ke Romawi, memberi dunia huruf Latin yang sedang Anda baca sekarang. Karena aksaranya alfabetis dan dipahami dengan baik, setiap inskripsi dapat ditranskripsikan secara fonetis. Kesulitannya adalah <strong>bahasa di balik aksara</strong>: Etruska bukan Indo-Eropa, bukan Semit, bukan Italik, bukan apa pun yang memiliki kerabat hidup. Satu-satunya kerabat yang diterima luas adalah dua bahasa yang sangat terfragmentasi — <strong>Raetik</strong> (di Pegunungan Alpen) dan <strong>Lemnos</strong> (di pulau Lemnos di Laut Aegea, dibuktikan dalam prasasti Kaminia abad ke-6 SM) — bersama-sama membentuk keluarga kecil <strong>Tyrsenia</strong>.</p>
...
<div class="trivia-actions">
  ...
  <button type="button" class="trivia-action" data-action="panto" data-lat="31.78" data-lng="35.22" data-zoom="9">✡️ Terbang ke Yerusalem</button>
</div>

<p>Satu orang yang paling dikaitkan dengan kebangkitan adalah <strong>Eliezer Ben-Yehuda</strong> (1858–1922), sarjana Yahudi kelahiran Lithuania yang beremigrasi ke Palestina Ottoman pada 1881 dengan satu obsesi: bahwa orang Yahudi hanya akan menjadi bangsa lagi jika mereka berbicara Ibrani. Ia menjadikan rumah tangganya sendiri laboratorium pertama. Putranya <strong>Itamar Ben-Avi</strong>, lahir di Yerusalem pada 1882, umumnya dianggap sebagai <strong>penutur asli pertama Ibrani Modern dalam kira-kira 1.700 tahun</strong>. Ben-Yehuda melarang bahasa lain di rumah; istrinya, yang tidak berbicara Ibrani ketika mereka menikah, mempelajarinya sambil bekerja. Itamar dilaporkan tidak berbicara bahasa apa pun sampai ia berusia sekitar empat tahun, dan anggota keluarga yang khawatir mendesak Ben-Yehuda untuk mengalah. Ia tidak.</p>

<p>Ben-Yehuda juga mengobarkan perang kosakata. Ibrani Alkitab dan Mishnah di antara mereka mungkin memiliki 8.000 lema — baik untuk doa, tanpa harapan untuk membeli koran. Maka Ben-Yehuda menemukan kata-kata. Beberapa masih tuturan Israel sehari-hari:</p>

<ul>
  <li><strong>milon</strong> (מילון) — "kamus", dari <em>milah</em> "kata".</li>
  <li><strong>iton</strong> (עיתון) — "koran", dari <em>et</em> "waktu".</li>
  <li><strong>ofnayim</strong> (אופניים) — "sepeda", bentuk dual dari <em>ofan</em> "roda".</li>
  <li><strong>glida</strong> (גלידה) — "es krim", dari akar yang berarti "membeku".</li>
...
<blockquote><em>A → B / X _ Y</em><br>"A menjadi B dalam konteks di mana ia didahului X dan diikuti Y" — sebuah notasi yang ditemukan kembali secara independen oleh linguistik pada 1968.</blockquote>

<p>Contoh apa yang dilakukan mesin Pāṇini:</p>

<ul>
  <li><strong>Sandhi.</strong> Sanskerta terkenal mengasimilasikan bunyi melintasi batas kata (<em>tat + ca → tac ca</em>, <em>tat + na → tan na</em>). Pāṇini mereduksi seluruh sistem ini menjadi sekumpulan kecil aturan fonologis tertib yang beroperasi secara siklik — ide yang sama ditemukan kembali sebagai <em>fonologi siklik</em> pada 1970-an.</li>
  <li><strong>Morfologi verbal.</strong> Sebuah verba Sanskerta dapat memiliki sekitar <em>2.000 bentuk infleksi</em>. Pāṇini menangani ini dengan inventaris batang berhingga, beberapa ratus aturan afiks, dan prinsip pengurutan (<em>tripādī</em>) sehingga aturan kemudian memblokir yang lebih awal — mendahului Elsewhere Conditions dalam morfologi modern.</li>
  <li><strong>Teori kāraka.</strong> Pāṇini menganalisis verba bukan dalam istilah "subjek" dan "objek" tetapi dalam istilah <em>kāraka</em> — peran semantik seperti agen (<em>kartṛ</em>), pasien (<em>karman</em>), instrumen (<em>karaṇa</em>), penerima (<em>sampradāna</em>), sumber (<em>apādāna</em>), dan lokus (<em>adhikaraṇa</em>). Ini pada dasarnya adalah <strong>teori peran tematik</strong> (tata bahasa kasus Charles Fillmore, 1968), 2.400 tahun lebih awal.</li>
</ul>

<div class="trivia-actions">
  <button type="button" class="trivia-action" data-action="setword" data-word="mother" data-code="sa">👩 Lihat Sanskerta "Ibu"</button>
...
<p>Sanskerta sendiri (<em>saṃskṛta-</em>, "dipoles, halus") sudah menjadi standar sastra dan ritual, bukan vernakular, pada zaman Pāṇini. Setelah dia ia menjadi, secara formal, apa yang dikatakan Pāṇini: sebuah bahasa yang setiap kalimat terbentuk dengan baiknya secara prinsip dapat diturunkan dari 4.000 sūtra-nya. Dua setengah ribu tahun kemudian, itu juga persis yang kita minta dari sebuah parser. Aṣṭādhyāyī tidak hanya mendeskripsikan Sanskerta. Ia mendorong gagasan tentang deskripsi bahasa yang generatif dan formal ke tingkat ketelitian yang tak tertandingi di zaman kuno — dan bisa dibilang sampai linguistik formal abad ke-20 secara independen menemukan kembali gagasan yang sama.</p>
  ...
  'esperanto-zamenhof': {
    title: 'Esperanto — conlang yang benar-benar berhasil',
    summary: 'Seorang oftalmolog Yahudi Polandia menerbitkan buklet 40 halaman pada 1887. Hari ini bahasa rancangannya memiliki hingga dua juta penutur, sekitar seribu di antaranya penutur asli — satu-satunya bahasa rancangan yang benar-benar berakar.',
    body: `
<p>Pada Juli 1887, seorang dokter mata muda di Warsawa menerbitkan buklet tipis dengan biaya sendiri dengan nama samaran <em>Doktoro Esperanto</em> — "Doktor Yang-Berharap". Bukunya berjudul <strong>Lingvo Internacia</strong> ("Bahasa Internasional"). Dalam satu generasi, nama samaran telah menjadi nama bahasa itu sendiri, dan <strong>L. L. Zamenhof</strong> telah mencapai sesuatu yang belum pernah dikelola perancang bahasa rancangan sebelumnya atau ditandingi sejak itu: ia telah membangun bahasa yang benar-benar ingin diucapkan orang biasa.</p>

<div class="trivia-actions">
  <button type="button" class="trivia-action" data-action="focus" data-code="eo" data-zoom="4">🌍 Tampilkan Esperanto di peta</button>
  <button type="button" class="trivia-action" data-action="setword" data-word="hello" data-code="eo">👋 Lihat Esperanto "Halo"</button>
</div>

<p>Zamenhof tumbuh di Białystok, kota multi-etnis di bawah kekuasaan Rusia di mana orang Yahudi, Polandia, Jerman, Rusia, dan Belarusia tinggal berdampingan dan sering saling tidak percaya. Dia kemudian menulis bahwa sebagai anak laki-laki ia menyimpulkan Babel linguistik adalah penyebab utama kebencian manusia, dan bahwa lidah bersama yang netral mungkin memberi orang-orang pijakan bersama dan setara. Proyek politik sama pentingnya baginya seperti yang gramatikal.</p>

<p>Desainnya terkenal sederhana. Tata bahasa Esperanto muat di kartu pos — "<strong>Fundamento</strong>" mereduksinya menjadi <strong>16 aturan tanpa pengecualian</strong>:</p>

<ul>
  <li>Semua nomina berakhir dengan <strong>-o</strong>, ajektiva dengan <strong>-a</strong>, adverbia dengan <strong>-e</strong>, infinitif dengan <strong>-i</strong>.</li>
  <li>Jamak selalu <strong>-j</strong>; objek langsung selalu mengambil <strong>-n</strong>.</li>
  <li>Tekanan selalu jatuh pada suku kata kedua dari akhir.</li>
  <li>Verba tidak terkonjugasi untuk persona atau jumlah — hanya untuk kala (<em>-as, -is, -os</em>) dan modus (<em>-us, -u</em>).</li>
  <li>Kata-kata dibangun secara aglutinatif dari akar plus inventaris kecil afiks: <em>mal-</em> membalikkan makna (<em>bona</em> baik → <em>malbona</em> buruk), <em>-ej-</em> menandai tempat (<em>lerni</em> belajar → <em>lernejo</em> sekolah), <em>-in-</em> menandai feminin.</li>
</ul>

<p>Kosakata sebagian besar Roman dengan bumbu Jermanik dan Slavik — kira-kira 75% Roman, 20% Jermanik, 5% Slavik dan Yunani. Ini adalah kompromi yang disengaja: Eropa tetapi tidak terkait secara nasional dengan satu kekuatan besar mana pun.</p>

<div class="trivia-actions">
  <button type="button" class="trivia-action" data-action="setword" data-word="love" data-code="eo">❤️ "Cinta" — <em>amo</em></button>
  <button type="button" class="trivia-action" data-action="setword" data-word="water" data-code="eo">💧 "Air" — <em>akvo</em></button>
  <button type="button" class="trivia-action" data-action="setword" data-word="one" data-code="eo">1️⃣ "Satu" — <em>unu</em></button>
</div>
...
<p>Zamenhof tidak pernah mengklaim Esperanto akan menggantikan bahasa ibu siapa pun. Dia menginginkan <em>dua lingvo</em> — bahasa kedua — sama-sama asing bagi semua orang, sehingga tidak ada penutur asli yang pernah memiliki keunggulan di meja perundingan. Satu setengah abad kemudian, proyek itu kecil, tetapi masih hidup, masih netral, dan masih penuh harapan — persis seperti pendirinya, <em>Doktoro Esperanto</em>, menandatangani namanya.</p>
  ...
  'toki-pona-minimalism': {
    title: 'Toki Pona — dapatkah Anda mengatakan segalanya dengan 120 kata?',
    summary: 'Seorang linguis Kanada merancang bahasa dengan hanya ~120 kata dan ~14 bunyi, sebagian sebagai eksperimen pemikiran Tao. Dua dekade kemudian, ribuan orang berbicara — dan banyak yang mengatakan itu mengubah cara mereka berpikir.',
    body: `
<p>Pada 2001, seorang linguis dan penerjemah Kanada bernama <strong>Sonja Lang</strong> (lahir Sonja Elen Kisa) berjuang melawan depresi. Sebagai bagian dari pemulihannya, ia mulai bereksperimen dengan bahasa yang sengaja minimal — bahasa yang akan memaksanya mengekspresikan ide hanya dengan menggunakan apa yang benar-benar penting. Ia menyebutnya <strong>Toki Pona</strong>, "bahasa kebaikan", atau lebih harfiah "tuturan baik / tuturan sederhana".</p>

<div class="trivia-actions">
  <button type="button" class="trivia-action" data-action="focus" data-code="tok" data-zoom="4">🌍 Tampilkan Toki Pona di peta</button>
...
<ul>
  <li><strong>9 konsonan</strong>: <em>p, t, k, s, m, n, l, j, w</em>.</li>
  <li><strong>5 vokal</strong>: <em>a, e, i, o, u</em>.</li>
  <li>Suku kata adalah (C)V(n). Tidak ada gugus konsonan, tidak ada nada, tidak ada kontras panjang.</li>
  <li>Tekanan selalu pada suku kata pertama.</li>
</ul>

<p>Itu memberi hanya sekitar <strong>14 fonem</strong> secara total — jauh lebih sedikit dari sekitar 44 bahasa Inggris — dan inventaris bunyi yang begitu tersebar luas lintas bahasa sehingga hampir setiap manusia dapat mengucapkan Toki Pona pada pendengaran pertama.</p>

<p>Jadi bagaimana Anda mengatakan apa pun dengan 120 kata? <strong>Komposisi.</strong> Toki Pona tidak memiliki kata untuk "teman", "komputer", atau "perpustakaan". Sebaliknya Anda mendeskripsikan:</p>

<ul>
  <li><em>jan pona</em> — "orang baik" → teman</li>
  <li><em>ilo sona</em> — "alat pengetahuan" → komputer</li>
  <li><em>tomo pi lipu mute</em> — "rumah dari banyak dokumen" → perpustakaan</li>
  <li><em>telo nasa</em> — "air aneh" → alkohol</li>
  <li><em>kala lawa</em> — "ikan kepala" → ikan bos, yaitu hiu, atau secara metaforis atasan Anda</li>
</ul>

<div class="trivia-actions">
  <button type="button" class="trivia-action" data-action="setword" data-word="water" data-code="tok">💧 "Air" — <em>telo</em></button>
  <button type="button" class="trivia-action" data-action="setword" data-word="sun" data-code="tok">☀️ "Matahari" — <em>suno</em></button>
...
<p>Namun komunitas terus tumbuh. Hari ini diperkirakan ada <strong>beberapa ribu penutur aktif</strong>, subreddit yang berdedikasi, Discord <em>ma pona pi toki pona</em> dengan puluhan ribu anggota, puisi orisinal, album musik, dan bahkan aksara rancangan — <em>sitelen pona</em> — di mana setiap glif adalah piktogram kecil dari satu kata inti. Apakah Toki Pona membuat Anda lebih bijaksana dapat diperdebatkan; bahwa ia membuat penuturnya <em>berpikir lebih keras tentang apa yang sebenarnya mereka maksud</em> tidak.</p>
    `
  },
  'ithkuil-complexity': {
...
<p>Sebuah contoh kalimat terkenal dari tata bahasa Quijada:</p>

<blockquote><em>Tram-mļöi hhâsmařpţuktôx.</em><br>"Sebaliknya, saya pikir mungkin akan ternyata bahwa pegunungan kasar ini berakhir di suatu titik."</blockquote>

<p>Dua kata. Sebuah kalimat bahasa Inggris penuh. Kepadatan itu adalah seluruh intinya.</p>
...
<p>Apakah Ithkuil sebuah kegagalan? Hanya jika Anda mengukur conlang berdasarkan ukuran komunitas. Sebagai sepotong <em>arsitektur linguistik</em> — demonstrasi berkelanjutan selama puluhan tahun tentang berapa banyak makna yang dapat dibawa saluran artikulasi manusia per detik tuturan — ia tidak ada bandingannya. Itu adalah Esperanto seperti roket Saturn V bagi sepeda: tidak ada yang bepergian dengannya, tetapi itu menunjukkan apa yang secara fisik mungkin.</p>
    `
  },
  'hangul-scientific-script': {
    title: 'Hangul — alfabet yang dirancang seorang raja di laboratorium',
    summary: 'Pada 1443 Raja Sejong Agung mengungkap alfabet Korea baru yang bentuk hurufnya secara harfiah mendiagramkan saluran vokal. Para linguis menyebutnya sistem penulisan yang paling ilmiah dirancang di Bumi — dan ia hampir dilarang dua kali.',
    body: `
<p>Sebagian besar alfabet berevolusi. Mereka melayang selama berabad-abad dari piktograf ke abstraksi, tidak ada yang benar-benar mengingat mengapa "B" terlihat seperti itu. <strong>Hangul</strong> tidak seperti itu. Hangul memiliki hari ulang tahun — <strong>9 Oktober 1446</strong>, tanggal penjelasan pendampingnya, <em>Hunminjeongeum Haerye</em>, diterbitkan. Dan ia memiliki satu penemu bernama: <strong>Raja Sejong Agung</strong> (世宗大王, memerintah 1418–1450) dari Joseon Korea, bekerja dengan para sarjana Hall of Worthies-nya (集賢殿, <em>Jiphyeonjeon</em>).</p>

<div class="trivia-actions">
  <button type="button" class="trivia-action" data-action="focus" data-code="ko" data-zoom="6">🌍 Tampilkan Korea di peta</button>
  <button type="button" class="trivia-action" data-action="setword" data-word="hello" data-code="ko">👋 "Halo" — <em>안녕하세요</em></button>
</div>

<p>Motivasi Sejong, dinyatakan dalam pengantar proyek, adalah salah satu pembukaan paling mengharukan dalam sejarah sistem penulisan mana pun:</p>

<blockquote>"Tuturan negara kita berbeda dari Tiongkok dan tidak cocok dengan karakter Tionghoa. Oleh karena itu, bahkan jika yang tidak terdidik ingin berkomunikasi, banyak dari mereka tidak dapat mengekspresikan diri. Berpikir dengan iba akan hal ini, saya telah merancang dua puluh delapan huruf baru, hanya berharap setiap orang dapat dengan mudah mempelajarinya dan menggunakannya dalam kehidupan sehari-hari." — Raja Sejong, pengantar <em>Hunminjeongeum</em>, 1446</blockquote>
...
<ul>
  ...
  <li><strong>ㄴ</strong> (n) menunjukkan ujung lidah menyentuh punggung alveolar di belakang gigi.</li>
...
<div class="trivia-actions">
  <button type="button" class="trivia-action" data-action="setword" data-word="one" data-code="ko">1️⃣ "Satu" — <em>하나</em> / <em>일</em></button>
  <button type="button" class="trivia-action" data-action="setword" data-word="moon" data-code="ko">🌙 "Bulan" — <em>달</em></button>
  <button type="button" class="trivia-action" data-action="setword" data-word="water" data-code="ko">💧 "Air" — <em>물</em></button>
</div>
...
<div class="trivia-actions">
  <button type="button" class="trivia-action" data-action="focus" data-code="chr" data-zoom="5">🌍 Tampilkan Cherokee di peta</button>
  <button type="button" class="trivia-action" data-action="setword" data-word="hello" data-code="chr">👋 "Halo" — <em>ᎣᏏᏲ (osiyo)</em></button>
</div>

<p>Sequoyah adalah pandai perak dan veteran cacat Resimen Cherokee di bawah Andrew Jackson dalam Perang Creek. Ia tidak berbicara bahasa Inggris dan tidak pernah bersekolah formal. Tetapi ia telah melihat tentara berbahasa Inggris membaca dan menulis surat selama perang — yang disebut orang Cherokee sebagai "daun yang berbicara" — dan ia menjadi yakin bahwa ini bukan sihir tetapi teknologi, dan bahwa rakyatnya sendiri juga layak mendapatkannya.</p>

<p>Dari sekitar 1809 ia bekerja secara obsesif pada masalah itu. Upaya pertamanya adalah logografis — satu simbol per kata — dan ia dilaporkan menggambar lebih dari seribu simbol sebelum menyadari sistem itu tidak akan dapat dipelajari. Istrinya konon membakar pekerjaannya karena frustrasi pada satu titik. Ia memulai lagi.</p>

<p>Terobosannya adalah kesadaran bahwa Cherokee, seperti bahasa Jepang, memiliki inventaris suku kata berbeda yang cukup kecil — sekitar 85. <strong>Silabari</strong>, bukan alfabet, adalah kecocokan alami. Ia menetapkan satu simbol untuk setiap suku kata. Untuk inspirasi ia menarik bentuk huruf Latin, Yunani, dan Sirilik (yang tidak dapat ia baca) ditambah bentuk asli, memperlakukan masing-masing sebagai token visual tanpa makna untuk dicocokkan dengan bunyi Cherokee. Hasilnya memiliki huruf yang tampak akrab tetapi tidak berarti apa pun yang dimaksud oleh padanan Eropa mereka:</p>

<ul>
  <li><strong>D</strong> dalam Cherokee adalah <em>a</em></li>
  <li><strong>R</strong> dalam Cherokee adalah <em>e</em></li>
  <li><strong>T</strong> dalam Cherokee adalah <em>i</em></li>
  <li><strong>L</strong> dalam Cherokee adalah <em>tle</em></li>
  <li><strong>Ꮳ</strong> terlihat Yunani tetapi adalah suku kata Cherokee <em>tsa</em></li>
</ul>

<p>Pada 1821 ia mendemonstrasikan sistem itu, dengan terkenal, dengan memisahkan putrinya yang berusia enam tahun <em>Ayoka</em> dari hadirin dan memintanya mentranskripsikan dan kemudian membacakan kembali pesan yang didiktekan kepadanya. Dewan Bangsa Cherokee tidak yakin ini bukan trik — sampai mereka mengujinya sendiri dan menemukan bahwa orang dewasa dapat menjadi melek huruf secara fungsional dalam <strong>hitungan hari, bukan tahun</strong>.</p>

<div class="trivia-actions">
  <button type="button" class="trivia-action" data-action="setword" data-word="water" data-code="chr">💧 "Air" — <em>ᎠᎹ (ama)</em></button>
  <button type="button" class="trivia-action" data-action="setword" data-word="fire" data-code="chr">🔥 "Api" — <em>ᎠᏥᎳ (atsila)</em></button>
  <button type="button" class="trivia-action" data-action="setword" data-word="moon" data-code="chr">🌙 "Bulan" — <em>ᏃᏓ (nvda)</em></button>
</div>
...
<p>Hari ini silabari Cherokee diajarkan di sekolah imersi di Tahlequah, Oklahoma dan Cherokee, North Carolina. Ia ada di Unicode (U+13A0–U+13FF), didukung oleh sistem operasi Apple dan Google, dan telah digunakan untuk menulis segala sesuatu mulai dari terjemahan Alkitab hingga unggahan media sosial modern. Pohon kayu merah pesisir California <em>Sequoia sempervirens</em> secara tradisional dikatakan dinamai menurut namanya, meski bagaimana Endlicher sampai pada nama itu pada 1847 masih diperdebatkan. Pria itu tidak bisa membaca. Ia memberi sebuah bangsa sebuah aksara.</p>
  ...
  'vai-dream-script': {
    title: 'Vai — aksara Afrika Barat yang datang dalam mimpi',
    summary: 'Sekitar 1832 seorang pria Liberia bernama Momolu Duwalu Bukele mengatakan seorang asing tak dikenal muncul kepadanya dalam mimpi dan mengajarinya aksara untuk bahasa Vai-nya sendiri. Dua abad kemudian, aksara itu ada di smartphone.',
    body: `
<p>Sejarah penulisan memiliki subgenre kecil tetapi mencolok: aksara yang penemunya mengklaim menerimanya dalam mimpi atau penglihatan. <strong>Silabari Vai</strong> dari Liberia adalah yang paling terkenal dan terdokumentasi terbaik di antara mereka — dan menjadi, pada 1834, salah satu penemuan tulisan independen pertama di Afrika Barat modern.</p>

<div class="trivia-actions">
  <button type="button" class="trivia-action" data-action="focus" data-code="vai" data-zoom="6">🌍 Tampilkan Vai di peta</button>
  <button type="button" class="trivia-action" data-action="panto" data-lat="6.5" data-lng="-11" data-zoom="6">🗺️ Terbang ke pesisir Liberia</button>
</div>

<p>Penciptanya adalah <strong>Mɔmɔlu Duwalu Bukɛlɛ</strong> (berbagai ditranskripsikan Momolu Duwalu Bukele, sekitar 1810–1850-an) dari rakyat Vai, yang tinggal di sepanjang pantai yang sekarang adalah Liberia dan Sierra Leone. Menurut wawancara yang direkam oleh misionaris Jerman <strong>S. W. Koelle</strong> pada 1849 — dan diterbitkan dalam monografnya 1854 <em>Outlines of a Grammar of the Vei Language</em> — Bukele mengatakan aksara itu datang kepadanya sekitar 1832–1833 dalam mimpi:</p>

<blockquote>"Seorang pria kulit putih jangkung yang tampak terhormat, dalam jas panjang, muncul dan berkata: 'Aku diutus kepadamu oleh orang kulit putih lain ... Aku membawa kepadamu sebuah buku.' [Pengunjung itu] kemudian menunjukkan kepadaku banyak tanda di atas kertas, tetapi aku tidak memahaminya. ... Ketika aku terbangun, aku memanggil teman-temanku bersama, dan kami mulai bekerja, dan setelah beberapa waktu kami membuat buku kami." — Catatan Bukɛlɛ, sebagaimana direkam Koelle, 1849</blockquote>
...
<ul>
  ...
  <li>Pria Vai pada abad ke-19 secara rutin saling menulis surat dalam tiga aksara tergantung penerima: <em>Vai</em> untuk sesama Vai, <em>Arab</em> untuk Muslim dari kelompok lain, dan <em>Latin</em> untuk orang Eropa.</li>
  <li>Aksara bertahan dari perang sipil Liberia (1989–2003) dan wabah Ebola 2014.</li>
</ul>
...
<p>Literasi Vai menjadi subjek <strong>studi terkenal 1981 oleh Sylvia Scribner dan Michael Cole</strong>, <em>The Psychology of Literacy</em>. Masyarakat Vai adalah — dan sampai batas tertentu masih — laboratorium alami: banyak orang dewasa melek dalam satu, dua, atau tiga aksara (Vai, Arab, Latin), masing-masing diperoleh di setting yang berbeda (Vai informal dari kerabat, Arab di sekolah Quran, Latin di sekolah gaya kolonial). Scribner dan Cole membandingkan efek kognitif masing-masing dan menyimpulkan bahwa "manfaat intelektual literasi" yang terkenal diklaim oleh sarjana sebelumnya sebagian besar <em>spesifik untuk sekolah</em>, bukan untuk literasi itu sendiri. Literasi aksara Vai, dipelajari secara informal, tidak dengan sendirinya mengubah pemikiran. Itu adalah temuan yang sangat berpengaruh dalam penelitian pendidikan.</p>

<p>Aksara Vai ditambahkan ke <strong>Unicode 5.1 pada 2008</strong> (blok U+A500–U+A63F), dan sekarang tersedia di Android, iOS, dan distribusi Linux utama. Ada stub Wikipedia berbahasa Vai, tata letak keyboard Vai, dan komunitas daring kecil tetapi gigih. Rakyat Vai sendiri tidak pernah kehilangan aksara mereka; hari ini, hampir 200 tahun setelah mimpi Bukele, seorang nenek Vai dapat ber-WhatsApp dengan cucunya dalam silabari yang sama yang ditulis seorang pria muda pada 1834 di lembaran kertas impor pertamanya.</p>

<p>Apakah mimpi itu metafora atau ingatan, Bukele memahami teknologi sosial lebih baik daripada banyak orang sezamannya di Eropa: tulisan bukan sihir, dan setiap rakyat yang menginginkannya dapat memilikinya.</p>
    `
  },
  'tangut-deciphered': {
...
<div class="trivia-actions">
  <button type="button" class="trivia-action" data-action="focus" data-code="txg" data-zoom="5">🌍 Tampilkan Tangut di peta</button>
...
<div class="trivia-actions">
  <button type="button" class="trivia-action" data-action="setword" data-word="moon" data-code="txg">🌙 Lihat Tangut "Bulan"</button>
...
<p>Tangut adalah pengingat bahwa "bahasa mati" jarang merupakan vonis akhir. Aksara yang ditemukan dalam satu dekade, digunakan oleh jutaan, dilupakan selama empat abad, masih dapat dibujuk kembali ke tuturan — asalkan seseorang cukup keras kepala untuk menghabiskan seumur hidup pada tabel rima.</p>
  ...
  'linear-a-undeciphered': {
    title: 'Linear A — aksara yang dapat kita baca tetapi tidak bisa kita pahami',
    summary: 'Sekitar 1.400 inskripsi Zaman Perunggu dari Kreta Minoa. Kita dapat membunyikan hampir setiap tanda — namun bahasa di baliknya tetap, setelah satu abad upaya, sepenuhnya tidak diketahui.',
    body: `
<p>Antara kira-kira <strong>1800 dan 1450 SM</strong>, peradaban Minoa Kreta menyimpan rekening istana, dedikasi, dan label dalam aksara silabis yang sekarang kita sebut <strong>Linear A</strong>. Sekitar <strong>1.400 inskripsi</strong> bertahan — sebagian besar singkat, digoreskan pada tablet tanah liat, meja libasi, dan kapak ganda perunggu dari situs seperti Knossos, Phaistos, Hagia Triada, dan Zakros.</p>

<div class="trivia-actions">
  <button type="button" class="trivia-action" data-action="panto" data-lat="35.30" data-lng="25.15" data-zoom="7">🗺️ Terbang ke Kreta Minoa</button>
</div>

<p>Inilah situasi anehnya. Pada 1952, arsitek muda Inggris <strong>Michael Ventris</strong>, bekerja dengan klasikis John Chadwick, memecahkan aksara saudara yang disebut <strong>Linear B</strong>. Ia menunjukkan, kepada hampir keterkejutan semua orang, bahwa Linear B mengkodekan <em>bentuk awal bahasa Yunani</em> — bahasa orang Mycenae yang mengambil alih Kreta sekitar 1450 SM. Linear B menggunakan banyak tanda silabis yang sama dengan Linear A, hanya dengan perbedaan gaya kecil. Jadi kita dapat mengambil tablet Linear A, melihat setiap tanda, dan menetapkan nilai bunyi Linear B kepadanya dengan kepercayaan yang wajar: <em>ku, ro, pi, te, da</em>…</p>

<p>Dan kemudian jejak menjadi dingin. Rangkaian suku kata yang muncul <strong>bukan bahasa Yunani</strong>. Mereka bukan Semit dengan cara apa pun yang dapat dikenali. Mereka tidak cocok dengan Hittit, Luwian, Hurrian, Mesir, atau bahasa Zaman Perunggu lain yang dibuktikan di wilayah itu. Mereka hanyalah <strong>bahasa Minoa</strong> — dan kita tidak memiliki kerabat hidup, tidak ada kunci dwibahasa gaya Rosetta, dan tidak ada gagasan dari mana orang Minoa berasal atau keluarga apa lidah mereka termasuk.</p>
...
<div class="trivia-actions">
  <button type="button" class="trivia-action" data-action="panto" data-lat="35.05" data-lng="24.81" data-zoom="9">🏛️ Hagia Triada (temuan terkaya)</button>
</div>

<div class="trivia-actions">
  <button type="button" class="trivia-action" data-action="panto" data-lat="35.40" data-lng="25.16" data-zoom="9">🏛️ Situs istana Knossos</button>
</div>
...
<p>Harapannya adalah bahwa penggalian di situs seperti Zominthos atau Petras akhirnya akan menghasilkan inskripsi dwibahasa yang panjang — mungkin Minoa dipasangkan dengan Mesir atau Akkadia — atau hanya tablet Linear A yang cukup panjang untuk analisis statistik dan morfologis untuk mendapatkan traksi. Sampai saat itu, Linear A tetap menjadi buku besar yang belum terbaca dari prasejarah Eropa, bersembunyi di depan mata pada tablet tanah liat yang telah kita pegang selama seratus tahun.</p>
    `
  },
  'aymara-time-reversed': {
    title: 'Aymara — bahasa di mana masa lalu ada di depan Anda',
    summary: 'Dalam bahasa Aymara, masa lalu berada di depan (di mana Anda dapat melihatnya) dan masa depan ada di belakang (tak terlihat). Penutur memberi isyarat ke depan untuk "kemarin" dan di atas bahu untuk "tahun depan".',
    body: `
<p>Jika Anda bertanya kepada penutur bahasa Inggris apa yang ada "di depan", mereka akan memberi tahu Anda tentang rapat <em>minggu depan</em>, tenggat waktu <em>di depan</em>, masa depan <em>untuk dinantikan</em>. Masa depan ada di depan; masa lalu ada di belakang. Hampir setiap bahasa Indo-Eropa mengemas waktu dengan cara ini, dan sebagian besar ilmuwan kognitif berasumsi selama puluhan tahun bahwa metafora itu adalah hampir-universal dari pemikiran manusia.</p>

<p>Kemudian pada 2006, Rafael Núñez dan Eve Sweetser menerbitkan studi kerja lapangan yang cermat tentang <strong>Aymara</strong>, sebuah bahasa yang dituturkan oleh sekitar <strong>2–3 juta orang</strong> di pegunungan Andes tinggi Bolivia, Peru, dan Chili utara — dan menemukan pemetaan yang sebaliknya persis.</p>

<div class="trivia-actions">
  <button type="button" class="trivia-action" data-action="focus" data-code="ay" data-zoom="6">🌍 Tampilkan Aymara di peta</button>
  <button type="button" class="trivia-action" data-action="panto" data-lat="-16.5" data-lng="-68.15" data-zoom="6">🗺️ Terbang ke La Paz</button>
</div>

<p>Dalam Aymara, kata dasar untuk "depan" adalah <em>nayra</em> — yang juga berarti <strong>"mata"</strong> dan <strong>"penglihatan"</strong>. Kata dasar untuk "di belakang" adalah <em>qhipa</em>, yang juga berarti <strong>"punggung"</strong>. Akar spasial ini digunakan kembali untuk waktu, dan penyelarasannya adalah:</p>

<ul>
  <li><strong><em>nayra mara</em></strong> — secara harfiah "tahun mata/depan", berarti <strong>tahun lalu</strong>.</li>
  <li><strong><em>nayra pacha</em></strong> — "waktu mata/depan", berarti <strong>masa lalu</strong>, <strong>zaman kuno</strong>.</li>
  <li><strong><em>qhipüru</em></strong> — dari "hari belakang", berarti <strong>besok / hari masa depan</strong>.</li>
  <li><strong><em>qhipa mara</em></strong> — "tahun belakang", berarti <strong>tahun depan</strong>.</li>
</ul>

<p>Logikanya, berulang kali diberikan oleh penutur Aymara ketika ditanya, indah konsisten: <em>masa lalu adalah apa yang telah Anda lihat, jadi itu harus berada di depan Anda, di mana mata melihat. Masa depan tidak terlihat, tidak diketahui — jadi itu terletak di belakang punggung Anda, di mana Anda tidak dapat melihat.</em></p>

<div class="trivia-actions">
  <button type="button" class="trivia-action" data-action="setword" data-word="sun" data-code="ay">☀️ Lihat Aymara "Matahari"</button>
</div>

<p>Núñez dan Sweetser tidak hanya bergantung pada glosa leksikal, yang dapat menyesatkan. Mereka memfilmkan penutur Aymara tua sambil mereka berbicara tentang peristiwa dari puluhan tahun yang lalu dan puluhan tahun ke masa depan. Isyaratnya tidak ambigu: ketika menggambarkan peristiwa masa lalu, penutur memberi isyarat <strong>ke depan, ke dalam bidang visual di depan mereka</strong> — kadang-kadang dengan sapuan, kadang-kadang menunjuk pada lokasi imajiner tertentu. Ketika menggambarkan peristiwa masa depan, mereka memberi isyarat ke belakang, kadang-kadang dengan jempol dilemparkan di atas bahu. Semakin jauh ke belakang dalam waktu, semakin jauh ke depan isyaratnya. Semakin jauh ke masa depan, semakin jauh ke belakang.</p>
...
<p>Aymara juga luar biasa dalam hal lain: <em>logika tiga-nilai</em> yang diperdebatkan oleh ilmuwan komputer pada 1980-an, sistem evidensial wajib yang tidak berbeda dengan Tuyuca, dan scene penerbitan bahasa pribumi yang hidup. Tetapi masa lalu yang menghadap ke depan tetap menjadi hadiahnya yang paling terkenal kepada ilmu kognitif.</p>
  ...
  'tuyuca-evidentials': {
    title: 'Tuyuca — bahasa di mana Anda harus mengungkapkan bagaimana Anda tahu',
    summary: 'Dalam bahasa Tuyuca di Amazon barat laut, setiap verba terbatas wajib menandai bukti: apakah Anda melihatnya, mendengarnya, menyimpulkannya, mengasumsikannya, atau Anda diberitahu? Anda tidak dapat mengatakan "John bermain sepak bola" tanpa menentukan yang mana.',
    body: `
<p>Bayangkan Anda harus menceritakan kembali peristiwa kecil — katakanlah, bahwa John bermain sepak bola kemarin. Dalam bahasa Inggris Anda dapat dengan mudah mengatakan "John bermain sepak bola", dan pendengar Anda tidak tahu apakah Anda berada di pinggir lapangan, mendengar sorakan dari jalan sebelah, menyimpulkannya dari sepatu boot berlumpurnya, atau diberitahu oleh seorang teman. Bahasa-bahasa Eropa meninggalkan <em>sumber</em> informasi hampir sepenuhnya tak ditandai.</p>

<p>Dalam <strong>Tuyuca</strong> — bahasa <strong>Tukanoan Timur</strong> dengan sekitar <strong>1.000 penutur</strong> di wilayah Vaupés di perbatasan Brasil–Kolombia — Anda tidak bisa. Setiap verba terbatas harus membawa sufiks kecil yang menunjukkan <em>bagaimana Anda mengetahui apa yang Anda klaim</em>. Tidak ada bentuk netral. Bicara tanpa evidensial dan Anda belum mengucapkan kalimat gramatikal.</p>

<div class="trivia-actions">
  <button type="button" class="trivia-action" data-action="focus" data-code="tue" data-zoom="6">🌍 Tampilkan Tuyuca di peta</button>
  <button type="button" class="trivia-action" data-action="panto" data-lat="0.5" data-lng="-69" data-zoom="6">🗺️ Terbang ke wilayah Vaupés</button>
</div>

<p>Deskripsi perintis adalah makalah Janet Barnes 1984. Ia mengkatalogkan <strong>lima kategori evidensial</strong> dalam Tuyuca, masing-masing direalisasikan sebagai akhiran verbal berbeda:</p>

<ul>
  <li><strong>Visual</strong> — penutur melihat peristiwa dengan matanya sendiri. Tuyuca: <em>díiga apé-wi</em> "ia bermain sepak bola (saya melihatnya)".</li>
  <li><strong>Sensorik non-visual</strong> — penutur mendengar, mencium, atau merasakan peristiwa tetapi tidak melihatnya. <em>díiga apé-ti</em> "ia bermain sepak bola (saya mendengar mereka)".</li>
  <li><strong>Inferensial</strong> — penutur tidak melihat peristiwa tetapi melihat jejak fisik. <em>díiga apé-yi</em> "ia bermain sepak bola (saya melihat lapangan berlumpur)".</li>
  <li><strong>Diasumsikan</strong> — penutur menalar dari pengetahuan umum: misalnya ia selalu bermain pada hari Sabtu. <em>díiga apé-hĩyi</em>.</li>
...
<div class="trivia-actions">
  <button type="button" class="trivia-action" data-action="setword" data-word="drink" data-code="tue">🥤 Lihat Tuyuca "Minum" (sĩdĩ)</button>
</div>

<p>Yang jelas adalah bahwa Tuyuca mengungkap asumsi tersembunyi dari banyak filsafat bahasa Barat: bahwa pernyataan secara default adalah klaim "fakta" yang tak ditandai. Bagi penutur Tuyuca tidak ada default seperti itu. Setiap kalimat, pada dasarnya, diawali dengan ekuivalen epistemik dari <em>"Saya melihat"</em>, <em>"Saya mendengar"</em>, atau <em>"Saya diberitahu"</em>. Tata bahasa asal-usul dibangun ke dalam setiap verba.</p>
    `
  },
...
<p>Jika Anda duduk dengan penutur <strong>Guugu Yimithirr</strong> — bahasa <strong>Pama-Nyungan</strong> dari Semenanjung Cape York di Queensland utara jauh, Australia — mereka akan mengatakan, pada efeknya, "cangkir di utara Anda" atau "cangkir di sebelah timur Anda". Guugu Yimithirr tidak hanya <em>lebih menyukai</em> arah mata angin. Ia <strong>sama sekali tidak memiliki kosakata produktif untuk kiri atau kanan</strong> saat mendeskripsikan lokasi objek eksternal. Sumbu relatif tubuh sekadar tidak digunakan dalam sistem spasial dasar.</p>

<div class="trivia-actions">
  <button type="button" class="trivia-action" data-action="focus" data-code="kky" data-zoom="6">🌍 Tampilkan Guugu Yimithirr di peta</button>
  <button type="button" class="trivia-action" data-action="panto" data-lat="-15.5" data-lng="145.25" data-zoom="6">🗺️ Terbang ke Hopevale, Cape York</button>
</div>
...
<p>Istilah-istilah ini menggabungkan bebas dengan verba, postposisi, dan bahkan morfem gerak. Anda dapat mengatakan "Saya menjatuhkannya <em>nagaalu</em>" — berarti "Saya menjatuhkannya di sisi timur". Seorang pria yang menceritakan kisah tentang perkelahian tidak mengatakan "ia memukulnya di wajah"; ia mengatakan "ia memukulnya di pipi sisi-utara" — dan yang penting, "utara" itu adalah utara kompas dunia nyata pada saat perkelahian, bukan pada saat penceritaan.</p>
...
<div class="trivia-actions">
  <button type="button" class="trivia-action" data-action="setword" data-word="sun" data-code="kky">☀️ Lihat Guugu Yimithirr "Matahari"</button>
</div>

<p>Guugu Yimithirr juga memiliki klaim ketenaran lain: ia adalah bahasa dari mana bahasa Inggris meminjam kata <strong>"kangguru"</strong>. Awak James Cook merekam <em>gangurru</em> pada 1770 sebagai nama spesies kanguru abu-abu besar tertentu — dan kata itu mengelilingi dunia. Bahasa kini memiliki kurang dari 1.000 penutur fasih, tetapi pelajaran kognitifnya telah mencapai jauh lebih jauh.</p>
    `
  },
  'mohawk-polysynthesis': {
    title: 'Mohawk — ketika satu kata adalah seluruh kalimat',
    summary: 'Mohawk, bahasa Iroquoian dari hutan timur laut, bersifat polisintetis — satu bentuk verba dapat mengkodekan subjek, objek, penerima manfaat, kala, aspek, modus, dan bahkan nomina yang tergabungkan, melakukan pekerjaan seluruh kalimat bahasa Inggris.',
    body: `
<p><strong>Mohawk</strong> (<em>Kanien'kéha</em>, "bahasa Rakyat Batu Api") adalah salah satu dari enam bahasa Konfederasi Haudenosaunee, dituturkan di komunitas di Quebec selatan, Ontario, dan negara bagian New York. Itu adalah anggota paling banyak dituturkan dari keluarga <strong>Iroquoian</strong>, dengan kira-kira 3.500 penutur dan gerakan revitalisasi sekolah imersi yang giat yang dipimpin oleh komunitas seperti Kahnawà:ke dan Akwesasne.</p>

<div class="trivia-actions">
  <button type="button" class="trivia-action" data-action="focus" data-code="moh" data-zoom="6">🌍 Tampilkan Mohawk di peta</button>
</div>

<p>Secara linguistik Mohawk adalah contoh buku teks <strong>bahasa polisintetis</strong> — tipe di mana satu bentuk verba dibangun dari rantai panjang afiks wajib dan opsional, sering mengekspresikan seluruh klausa bahasa Inggris di dalam satu kata. Ilustrasi klasik, sering dikutip oleh Marianne Mithun:</p>

<blockquote><em>washakotya'tawitsherahetkvhta'se'</em><br>
"ia merusak gaunnya untuknya"</blockquote>

<p>Membongkar satu kata itu menghasilkan kira-kira:</p>
...
<ul>
  ...
  <li><em>-e'</em> — aspek punktual (satu peristiwa selesai)</li>
</ul>

<p>Struktur argumen seluruh kalimat bahasa Inggris dikemas ke dalam morfologi satu verba. Mohawk juga menunjukkan <strong>penggabungan nomina</strong>: nomina objek generik (di sini, "gaun") bergerak di dalam batang verba daripada muncul sebagai kata terpisah. Wallace Chafe dan Mithun telah menunjukkan bahwa penggabungan diatur oleh aturan tingkat wacana — nomina yang tergabungkan biasanya dilatarbelakangkan, sementara nomina independen menonjolkan referen.</p>

<div class="trivia-actions">
  <button type="button" class="trivia-action" data-action="setword" data-word="house" data-code="moh">🏠 Lihat Mohawk "Rumah"</button>
...
<p>Bahasa polisintetis klasik lainnya — Inuktitut, Yupik Siberia Tengah, Chukchi, Ainu, Sora — mengkonfirmasi bahwa pola ini berulang lintas benua. Tetapi untuk kepadatan informasi gramatikal per kata yang murni, bahasa Iroquoian, dan Mohawk khususnya, masih merupakan prototipe yang pertama dijangkau oleh buku teks.</p>
  ...
  'nuxalk-vowelless': {
    title: 'Nuxalk — kata-kata tanpa vokal sama sekali',
    summary: 'Bahasa Salishan dari British Columbia pesisir yang katanya bisa sepenuhnya konsonantal — seluruh ucapan tanpa satu vokal pun.',
    body: `
<p>Di teluk-teluk kasar British Columbia tengah, beberapa lusin orang masih berbicara <strong>Nuxalk</strong> (juga disebut <em>Bella Coola</em>), bahasa Salishan yang fonologinya telah memukau para linguis selama lebih dari setengah abad. Klaim ketenarannya: <strong>kata-kata yang tidak mengandung vokal sama sekali</strong>.</p>

<div class="trivia-actions">
  <button type="button" class="trivia-action" data-action="focus" data-code="blc" data-zoom="6">🌍 Tampilkan Nuxalk di peta</button>
  <button type="button" class="trivia-action" data-action="panto" data-lat="52.40" data-lng="-126.75" data-zoom="6">🗺️ Terbang ke lembah Bella Coola</button>
</div>

<p>Contoh buku teks, pertama kali dilaporkan oleh <strong>Hank Nater</strong> dalam tata bahasanya 1984, adalah:</p>
...
<div class="trivia-actions">
  <button type="button" class="trivia-action" data-action="setword" data-word="water" data-code="blc">💧 Lihat Nuxalk "air" (qla)</button>
...
<p>Hari ini kurang dari 20 penutur fasih bahasa pertama Nuxalk tersisa, hampir semua sesepuh di Bella Coola. Bangsa Nuxalk menjalankan program imersi dan inisiatif rumah bahasa; rekaman yang dibuat oleh Nater pada 1970-an, dan dokumentasi lebih baru yang didukung First Peoples' Cultural Council, berpacu untuk mendokumentasikan fonologi yang tidak seperti yang lain.</p>
  ...
  'hawaiian-13-phonemes': {
    title: 'Hawaii — hanya 13 bunyi, dan kebangkitan yang menakjubkan',
    summary: 'Hawaii memiliki salah satu inventaris fonem terkecil di Bumi — hanya 13 bunyi — dan pernah berada di ambang kepunahan. Hari ini ia adalah salah satu kebangkitan bahasa pribumi paling berhasil yang pernah dicatat.',
    body: `
<p><strong>ʻŌlelo Hawaiʻi</strong> — bahasa Hawaii — memiliki salah satu inventaris bunyi terkecil dari bahasa yang hidup mana pun. <strong>Hanya 13 fonem</strong>: 8 konsonan (<em>p, k, ʻ, h, m, n, l, w</em>) dan 5 vokal (<em>a, e, i, o, u</em>), masing-masing dapat pendek atau panjang. Hanya itu. Anda dapat mempelajari seluruh alfabet, termasuk henti glotal <em>ʻokina</em> dan tanda vokal panjang <em>kahakō</em>, dalam satu sore.</p>

<div class="trivia-actions">
  <button type="button" class="trivia-action" data-action="focus" data-code="haw" data-zoom="5">🌍 Tampilkan Hawaii di peta</button>
</div>
...
<div class="trivia-actions">
  ...
  <button type="button" class="trivia-action" data-action="setword" data-word="hello" data-code="haw">👋 Lihat Hawaii "Halo"</button>
</div>

<p>Kemudian datang keruntuhan. <strong>Penggulingan Kerajaan Hawaiʻi 1893</strong> dan aneksasi AS 1898 memicu satu generasi penindasan budaya. Pada 1896 Republik Hawaiʻi meloloskan <strong>Undang-Undang 57</strong>, mewajibkan bahasa Inggris sebagai satu-satunya media instruksi di sekolah. Anak-anak yang tertangkap berbicara bahasa Hawaii dihukum fisik. Pada 1980, kurang dari 2.000 penutur asli tersisa, hampir semua tua. Para linguis menulisnya sebagai sekarat.</p>

<p>Apa yang terjadi selanjutnya adalah salah satu kisah besar dalam sosiolinguistik modern. Terinspirasi oleh <em>Kōhanga Reo</em> Māori ("sarang bahasa") di Selandia Baru, sekelompok pendidik termasuk <strong>Larry Kimura</strong>, <strong>William H. "Pila" Wilson</strong>, dan <strong>Kauanoe Kamanā</strong> mendirikan <strong>ʻAha Pūnana Leo</strong> pada 1983 — prasekolah khusus Hawaii di mana sesepuh hanya berbicara bahasa Hawaii kepada balita. Pada 1986, larangan 90 tahun terhadap sekolah berbahasa Hawaii akhirnya dicabut. Pada 1987 sekolah negeri imersi Hawaii <strong>Kula Kaiapuni</strong> pertama dibuka. Perguruan tinggi <strong>Ka Haka ʻUla O Keʻelikōlani</strong> Universitas Hawaiʻi di Hilo sekarang menawarkan kursus PhD yang sepenuhnya dilakukan dalam bahasa Hawaii — bahasa pribumi pertama di Amerika Serikat yang mencapai tingkat itu.</p>
...
<div class="trivia-actions">
  ...
  <button type="button" class="trivia-action" data-action="panto" data-lat="12.13" data-lng="-86.25" data-zoom="7">🗺️ Terbang ke Managua</button>
</div>

<p>Sebelum 1977, orang Nikaragua tuli terisolasi. Setiap keluarga menemukan "<strong>tanda rumah</strong>" mereka sendiri — sistem gestur idiolektal kecil yang digunakan antara anak tuli dan kerabat terdekat — tetapi negara tidak memiliki komunitas tuli, tidak ada bahasa isyarat, dan hampir tidak ada pendidikan untuk anak-anak tuli. Kemudian, pada 1977, <strong>Centro Nacional de Educación Especial</strong> baru dibuka di Managua, diikuti oleh sekolah kejuruan di Villa Libertad pada 1981. Untuk pertama kalinya, ratusan anak tuli disatukan setiap hari.</p>

<p>Sekolah-sekolah mengajar dalam bahasa Spanyol lisan dengan baca-bibir dan ejaan jari. Secara resmi, isyarat tidak dianjurkan. Anak-anak, bagaimanapun, melakukan apa yang selalu dilakukan manusia ketika dipaksa berdekatan: <strong>mereka berkomunikasi</strong>. Di taman bermain dan bus sekolah, mereka menggabungkan tanda rumah mereka, menemukan yang baru, dan dalam beberapa tahun telah membangun <strong>sistem isyarat pidgin</strong> bersama, sekarang disebut <em>Lenguaje de Signos Nicaragüense (LSN)</em>.</p>

<p>Kemudian datang revolusi. Ketika anak-anak yang lebih muda — anak prasekolah dan anak SD awal — memasuki sistem pada pertengahan 1980-an, mereka mengambil pidgin anak-anak yang lebih tua sebagai masukan dan melakukan sesuatu yang hanya bisa dilakukan anak-anak: <strong>mereka menggrammatikalisasinya</strong>. Mereka menambahkan kesepakatan spasial yang konsisten, morfologi verba, dan penanda wacana. Pada awal 1990-an, kohort yang lebih muda mengisyaratkan bahasa yang sepenuhnya gramatikal, sepenuhnya alami — ISN — yang hanya sebagian dapat diikuti kohort yang lebih tua.</p>
...
<ul>
  ...
  <li>Proto-suku kata pertama yang dibuat bayi karenanya adalah <em>ma</em>, <em>pa</em>, <em>ba</em>, diulang: <em>mama</em>, <em>papa</em>, <em>baba</em>.</li>
  <li>Orang dewasa yang mendengar celoteh ini berasumsi bayi sedang berbicara dengan mereka. Karena orang yang hampir selalu hadir ketika bayi bersuara adalah ibunya, <em>mama</em> ditafsirkan sebagai "ibu". Ayah, sedikit lebih jauh dalam pengasuhan tradisional, mendapat <em>papa</em>.</li>
  <li>Orang dewasa <strong>memperkuat</strong> celoteh dengan menanggapinya, sehingga bentuk <em>menempel</em> sebagai kata konvensional dalam bahasa itu — meskipun tidak ada dalam struktur bahasa yang mengharuskannya.</li>
</ul>

<div class="trivia-actions">
  <button type="button" class="trivia-action" data-action="setword" data-word="mother" data-code="en">👩 Lihat "ibu" di seluruh dunia</button>
  <button type="button" class="trivia-action" data-action="setword" data-word="father" data-code="en">👨 Lihat "ayah" di seluruh dunia</button>
</div>

<p>Penjelasan Jakobson juga menjelaskan pengecualian dengan elegan. <strong>Georgia</strong> dengan terkenal menukar pasangan: <em>mama</em> berarti "ayah" dan <em>deda</em> berarti "ibu". Ini bukan rasa malu bagi teori — poin Jakobson adalah bahwa <em>mama</em> adalah kata pertama yang paling mudah, bukan bahwa ia harus berarti "ibu". Georgia hanya melekatkan bentuk termudah pada referen yang sedikit kurang diharapkan. Demikian pula, dalam <strong>Jepang Kuno</strong>, "ibu" direkonstruksi sebagai <em>papa</em> (modern <em>haha</em>, dengan perubahan bunyi reguler /p/ → /h/), dan "ayah" adalah <em>titi</em>.</p>

<p>Jadi ketika bayi Inggris mengatakan <em>mama</em>, bayi Mandarin mengatakan <em>māma</em>, dan bayi Swahili mengatakan <em>mama</em>, tidak ada leluhur bersama yang dibutuhkan. Kemudahan artikulatoris yang sama bertemu pengasuh yang sama, dan kata yang sama lahir — secara independen, lagi dan lagi, di setiap benua sejarah manusia.</p>
    `
  },
  'pie-reconstruction': {
    title: 'Proto-Indo-Eropa — bahasa yang tak pernah ditulis oleh siapa pun',
    summary: 'Setengah populasi dunia berbicara keturunan Proto-Indo-Eropa — bahasa yang dituturkan kira-kira 6.000 tahun yang lalu yang tidak meninggalkan teks. Para linguis telah membangunnya kembali kata demi kata menggunakan metode komparatif, dan bahkan memprediksi bunyi yang ternyata nyata.',
    body: `
...
<div class="trivia-actions">
  <button type="button" class="trivia-action" data-action="setword" data-word="father" data-code="en">👨 Lihat "ayah" di seluruh Indo-Eropa</button>
  <button type="button" class="trivia-action" data-action="setword" data-word="water" data-code="en">💧 Lihat Inggris "Air"</button>
</div>

<p>Lalu datang momen yang, bagi banyak linguis, menyelesaikan pertanyaan apakah rekonstruksi adalah sains nyata. Pada 1879, linguis Swiss muda <strong>Ferdinand de Saussure</strong> — dua puluh satu tahun dan belum terkenal sebagai pendiri semiotika modern — menerbitkan <em>Mémoire sur le système primitif des voyelles dans les langues indo-européennes</em>. Untuk membuat pergantian vokal PIE bekerja secara bersih, ia mengusulkan bahwa PIE telah berisi <em>coefficients sonantiques</em> tambahan misterius yang sejak itu telah menghilang di setiap bahasa anak yang dikenal — bunyi yang sekarang kita sebut <strong>laringeal</strong> (<em>*h₁, *h₂, *h₃</em>).</p>

<blockquote>"Pasti pernah ada dalam Indo-Eropa sebuah fonem A yang tidak meninggalkan jejak langsung dalam bahasa-bahasa historis..." — Saussure, 1879</blockquote>

<p>Itu adalah deduksi cemerlang tanpa bukti langsung. Selama hampir lima puluh tahun, sebagian besar Indo-Eropais menganggapnya spekulasi elegan. Lalu, pada 1915, sarjana Ceko Bedřich Hrozný memecahkan kode <strong>Hittit</strong> — bahasa Indo-Eropa dari Zaman Perunggu yang telah terkubur di bawah Anatolia selama tiga ribu tahun. Pada 1927, linguis Polandia <strong>Jerzy Kuryłowicz</strong> menyadari bahwa Hittit melestarikan sebuah konsonan, ditulis <em>ḫ</em>, di <strong>posisi persis di mana Saussure telah memprediksi bunyinya yang hilang</strong>. Saussure telah meninggal empat belas tahun. Hantu-hantunya selama ini nyata.</p>

<p>Hari ini rekonstruksi PIE memiliki ratusan akar yang mapan, tata bahasa canggih dengan delapan kasus dan tiga gender, pergantian ablaut, dan bahkan puisi yang direkonstruksi — frasa seperti <em>*ḱléwos n̥dʰgʷʰitóm</em> "ketenaran abadi", dibuktikan dalam baik Yunani Homerik (<em>kléos áphthiton</em>) dan Sanskerta Veda (<em>śrávas ákṣitam</em>). Bahasa yang tak pernah ditulis siapa pun mungkin adalah bahasa tak tertulis yang paling dipelajari dalam sejarah.</p>
    `
  },
};
