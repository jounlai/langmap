...
window.TRIVIA_I18N['pt'] = {
  'piraha-no-numbers': {
    ...
    body: `
<p>No coração da Amazônia brasileira, menos de 800 pessoas falam <strong>Pirahã</strong> (pronuncia-se aproximadamente <em>pi-da-RÃ</em>). É uma língua isolada — sem parentes comprovados em nenhum lugar da Terra — e tornou-se um dos casos mais ferozmente debatidos na linguística moderna.</p>
