// Swahili (sw) translations of TRIVIA_ARTICLES
// Tafsiri za Kiswahili za makala 30 za maarifa ya lugha

window.TRIVIA_I18N = window.TRIVIA_I18N || {};
window.TRIVIA_I18N['sw'] = {
  'piraha-no-numbers': {
    title: 'Pirahã — lugha inayosemekana haina nambari',
    summary: 'Lugha pekee ya Amazoni yenye wasemaji wachache, inayosemekana haina maneno ya nambari, maneno ya msingi ya rangi, wala urudufu wa kisarufi — na ikatikisa nadharia ya lugha iliyodumu kwa miaka 60.',
    body: `
<p>Ndani kabisa ya msitu wa Amazoni wa Brazili, watu mia chache husema <strong>Pirahã</strong> (hutamkwa takriban <em>pii-da-HAN</em>). Ni lugha pekee — bila ndugu wowote waliothibitishwa duniani — na imekuwa mojawapo ya kesi zinazobishaniwa zaidi katika isimu ya kisasa.</p>

<div class="trivia-actions">
  <button type="button" class="trivia-action" data-action="focus" data-code="myp" data-zoom="6">📍 Onyesha Pirahã kwenye ramani</button>
  <button type="button" class="trivia-action" data-action="panto" data-lat="-5" data-lng="-62" data-zoom="4" data-codes="myp">🌳 Ruka hadi bonde la Amazoni</button>
</div>
...
<div class="trivia-actions">
  <button type="button" class="trivia-action" data-action="setword" data-word="one" data-code="myp">🔢 Ona "moja" katika lugha mbalimbali</button>
...
<p>Mambo yanayobishaniwa kidogo, ingawa bado yamo katika mjadala, ni kanuni ya kitamaduni inayozuia mazungumzo kwa matukio yaliyopatikana moja kwa moja na utumaji wa Pirahã wa njia nyingi unaovutia. Bila kujali ni upande gani utashinda vita ya urudufu, Pirahã imefanya kile lugha chache sana zinafanya: imelazimisha wanaisimu kuuliza tena, je lugha hutengeneza fikra — au fikra hutengeneza lugha.</p>
  ...
  'silbo-gomero': {
    title: 'Silbo Gomero — Kihispania cha mluzi kinachovuka mabonde',
    summary: 'Katika kisiwa kidogo cha volkano katika Atlantiki, wachungaji walibadilisha Kihispania kuwa mluzi safi na waliweza kuzungumza katika mabonde marefu mawili kilomita kwa upana. UNESCO iliisajili mwaka 2009; leo hufundishwa katika kila shule ya msingi La Gomera.',
    body: `
  <p>Kisiwa cha <strong>La Gomera</strong> katika Visiwa vya Kanari kimechorwa na mabonde ya kina, karibu wima — yaliyo na mteremko mkubwa hata jirani anayeonekana kuvuka bonde anaweza kuwa saa moja ya kutembea mbali. Muda mrefu kabla ya simu za mkononi, watu wa Gomera walitatua tatizo hili kwa mojawapo ya <strong>lugha za mluzi</strong> zilizoelimika zaidi duniani: <em>Silbo Gomero</em>, "mluzi wa Gomera".</p>
  ...
  <ul>
    ...
    <li><strong>"Konsonanti" nne</strong> zinazotofautishwa na kama mluzi umekatika au unaendelea, na kama toni inapanda au inashuka kuelekea vokali inayofuata.</li>
  ...
  <div class="trivia-actions">
    ...
    <button type="button" class="trivia-action" data-action="panto" data-lat="-22" data-lng="20" data-zoom="5">🗺️ Ruka hadi makao ya Taa</button>
  </div>

  <p>Taa ni <strong>lugha ya Tuu</strong> (zamani iliwekwa katika familia ya "Khoisan ya Kusini" iliyokataliwa sasa) inayozungumzwa katika vijiji vilivyotapakaa vya Kalahari ya kusini-magharibi, hasa nchini Botswana na jamii ndogo Namibia. Makadirio yanaweka jamii ya wasemaji kwa takriban <strong>watu 2,500</strong>, wote ni wenye lugha mbili katika Kitswana, Kiafrikaans au Khoekhoegowab — kwa hivyo ingawa lugha bado haijafikia kifo, kila uhamisho wa kizazi ni kama kutupa sarafu.</p>

  <p>Ufakhamu wa fonolojia una tabaka tatu:</p>

  <ul>
    <li><strong>Aina tano za msingi za mibofyo.</strong> Wa meno <em>|</em>, wa upande <em>||</em>, wa alveoli <em>!</em>, wa kaakaa <em>ǂ</em> na wa midomo miwili <em>ʘ</em>. Mibofyo ya midomo miwili — inayoundwa kwa sauti kama ya busu — inaendelea katika lugha chache tu duniani; Taa ni mojawapo.</li>
    <li><strong>Takriban vifaa 17 vya mibofyo.</strong> Kila mibofyo inaweza kuwa na sauti, isiyo na sauti, ya pumzi, iliyofungwa kwenye koo, ya pua, ya pua kabla, ya sauti ya pumzi au kuunganishwa na utoaji wa uvula na wa kuruka. Zidisha 5 × 17 na orodha ya mibofyo peke yake inazidi mfumo mzima wa konsonanti wa Kihawaii mara kadhaa.</li>
    <li><strong>Mfululizo tofauti wa konsonanti zisizo za mibofyo</strong> karibu mkubwa kama orodha nzima ya lugha ya kawaida, ikiwa na tofauti nadra kama vile vya kuruka vya uvula <em>q'χ</em>.</li>
  </ul>
  ...
  <p>Taa kwa kawaida huelezewa kuwa <strong>iliyo hatarini sana</strong>. Watoto wachache mia kadhaa ambao bado wanajifunza wanakua pamoja na shule ya Kitswana na mitindo ya maisha ya kuhama zaidi. Iwapo Taa itanyamaza katika kizazi kijacho, dunia inapoteza si tu urithi wa jamii bali maabara tajiri zaidi ya asili ambayo sayansi ya fonetiki imepata.</p>
    `
  },

  'rotokas-fewest-sounds': {
    title: 'Rotokas — lugha yenye (karibu) sauti chache zaidi',
    summary: 'Katika kisiwa cha kahawa cha Bougainville, lahaja kuu ya Rotokas inajulikana kwa kuwa na fonimu kumi na moja tu — konsonanti sita na vokali tano — iliyowahi kunukuliwa kama orodha ndogo zaidi ya fonimu duniani.',
    body: `
  <p>Iwapo Taa ni paradiso ya mtaalamu wa wingi, <strong>Rotokas</strong> ni ya mtaalamu wa uchache. Ikisemwa na takriban watu 4,000 katika mlima wa ndani wa <strong>Bougainville</strong>, kisiwa kinachomilikiwa kisiasa na Papua New Guinea lakini kijiografia kwa msururu wa Solomon, lahaja kuu ya Rotokas ina <strong>fonimu kumi na moja tu tofauti</strong>: konsonanti sita — <em>p, t, k, β, ɾ, ɡ</em> — na vokali tano <em>a, e, i, o, u</em>, kila moja inaweza kuwa fupi au ndefu.</p>

  <div class="trivia-actions">
    <button type="button" class="trivia-action" data-action="focus" data-code="roo" data-zoom="7">📍 Fungua Rotokas kwenye ramani</button>
  ...
  <p>Tokeo moja la haraka ni kwamba maneno ya Rotokas huwa <strong>marefu zaidi</strong> kuliko maneno katika lugha zenye fonolojia tajiri — msamiati mdogo wa sauti unahitaji michanganyiko zaidi kutenganisha maneno. Majina ya mahali kama <em>Rotokas</em>, <em>Pipipaia</em>, <em>Togarao</em> na <em>Keriaka</em> yatoa hisia: silabi rahisi, mifumo ya kurudia, karibu kama wimbo.</p>

  <div class="trivia-actions">
    <button type="button" class="trivia-action" data-action="compare" data-codes="roo,haw,mi">🗣 Linganisha Rotokas, Kihawaii na Kimaori</button>
  </div>
  ...
  <div class="trivia-actions">
    <button type="button" class="trivia-action" data-action="panto" data-lat="-6.20" data-lng="155.30" data-zoom="8" data-tiles="terrain">🌋 Vuta karibu na safu ya Crown Prince</button>
  </div>

  <p>Somo la Rotokas si kwamba lugha rahisi ni "rahisi" — kila mtoto wa Rotokas bado anajifunza ufasaha wa kuzaliwa kwa juhudi sawa na mtoto yeyote popote anavyoweka katika kujifunza lugha. Bali ni kwamba <strong>uwezo wa lugha wa binadamu una nafasi ya kushangaza pande zote mbili</strong>. Kutoka sauti kumi na moja hadi mia moja na sitini na nne, mfumo wa msingi ni sawa.</p>
    `
  },
  ...
  <p>Kinachofanya Ubykh kuwa ya kipekee kwa maneno ya kiisimu ni orodha yake ya fonimu:</p>

  <ul>
    <li><strong>Konsonanti 84 za kifonimu.</strong> Zilizofarynjalizwa, zilizolabializwa, zilizopalatatized, za kuruka — kila kigezo kinachoweza kuzidisha mfululizo wa konsonanti, Ubykh ilitumia. Baadhi ya hesabu zilizochapishwa zinafikia 81, nyingine 83 au 84; hata takwimu ya chini ni juu ya lugha yoyote isiyo ya Khoisan.</li>
    <li><strong>Vokali mbili za kifonimu.</strong> <em>/ə/</em> na <em>/a/</em> tu, mara nyingine zikichambuliwa kama vokali moja iliyo chini ambayo rangi yake imedhamiriwa na konsonanti zinazozunguka. Tofauti kati ya vokali kimsingi haifanyi kazi yoyote; konsonanti hufanya kila kitu.</li>
    <li><strong>Mofolojia ya kitenzi ya polypersonal.</strong> Kitenzi kimoja cha Ubykh kinaweza kueleza sawa, kitu cha moja kwa moja, kitu kisicho cha moja kwa moja, eneo, mwelekeo, chombo na hoja za kufaidika katika neno moja lililowekwa kwa nguvu — kipengele cha kimuundo kinachoshirikiwa na binamu zake wa Caucasian wa Kaskazini-Magharibi.</li>
  </ul>
  ...
  <div class="trivia-actions">
    ...
    <button type="button" class="trivia-action" data-action="panto" data-lat="-16.6" data-lng="139.5" data-zoom="6">🗺️ Ruka hadi Kisiwa cha Mornington</button>
  </div>
  ...
  <p>Fonolojia, hata hivyo, ndipo Damin ilipovunja kanuni za bara. Ilikuwa na:</p>
  ...
  <div class="trivia-actions">
    <button type="button" class="trivia-action" data-action="panto" data-lat="-16.55" data-lng="139.45" data-zoom="9">🪨 Vuta karibu na Kisiwa cha Mornington</button>
  </div>

  <p>Damin haitumiki tena. Wasemaji wa mwisho waliokuwa wameanzishwa walikufa katika miaka ya 1980, na mwiko wa siri unaozunguka kiwango ulimaanisha kuwa jamii ya Lardil yenyewe haingeweza tu "kuhuisha" kutoka kwa rekodi bila kukiuka kazi yake takatifu. Kile kinachosalia ni vidokezo vya shamba vya Hale, kazi ndogo ya ufuatiliaji ya <strong>Norvin Richards</strong> na wengine, na nafasi kubwa katika fikra ya fonolojia ya dunia. Kwa lugha yenye maneno 200 tu, alama ya Damin katika nadharia ya kiisimu ni kubwa sana.</p>
    `
  },

  'khoisan-clicks': {
    title: 'Konsonanti za mibofyo — familia tano za sauti zilizovuka mipaka',
    summary: 'Aina tano za mibofyo — wa meno, wa upande, wa alveoli, wa kaakaa na wa midomo miwili — vilizuka katika lugha za familia za Khoe na Tuu za kusini mwa Afrika na lugha pekee ya Hadza, kisha vikaruka katika Kizulu na Kixhosa cha Bantu kupitia karne za mawasiliano na majirani wanaozungumza Khoekhoe.',
    body: `
  <p>Lugha nyingi ambazo wasemaji wa Kiingereza wamesikia "hutumia" mibofyo — kupiga midomo kwa mzazi mwenye hasira, kupiga ulimi kwa kukataa — lakini huwatumia <em>kibinadamu</em>, nje ya orodha ya fonimu. Katika <strong>Afrika ya kusini</strong>, kinyume chake, familia kadhaa za lugha zimefanya mibofyo kuwa konsonanti za kweli: vipengele vya ujenzi vya maneno ya kawaida, visivyoweza kutofautishwa kwa hadhi na <em>p</em> na <em>t</em> katika Kiingereza.</p>

  <div class="trivia-actions">
    <button type="button" class="trivia-action" data-action="focus" data-code="hts" data-zoom="6">🌍 Onyesha Hadza kwenye ramani</button>
  </div>
  ...
  <p>Wanafonetiki hutofautisha <strong>aina tano za msingi za mibofyo</strong> kwa mahali ambapo kufungwa kwa mbele kunafanyika:</p>
  ...
  <ul>
    <li><strong>Mpangilio wa ergative-absolutive.</strong> Kibasque hualama mhusika wa kitenzi cha kupita (mtenda) na kiambishi maalum <em>-k</em>, wakati kitu na mhusika wa kitenzi kisicho cha kupita hubaki bila alama. Hii ni nadra katika Ulaya lakini kawaida duniani kote.</li>
    <li><strong>Makubaliano ya polypersonal.</strong> Fomu moja ya kitenzi cha Kibasque inaweza kueleza mtu na nambari ya mhusika, kitu cha moja kwa moja, <em>na</em> kitu kisicho cha moja kwa moja kwa wakati mmoja: <em>dakarkiot</em> = "Ninamletea kitu hicho".</li>
    <li><strong>Kuhesabu kwa ishirini.</strong> Nambari hujengwa kwa 20: <em>hogei</em> "20", <em>berrogei</em> "40" (lit. "mbili-ishirini"), <em>hirurogei</em> "60". Msingi sawa unaendelea katika Kifaransa <em>quatre-vingts</em> "80" — alama inayowezekana ya kichini cha Kibasque.</li>
    <li><strong>Hakuna jinsia ya kisarufi.</strong> Kama Kifinland na Kituruki, Kibasque haina tofauti ya mwanaume/mwanamke katika nomino au viwakilishi.</li>
  </ul>

  <div class="trivia-actions">
    <button type="button" class="trivia-action" data-action="setword" data-word="water" data-code="eu">💧 Ona Kibasque "Maji"</button>
  ...
  <p>Uhuishaji huo umefanya kazi: Kibasque sasa ni rasmi pamoja na Kihispania katika Jamii ya Kibasque ya Kujitawala, kinafundishwa katika mfumo wote wa shule katika mifano mitatu ya kuzama (A, B, D), na kinatumika kwenye televisheni, katika fasihi, na mtandaoni. Inabaki, kama ilivyokuwa kwa miaka elfu, sauti ya kabla ya Indo-Ulaya yenye ukaidi ya Pyrenees za magharibi — kapsuli ya wakati ya kiisimu kutoka Ulaya ambayo hatutaisikia tena.</p>
    `
  },
  ...
  <div class="trivia-actions">
    ...
    <button type="button" class="trivia-action" data-action="panto" data-lat="31.32" data-lng="45.64" data-zoom="7">𒀭 Ruka hadi Uruk</button>
  </div>

  <p>Kisumerian ni <strong>lugha pekee</strong>. Licha ya karne ya jitihada, hakuna ndugu waliothibitishwa wamepatikana — si katika Kisemiti (jirani yake wa baadaye sana Kiakkadian), si katika Kiindo-Ulaya, si katika Kidravidian, si katika familia yoyote ya Kicaucasian. Pia ni <strong>agglutinative</strong> na kwa kiasi kikubwa <strong>ergative</strong>: maana huundwa kwa kuweka morphemes juu ya mzizi wa kitenzi katika nafasi zilizotengwa, na mtenda wa kitenzi cha kupita huchukua mwisho maalum wa kesi. Mlolongo wa kitenzi wa kawaida unaonekana kama:</p>

  <blockquote><em>i-mu-na-an-šúm</em> — "alimpa" (kihalisi: kipengele-ventive-3sg.dative-3sg.agent-toa)</blockquote>

  <p>Kuandika kulianza kama uhasibu. Vibao vya kwanza — vya kile kinachoitwa <strong>proto-cuneiform</strong> cha Uruk IV (k. 3200 KK) — ni risiti na orodha za mgawo: pictographs kwa kondoo, bia, mafuta, na nambari katika mfumo wa sexagesimal (msingi-60) ambao unaendelea katika saa yetu ya dakika 60. Katika karne nne zilizofuata pictographs zilizungushwa digrii 90, zilipambwa kuwa michoro ya umbo la kabari, na kupata mwelekeo wa kifonetiki kupitia <strong>kanuni ya rebus</strong>: ishara ya kitu ikaja kusimama pia kwa sauti ya jina lake. Mara tu mfumo wa kuandika unapoweza kuandika sauti, unaweza kuandika chochote — na kufikia 2600 KK waandishi wa Kisumerian walikuwa wakiandika fasihi, sheria, na maombi.</p>
  ...
  <div class="trivia-actions">
    <button type="button" class="trivia-action" data-action="setword" data-word="water" data-code="sux">💧 Ona Kisumerian "Maji"</button>
    <button type="button" class="trivia-action" data-action="setword" data-word="house" data-code="sux">🏠 Ona Kisumerian "Nyumba"</button>
  </div>
  ...
  'etruscan-mystery': {
    title: 'Kietruscan — lugha tunayoweza kusoma lakini hatuelewi',
    summary: 'Lugha kuu ya Italia kabla ya Roma: maandishi 13,000 yanayosalia katika alfabeti iliyotokana na Kigiriki, yanaweza kusomwa kabisa kifonetiki — na bado yametafsiriwa kwa sehemu tu.',
    body: `
  <p>Kabla Roma kuwa Roma, nguvu kuu katikati ya Italia ilikuwa ustaarabu wa <strong>Kietruscan</strong> — mataifa kumi na mbili ya jiji yaliyoenea kutoka Arno hadi Tiber, mafundi bora wa chuma, wafanyabiashara wa baharini, na watu waliowafundisha Warumi jinsi ya kuvaa toga, kujenga upinde, na kuandaa pigano la gladiator. Pia waliacha mojawapo ya zawadi za ajabu zaidi za akiolojia: lugha tunayoweza <em>kusoma kwa sauti</em> herufi kwa herufi, lakini tunaielewa kwa sehemu tu.</p>

  <div class="trivia-actions">
    <button type="button" class="trivia-action" data-action="focus" data-code="ett" data-zoom="6">🌍 Onyesha Kietruscan kwenye ramani</button>
    <button type="button" class="trivia-action" data-action="panto" data-lat="42.4" data-lng="11.9" data-zoom="7">𐌀 Ruka hadi Etruria</button>
  </div>

  <p>Kietruscan kimeandikwa katika <strong>alfabeti iliyokopwa kutoka Euboean Kigiriki</strong> karibu 700 KK — alfabeti hiyo hiyo ya Kigiriki cha magharibi ambayo, ikipita kupitia mikono ya Kietruscan kwenda kwa Warumi, ilipa dunia herufi za Kilatini ambazo unasoma sasa hivi. Kwa sababu maandishi ni ya kialfabeti na yanaeleweka vizuri, kila maandiko yanaweza kuhamishwa kifonetiki. Tatizo ni <strong>lugha nyuma ya maandishi</strong>: Kietruscan si cha Kiindo-Ulaya, si Kisemiti, si Kiitaliki, si chochote kingine kilicho na ndugu wanaoishi. Ndugu pekee wanaokubaliwa kwa upana ni lugha mbili zilizovunjika sana — <strong>Kirhaetic</strong> (katika Milima ya Alps) na <strong>Kilemnian</strong> (katika kisiwa cha Aegean cha Lemnos, kilichothibitishwa katika stele ya Kaminia ya karne ya 6 KK) — pamoja zinaunda familia ndogo ya <strong>Kityrsenian</strong>.</p>
  ...
  <p>Wasentinelese ni mojawapo ya watu wa <strong>Kiandamani</strong> — wanaaminika kuwa wazao wa mojawapo ya mawimbi ya kwanza kabisa ya migawanyo ya binadamu <em>Out of Africa</em>, ambao huenda walifika Visiwa vya Andaman makumi ya maelfu ya miaka iliyopita. Ushahidi wa kigenetiki unawaweka miongoni mwa makundi yaliyobaki yakitengwa muda mrefu zaidi kwenye sayari, ingawa muda halisi wa kutengwa kwao na mwendelezo wake hauwezi kuthibitishwa kwa uhakika. Majirani zao katika visiwa kipana — Great Andamanese, Onge wa Little Andaman, na Jarawa wa South na Middle Andaman — husema lugha zinazoanguka katika <strong>familia mbili zisizo na uhusiano</strong>: Great Andamanese, na familia ndogo ya Kiongan (Onge + Jarawa). Kisentinelese kinashukiwa kuwa dada wa tatu, labda karibu zaidi na Kiongan, lakini hakuna mtu amewahi kusikia maneno ya kutosha kuthibitisha.</p>

  <p>Kila jaribio lililoandikwa la mawasiliano lilishindwa au kuishia katika vurugu:</p>
  ...
  'modern-hebrew-revival': {
    title: 'Kiebrania — lugha ya kale iliyorudishwa katika maisha ya kila siku',
    summary: 'Kwa karibu miaka 1,700, Kiebrania kiliendelea kama lugha ya ibada na fasihi lakini hakuna mtoto aliyekua akikizungumza. Leo ni lugha ya mama ya watu milioni tisa — ufufuo mkubwa zaidi kwa kiwango na uliofanikiwa zaidi wa lugha ambayo ilikuwa imekoma kuwa lugha ya kila siku ya jamii.',
    body: `
  <p>Karibu mwaka <strong>200 BK</strong>, kaya ya mwisho katika Palestina ya Kirumi ambayo watoto walikua wakisikia Kiebrania mezani imenyamaza. Kiaramaic kilikuwa tayari kimechukua barabara; Kigiriki kilitawala miji; Mishnah ilikuwa ikiundwa kwa Kiebrania ambacho wasomi waliandika lakini hawakuzungumza zaidi. Kwa miaka 1,700 iliyofuata, Kiebrania kiliendelea kama lugha ya sinagogi, kitabu cha maombi, gombo la Torah, na barua kutoka kwa rabbi mmoja kwenda kwa mwingine — lugha iliyoandikwa iliyotumiwa na watu wazima wenye kusoma, lakini si maneno ya kwanza ya mtoto yoyote. Kisha, kwa namna fulani, hiyo ilibadilika. Kiebrania sasa ni lugha ya kila siku ya kuzungumza ya watu wapata <strong>milioni tisa</strong>, takriban nusu yao ni wasemaji wa kuzaliwa walioifunza wakiwa watoto wachanga. Pia kuna ufufuo wa kiwango kidogo (Kikorni, Kimanksi, Wampanoag), lakini Kiebrania kinaendelea kuwa kesi kubwa zaidi na iliyoandikwa kwa undani zaidi ya lugha ambayo haikuwa tena lugha ya mama ya yeyote kurudishwa katika matumizi ya kila siku ya jamii.</p>

  <div class="trivia-actions">
    <button type="button" class="trivia-action" data-action="focus" data-code="he" data-zoom="7">🌍 Onyesha Kiebrania kwenye ramani</button>
    <button type="button" class="trivia-action" data-action="panto" data-lat="31.78" data-lng="35.22" data-zoom="9">✡️ Ruka hadi Yerusalemu</button>
  </div>

  <p>Mtu mmoja anayehusishwa zaidi na ufufuo ni <strong>Eliezer Ben-Yehuda</strong> (1858–1922), msomi wa Kiyahudi aliyezaliwa Lithuania ambaye alihamia Palestina ya Ottoman mwaka 1881 akiwa na hamu moja: kwamba Wayahudi watakuwa taifa tena ikiwa watazungumza Kiebrania. Aliyafanya kaya yake kuwa maabara ya kwanza. Mwanawe <strong>Itamar Ben-Avi</strong>, aliyezaliwa Yerusalemu mwaka 1882, kwa ujumla anachukuliwa kuwa <strong>msemaji wa kwanza wa kuzaliwa wa Kiebrania cha kisasa kwa takriban miaka 1,700</strong>. Ben-Yehuda alikataza lugha yoyote nyingine nyumbani; mke wake, ambaye hakuzungumza Kiebrania walipoolewa, alijifunza kazini. Itamar inaripotiwa hakuongea lugha yoyote hadi alipokuwa karibu miaka minne, na wanafamilia walio na wasiwasi walimsihi Ben-Yehuda alegeze. Hakulegeza.</p>

  <p>Ben-Yehuda pia alipigana vita ya msamiati. Kiebrania cha Biblia na Mishnaic pamoja huenda vina maneno 8,000 — vya kutosha kwa maombi, vya kushindwa kwa kununua gazeti. Kwa hivyo Ben-Yehuda alibuni maneno. Baadhi bado ni hotuba ya kila siku ya Israeli:</p>

  <ul>
    <li><strong>milon</strong> (מילון) — "kamusi", kutoka <em>milah</em> "neno".</li>
    <li><strong>iton</strong> (עיתון) — "gazeti", kutoka <em>et</em> "wakati".</li>
    <li><strong>ofnayim</strong> (אופניים) — "baiskeli", fomu ya pacha ya <em>ofan</em> "gurudumu".</li>
    <li><strong>glida</strong> (גלידה) — "barafu ya krimu", kutoka mzizi unaomaanisha "kuganda".</li>
  ...
  <div class="trivia-actions">
    ...
    <button type="button" class="trivia-action" data-action="panto" data-lat="34.0" data-lng="72.0" data-zoom="6">🕉️ Ruka hadi Gandhāra ya Pāṇini</button>
  </div>

  <p>Tunajua karibu chochote kuhusu Pāṇini mtu — tu kwamba alikuwa kutoka kijiji cha Śalātura (Lahor / Lahur ya sasa, mara kwa mara hujulikana kama "Lahore Ndogo", karibu na Attock kaskazini-magharibi mwa Pakistan — isichanganywe na mji mkubwa wa Punjabi wa Lahore), labda alifanya kazi katika karne ya 5 au 4 KK, na kwamba kila kitu alichotoa kilionekana kuundwa kukumbukwa kwa sauti. Aṣṭādhyāyī ilihifadhiwa kwa kusoma kwa kurudia kwa karne kabla ya kuandikwa. Kuokoa silabi — na kwa hiyo pumzi — Pāṇini alibuni <strong>lugha-meta nzima ya kiufundi</strong>: mfumo wa vifupisho vya herufi moja, orodha za fonimu zilizoamuriwa zinazoitwa <strong>Śiva sūtras</strong>, mikataba ya matumizi ya sheria "tegemea-muktadha", anuvṛtti (urithi wa sheria kutoka mstari uliotangulia ambao hauhitaji kutamkwa tena), na mfumo wa kipaumbele wa kutatua sheria gani inatumika wakati sheria mbili zinapingana.</p>

  <p>Tokeo linasomeka, kwa jicho la kisasa, kwa ajabu kama sheria za uzalishaji wa sarufi isiyo na muktadha — tu yenye nguvu zaidi. Muundo wa sheria wa Pāṇini kimsingi ni:</p>

  <blockquote><em>A → B / X _ Y</em><br>"A inakuwa B katika muktadha ambapo inatanguliwa na X na kufuatwa na Y" — notation ambayo isimu ilirudia kwa kujitegemea mwaka 1968.</blockquote>

  <p>Mifano ya kile mashine ya Pāṇini hufanya:</p>

  <ul>
    <li><strong>Sandhi.</strong> Kisanskrit kinajulikana kwa kunyonya sauti kwenye mipaka ya maneno (<em>tat + ca → tac ca</em>, <em>tat + na → tan na</em>). Pāṇini hupunguza mfumo huu mzima kuwa seti ndogo ya sheria za kifonolojia zilizoamuriwa zinazofanya kazi kwa mzunguko — wazo lile lile lililoivumbuliwa upya kama <em>kifonolojia cha mzunguko</em> katika miaka ya 1970.</li>
    <li><strong>Mofolojia ya kitenzi.</strong> Kitenzi cha Kisanskrit kinaweza kuwa na takriban <em>fomu 2,000 zilizopinda</em>. Pāṇini anashughulikia hili kwa orodha yenye mwisho ya shina, sheria mia chache za viambishi, na kanuni ya kuamuru (<em>tripādī</em>) hivi kwamba sheria za baadaye huzuia za awali — kutangulia "Elsewhere Conditions" katika mofolojia ya kisasa.</li>
    <li><strong>Nadharia ya Kāraka.</strong> Pāṇini anachambua vitenzi si kwa maneno ya "sawa" na "kitu" bali kwa maneno ya <em>kārakas</em> — majukumu ya kisemantiki kama vile mtenda (<em>kartṛ</em>), mtendewa (<em>karman</em>), chombo (<em>karaṇa</em>), mpokeaji (<em>sampradāna</em>), chanzo (<em>apādāna</em>), na mahali (<em>adhikaraṇa</em>). Hii kimsingi ni <strong>nadharia ya jukumu la kithematiki</strong> (Charles Fillmore's "case grammar", 1968), miaka 2,400 mapema.</li>
  </ul>

  <div class="trivia-actions">
    <button type="button" class="trivia-action" data-action="setword" data-word="mother" data-code="sa">👩 Ona Kisanskrit "Mama"</button>
  ...
  'esperanto-zamenhof': {
    title: 'Esperanto — lugha bunifu iliyofanya kazi kweli',
    summary: 'Daktari wa macho wa Kiyahudi wa Kipolishi alichapisha kitabu cha kurasa 40 mwaka 1887. Leo lugha yake ina hadi wasemaji milioni mbili, takriban elfu moja kati yao ni wa kuzaliwa — lugha pekee iliyobuniwa iliyoshika mizizi kweli.',
    body: `
  <p>Mnamo Julai 1887, daktari mdogo wa macho katika Warsaw alichapisha kitabu kidogo kwa gharama yake mwenyewe chini ya jina la bandia <em>Doktoro Esperanto</em> — "Daktari Yule-Anayetumaini". Kitabu kiliitwa <strong>Lingvo Internacia</strong> ("Lugha ya Kimataifa"). Ndani ya kizazi, jina la bandia lilikuwa limekuwa jina la lugha yenyewe, na <strong>L. L. Zamenhof</strong> alikuwa amefikia kile ambacho hakuna mbunifu wa lugha iliyobuniwa amefanikiwa kabla au amelinganisha tangu hapo: alikuwa amejenga lugha ambayo watu wa kawaida walitaka kuzungumza.</p>

  <div class="trivia-actions">
    <button type="button" class="trivia-action" data-action="focus" data-code="eo" data-zoom="4">🌍 Onyesha Esperanto kwenye ramani</button>
    <button type="button" class="trivia-action" data-action="setword" data-word="hello" data-code="eo">👋 Ona Esperanto "Hujambo"</button>
  </div>

  <p>Zamenhof alikuwa amekulia Białystok, mji wa makabila mengi chini ya utawala wa Urusi ambapo Wayahudi, Wapolishi, Wajerumani, Warusi na Wabelarusi waliishi pamoja na mara nyingi katika kutoaminiana. Aliandika baadaye kwamba akiwa mvulana alikuwa amehitimisha kwamba Babeli ya kiisimu ndiyo sababu kuu ya chuki ya binadamu, na kwamba lugha ya pamoja isiyo na upande inaweza kuwapa watu msingi wa pamoja, sawa. Mradi wa kisiasa ulikuwa muhimu kwake kama wa kisarufi.</p>

  <p>Muundo ni rahisi sana. Sarufi ya Esperanto inatoshea kwenye postkadi — "<strong>Fundamento</strong>" inaipunguza kuwa <strong>sheria 16 zisizo na isipokuwa</strong>:</p>

  <ul>
    <li>Nomino zote huishia kwa <strong>-o</strong>, vivumishi kwa <strong>-a</strong>, vielezi kwa <strong>-e</strong>, infinitive kwa <strong>-i</strong>.</li>
    <li>Wingi siku zote ni <strong>-j</strong>; kitu cha moja kwa moja siku zote huchukua <strong>-n</strong>.</li>
    <li>Mkazo siku zote huanguka kwenye silabi ya pili kutoka mwisho.</li>
    <li>Vitenzi havipindi kwa mtu au nambari — tu kwa wakati (<em>-as, -is, -os</em>) na hali (<em>-us, -u</em>).</li>
    <li>Maneno hujengwa kwa agglutinative kutoka mizizi pamoja na orodha ndogo ya viambishi: <em>mal-</em> hurudisha maana (<em>bona</em> nzuri → <em>malbona</em> mbaya), <em>-ej-</em> hualamisha mahali (<em>lerni</em> jifunza → <em>lernejo</em> shule), <em>-in-</em> hualamisha kike.</li>
  </ul>

  <p>Msamiati ni hasa wa Kiromance pamoja na ladha ya Kijerumani na ya Kislavoni — takriban 75% Kiromance, 20% Kijerumani, 5% Kislavoni na Kigiriki. Hii ni maelewano ya makusudi: ya Kizungu lakini si imepangwa kitaifa na nguvu yoyote kubwa moja.</p>

  <div class="trivia-actions">
    <button type="button" class="trivia-action" data-action="setword" data-word="love" data-code="eo">❤️ "Upendo" — <em>amo</em></button>
    <button type="button" class="trivia-action" data-action="setword" data-word="water" data-code="eo">💧 "Maji" — <em>akvo</em></button>
    <button type="button" class="trivia-action" data-action="setword" data-word="one" data-code="eo">1️⃣ "Moja" — <em>unu</em></button>
  </div>
  ...
  <p>Leo Esperanto ina labda <strong>wasemaji milioni mbili</strong> katika viwango mbalimbali, na karibu <strong>wasemaji elfu moja wa kuzaliwa</strong> wanaojulikana kama <em>denaskuloj</em>, waliokulia katika kaya za lugha mbili ambapo Esperanto ni mojawapo ya lugha za nyumbani. Kozi ya Duolingo ya Esperanto pekee imeandikisha zaidi ya wanafunzi milioni moja. Kwa kipimo chochote — jamii inayoendelea, upana wa fasihi, idadi ya wasemaji wa kuzaliwa — Esperanto ndiyo lugha bunifu iliyofanikiwa zaidi kuwahi kujaribiwa, kwa tofauti kubwa.</p>

  <p>Zamenhof hakuwahi kudai Esperanto ingebadilisha lugha ya mama ya mtu yeyote. Alitaka <em>dua lingvo</em> — lugha ya pili — sawa ya kigeni kwa kila mtu, ili hakuna msemaji wa kuzaliwa angekuwa na faida juu kwenye meza ya mazungumzo. Karne na nusu baadaye, mradi ni mdogo, lakini bado uko hai, bado hauna upande, na bado una matumaini — kama vile mwanzilishi wake, <em>Doktoro Esperanto</em>, alivyosaini jina lake.</p>
    `
  },

  'toki-pona-minimalism': {
    title: 'Toki Pona — Je, unaweza kusema kila kitu kwa maneno 120?',
    summary: 'Mwanaisimu wa Kanada alibuni lugha yenye maneno ~120 tu na sauti ~14, kwa sehemu kama jaribio la mawazo la Kitao. Miongo miwili baadaye, maelfu ya watu husema — na wengi husema ilibadilisha jinsi wanavyofikiria.',
    body: `
  <p>Mwaka 2001, mwanaisimu na mtafsiri wa Kanada aitwaye <strong>Sonja Lang</strong> (aliyezaliwa Sonja Elen Kisa) alikuwa akipambana na huzuni. Kama sehemu ya kupona kwake alianza kujaribu lugha iliyo ndogo kwa makusudi — moja ambayo ingemlazimisha kueleza mawazo akitumia tu kile kilichokuwa muhimu kweli. Aliiita <strong>Toki Pona</strong>, "lugha ya wema", au halisi zaidi "hotuba njema / hotuba rahisi".</p>

  <div class="trivia-actions">
    <button type="button" class="trivia-action" data-action="focus" data-code="tok" data-zoom="4">🌍 Onyesha Toki Pona kwenye ramani</button>
  ...
  <ul>
    <li><strong>Konsonanti 9</strong>: <em>p, t, k, s, m, n, l, j, w</em>.</li>
    <li><strong>Vokali 5</strong>: <em>a, e, i, o, u</em>.</li>
    <li>Silabi ni (C)V(n). Hakuna makundi ya konsonanti, hakuna toni, hakuna tofauti za urefu.</li>
    <li>Mkazo siku zote ni kwenye silabi ya kwanza.</li>
  </ul>

  <p>Hilo hutoa tu kuhusu <strong>fonimu 14</strong> kwa jumla — chache zaidi kuliko ~44 za Kiingereza — na orodha ya sauti ilieneza sana kati ya lugha mbalimbali kwamba karibu mtu yeyote anaweza kutamka Toki Pona kwa kusikia kwa mara ya kwanza.</p>

  <p>Kwa hivyo unawezaje kusema chochote kwa maneno 120? <strong>Mchanganyiko.</strong> Toki Pona haina neno la "rafiki", "kompyuta" au "maktaba". Badala yake unaelezea:</p>

  <ul>
    <li><em>jan pona</em> — "mtu mwema" → rafiki</li>
    <li><em>ilo sona</em> — "chombo cha maarifa" → kompyuta</li>
    <li><em>tomo pi lipu mute</em> — "nyumba ya nyaraka nyingi" → maktaba</li>
    <li><em>telo nasa</em> — "maji ya kushangaza" → pombe</li>
    <li><em>kala lawa</em> — "samaki wa kichwa" → bosi-samaki, yaani papa, au kwa mfano bosi wako</li>
  </ul>

  <div class="trivia-actions">
    <button type="button" class="trivia-action" data-action="setword" data-word="water" data-code="tok">💧 "Maji" — <em>telo</em></button>
    <button type="button" class="trivia-action" data-action="setword" data-word="sun" data-code="tok">☀️ "Jua" — <em>suno</em></button>
  ...
  <p>Hata hivyo jamii inaendelea kukua. Leo kuna makadirio ya <strong>wasemaji elfu kadhaa wenye amali</strong>, subreddit iliyojitolea, Discord <em>ma pona pi toki pona</em> yenye makumi ya maelfu ya wanachama, mashairi asili, albamu za muziki, na hata hati iliyobuniwa — <em>sitelen pona</em> — ambapo kila glyph ni picha ndogo ya neno moja la msingi. Iwapo Toki Pona inakufanya uwe mwerevu zaidi inaweza kujadiliwa; kwamba inawafanya wasemaji wake <em>kufikiri zaidi juu ya kile wanachomaanisha kweli</em> haiwezi.</p>
    `
  },
  ...
  <p>Sentensi maarufu ya mfano kutoka kwa sarufi ya Quijada:</p>

  <blockquote><em>Tram-mļöi hhâsmařpţuktôx.</em><br>"Kinyume chake, ninafikiri inaweza kuwa kwamba safu hii ya milima yenye ugumu inaweza kuteleza kwa pole pole hadi kufutwa wakati fulani."</blockquote>

  <p>Maneno mawili. Sentensi kamili ya Kiingereza. Msongamano huo ni lengo lote.</p>
  ...
  <p>Je, Ithkuil ni kushindwa? Tu ikiwa unapima lugha bunifu kwa ukubwa wa jamii. Kama kipande cha <em>usanifu wa kiisimu</em> — onyesho lililoendelea, la miongo, la kiasi gani maana ya mfumo wa kutamka wa binadamu unaweza kufanywa kubeba kwa sekunde ya hotuba — haina mlinganifu. Ni kwa Esperanto kama Saturn V roketi ni kwa baiskeli: hakuna anayesafiri kazini juu yake, lakini inaonyesha kile kinachowezekana kimwili.</p>
    `
  },


  'hangul-scientific-script': {
    title: 'Hangul — alfabeti ambayo mfalme alibuni katika maabara',
    summary: 'Mwaka 1443 Mfalme Sejong Mkuu aliifunua alfabeti mpya ya Kikorea ambayo maumbo ya herufi zake halisi yanaonyesha kifaa cha sauti. Wanaisimu huiita mfumo wa kuandika ulioundwa kwa sayansi zaidi duniani — na ilikaribia kupigwa marufuku mara mbili.',
    body: `
  <p>Alfabeti nyingi zilibadilika. Zinapeperushwa kwa karne kutoka pictographs hadi abstractions, hakuna anayekumbuka kabisa kwa nini "B" inaonekana jinsi inavyoonekana. <strong>Hangul</strong> sio hivyo. Hangul ina siku ya kuzaliwa — <strong>9 Oktoba 1446</strong>, tarehe ambayo maelezo yake yanayofuatana, <em>Hunminjeongeum Haerye</em>, yalichapishwa. Na ina mvumbuzi mmoja, aliyepewa jina: <strong>Mfalme Sejong Mkuu</strong> (世宗大王, r. 1418–1450) wa Joseon Korea, akifanya kazi na wasomi wa Hall of Worthies (集賢殿, <em>Jiphyeonjeon</em>).</p>

  <div class="trivia-actions">
    <button type="button" class="trivia-action" data-action="focus" data-code="ko" data-zoom="6">🌍 Onyesha Kikorea kwenye ramani</button>
    <button type="button" class="trivia-action" data-action="setword" data-word="hello" data-code="ko">👋 "Hujambo" — <em>안녕하세요</em></button>
  </div>

  <p>Motisha ya Sejong, iliyoelezwa katika utangulizi wa mradi, ni mojawapo ya mwanzo wa kuhuzunisha katika historia yoyote ya mfumo wa kuandika:</p>

  <blockquote>"Hotuba ya nchi yetu ni tofauti na ile ya China na hailingani na herufi za Kichina. Kwa hivyo, hata kama wajinga wanataka kuwasiliana, wengi wao hawawezi kueleza wenyewe. Nikifikiri hili kwa huruma, nimebuni upya herufi ishirini na nane, nikitamani tu kwamba kila mtu apate kuzijifunza kwa urahisi na kuzitumia katika maisha yao ya kila siku." — Mfalme Sejong, utangulizi wa <em>Hunminjeongeum</em>, 1446</blockquote>
  ...
  <ul>
    ...
    <li><strong>ㄴ</strong> (n) inaonyesha ncha ya ulimi ikigusa ukingo wa alveoli nyuma ya meno.</li>
  ...
  <div class="trivia-actions">
    <button type="button" class="trivia-action" data-action="setword" data-word="one" data-code="ko">1️⃣ "Moja" — <em>하나</em> / <em>일</em></button>
    <button type="button" class="trivia-action" data-action="setword" data-word="moon" data-code="ko">🌙 "Mwezi" — <em>달</em></button>
    <button type="button" class="trivia-action" data-action="setword" data-word="water" data-code="ko">💧 "Maji" — <em>물</em></button>
  </div>
  ...
  <div class="trivia-actions">
    <button type="button" class="trivia-action" data-action="focus" data-code="chr" data-zoom="5">🌍 Onyesha Cherokee kwenye ramani</button>
    <button type="button" class="trivia-action" data-action="setword" data-word="hello" data-code="chr">👋 "Hujambo" — <em>ᎣᏏᏲ (osiyo)</em></button>
  </div>

  <p>Sequoyah alikuwa fundi wa fedha na mkongwe wa vita aliyejeruhiwa wa Kikosi cha Cherokee chini ya Andrew Jackson katika Vita ya Creek. Hakuzungumza Kiingereza na hakuwa amepata elimu rasmi. Lakini alikuwa ameona askari wanaozungumza Kiingereza wakisoma na kuandika barua wakati wa vita — kile Wacherokee waliita "majani yanayozungumza" — na akawa amesadiki kwamba hii haikuwa uchawi bali teknolojia, na kwamba watu wake mwenyewe pia walistahili.</p>

  <p>Kutoka karibu 1809 alifanya kazi kwa obsession juu ya tatizo. Jaribio lake la kwanza lilikuwa la kilogografiki — ishara moja kwa neno moja — na inaripotiwa alichora zaidi ya ishara elfu kabla ya kutambua kwamba mfumo huo hauwezi kujifunzwa. Inaripotiwa kwamba mke wake aliwaka kazi yake kwa hasira wakati mmoja. Alianza tena.</p>

  <p>Mafanikio yalikuwa utambuzi kwamba Cherokee, kama Kijapani, ina orodha ndogo ya silabi tofauti — kuhusu 85. <strong>Syllabary</strong>, si alfabeti, ndiyo iliyofaa kawaida. Aliainisha ishara moja kwa kila silabi. Kwa msukumo alichukua kutoka kwa maumbo ya herufi za Kilatini, Kigiriki na Kicyril (ambazo hangeweza kusoma) pamoja na maumbo asili, akiyatibu kila kimoja kama alama ya kuona isiyo na maana ya kulinganishwa na sauti ya Cherokee. Tokeo lina herufi zinazoonekana kawaida lakini hazimaanisha chochote cha kile washirika wao wa Kizungu wanamaanisha:</p>

  <ul>
    <li><strong>D</strong> katika Cherokee ni <em>a</em></li>
    <li><strong>R</strong> katika Cherokee ni <em>e</em></li>
    <li><strong>T</strong> katika Cherokee ni <em>i</em></li>
    <li><strong>L</strong> katika Cherokee ni <em>tle</em></li>
    <li><strong>Ꮳ</strong> inaonekana Kigiriki lakini ni silabi ya Cherokee <em>tsa</em></li>
  </ul>

  <p>Mwaka 1821 alionyesha mfumo, kwa kujulikana, kwa kumtenga binti yake wa miaka sita <em>Ayoka</em> kutoka kwa watazamaji na kumfanya anakili na kisha asome ujumbe alioamuriwa kwake. Baraza la Taifa la Cherokee halikuwa na ushawishi kwamba hili lilikuwa chochote isipokuwa hila — hadi walipojaribu wenyewe na kupata kwamba watu wazima wanaweza kuwa wa kusoma na kuandika kwa utendaji katika <strong>siku, si miaka</strong>.</p>

  <div class="trivia-actions">
    <button type="button" class="trivia-action" data-action="setword" data-word="water" data-code="chr">💧 "Maji" — <em>ᎠᎹ (ama)</em></button>
    <button type="button" class="trivia-action" data-action="setword" data-word="fire" data-code="chr">🔥 "Moto" — <em>ᎠᏥᎳ (atsila)</em></button>
    <button type="button" class="trivia-action" data-action="setword" data-word="moon" data-code="chr">🌙 "Mwezi" — <em>ᏃᏓ (nvda)</em></button>
  </div>
  ...
  'vai-dream-script': {
    title: 'Vai — hati ya Afrika Magharibi iliyokuja katika ndoto',
    summary: 'Karibu 1832 mwanamume wa Liberia aitwaye Momolu Duwalu Bukele alisema mgeni asiyejulikana alimtokea katika ndoto na akamfundisha hati ya lugha yake mwenyewe ya Vai. Karne mbili baadaye, hati hiyo iko kwenye simu za mkononi.',
    body: `
  <p>Historia ya kuandika ina aina ndogo lakini ya kuvutia: hati ambazo wavumbuzi wao husema waliwapokea katika ndoto au maono. <strong>Syllabary ya Vai</strong> ya Liberia ni maarufu zaidi na yenye nyaraka bora zaidi kati yao — na ikawa, mwaka 1834, mojawapo ya uvumbuzi wa kwanza wa kujitegemea wa kuandika katika Afrika Magharibi ya kisasa.</p>

  <div class="trivia-actions">
    <button type="button" class="trivia-action" data-action="focus" data-code="vai" data-zoom="6">🌍 Onyesha Vai kwenye ramani</button>
    <button type="button" class="trivia-action" data-action="panto" data-lat="6.5" data-lng="-11" data-zoom="6">🗺️ Ruka hadi pwani ya Liberia</button>
  </div>

  <p>Mvumbuzi alikuwa <strong>Mɔmɔlu Duwalu Bukɛlɛ</strong> (anaandikwa kwa namna mbalimbali Momolu Duwalu Bukele, k. 1810–miaka ya 1850) wa watu wa Vai, wanaoishi kwenye pwani ya kile ambacho sasa ni Liberia na Sierra Leone. Kulingana na mahojiano yaliyorekodiwa na mmisionari wa Kijerumani <strong>S. W. Koelle</strong> mwaka 1849 — na yaliyochapishwa katika monograph yake ya 1854 <em>Outlines of a Grammar of the Vei Language</em> — Bukele alisema hati ilimjia karibu 1832–1833 katika ndoto:</p>

  <blockquote>"Mwanamume mrefu, mwenye kuonekana mwenye heshima, mzungu, akiwa amevaa koti refu, alionekana na akasema: 'Nimetumwa kwako na wanaume wengine weupe ... Ninakuletea kitabu.' [Mgeni] kisha akanionyesha ishara nyingi kwenye karatasi, lakini sikuzielewa. ... Nilipoamka, niliwaita marafiki zangu pamoja, na tukaanza kufanya kazi, na baada ya muda fulani tukafanya kitabu chetu." — Maelezo ya Bukɛlɛ, kama yalivyorekodiwa na Koelle, 1849</blockquote>
  ...
  <ul>
    ...
    <li>Wanaume wa Vai katika karne ya 19 walikuwa wakiandikiana barua mara kwa mara katika hati tatu kulingana na mpokeaji: <em>Vai</em> kwa Wavai wenzao, <em>Kiarabu</em> kwa Waislamu wa makundi mengine, na <em>Kilatini</em> kwa Wazungu.</li>
    <li>Hati ilinusurika vita vya wenyewe kwa wenyewe vya Liberia (1989–2003) na mlipuko wa Ebola wa 2014.</li>
  </ul>
  ...
  <p>Kusoma na kuandika kwa Vai kukawa somo la utafiti maarufu wa <strong>1981 na Sylvia Scribner na Michael Cole</strong>, <em>The Psychology of Literacy</em>. Jamii ya Vai ilikuwa — na kwa kiasi fulani bado ni — maabara ya asili: watu wazima wengi husoma katika hati moja, mbili au tatu (Vai, Kiarabu, Kilatini), kila moja imepatikana katika mazingira tofauti (Vai isiyo rasmi kutoka kwa jamaa, Kiarabu katika shule za Kurani, Kilatini katika shule za mtindo wa kikoloni). Scribner na Cole walilinganisha athari za kiakili za kila moja na kuhitimisha kwamba "faida za kiakili za kusoma na kuandika" zilizodaiwa kwa umaarufu na wasomi wa awali kwa kiasi kikubwa zilikuwa <em>maalum kwa elimu ya shule</em>, si kwa kusoma na kuandika kama hivyo. Kusoma na kuandika kwa hati ya Vai, kulijifunzwa isiyo rasmi, peke yake hakukubadilisha fikra. Lilikuwa tokeo la athari kubwa katika utafiti wa elimu.</p>

  <p>Hati ya Vai iliongezwa kwa <strong>Unicode 5.1 mwaka 2008</strong> (block U+A500–U+A63F), na sasa inapatikana kwenye Android, iOS na uvunjifu mkuu wa Linux. Kuna vipande vya Wikipedia ya lugha ya Vai, mipangilio ya kibodi ya Vai, na jamii ndogo lakini inayodumu mtandaoni. Watu wa Vai wenyewe hawakuwahi kupoteza hati yao; leo, karibu miaka 200 baada ya ndoto ya Bukele, bibi wa Kivai anaweza kutuma WhatsApp kwa mjukuu wake katika syllabary ile ile ambayo mwanamume mdogo katika 1834 aliandika kwenye karatasi yake ya kwanza iliyoletwa kutoka nje.</p>

  <p>Iwapo ndoto ilikuwa mfano au kumbukumbu, Bukele alielewa teknolojia ya kijamii vyema kuliko wengi wa watu wa wakati wake wa Kizungu: kuandika si uchawi, na watu wowote wanaotaka wanaweza kuwa nayo.</p>
    `
  },
  ...
  <div class="trivia-actions">
    <button type="button" class="trivia-action" data-action="focus" data-code="txg" data-zoom="5">🌍 Onyesha Tangut kwenye ramani</button>
  ...
  <div class="trivia-actions">
    <button type="button" class="trivia-action" data-action="setword" data-word="moon" data-code="txg">🌙 Ona Tangut "Mwezi"</button>
  ...
  'linear-a-undeciphered': {
    title: 'Linear A — hati tunayoweza kusoma lakini hatuwezi kuelewa',
    summary: 'Takriban maandishi 1,400 ya Enzi ya Shaba kutoka Kreta ya Minoa. Tunaweza kuzungumza karibu kila ishara — bado lugha nyuma yao inabaki, baada ya karne ya juhudi, isiyojulikana kabisa.',
    body: `
  <p>Kati ya takriban <strong>1800 na 1450 KK</strong>, ustaarabu wa Minoa wa Kreta uliendesha akaunti zake za kasri, kujitolea na lebo katika hati ya silabi ambayo sasa tunaitwa <strong>Linear A</strong>. Karibu <strong>maandishi 1,400</strong> yanaendelea — wengi wao wafupi, walichorwa kwenye vibao vya udongo, meza za libation, na shoka mbili za shaba kutoka maeneo kama Knossos, Phaistos, Hagia Triada, na Zakros.</p>

  <div class="trivia-actions">
    <button type="button" class="trivia-action" data-action="panto" data-lat="35.30" data-lng="25.15" data-zoom="7">🗺️ Ruka hadi Kreta ya Minoa</button>
  </div>
  ...
  <div class="trivia-actions">
    <button type="button" class="trivia-action" data-action="panto" data-lat="35.05" data-lng="24.81" data-zoom="9">🏛️ Hagia Triada (uvumbuzi tajiri zaidi)</button>
  </div>

  <div class="trivia-actions">
    <button type="button" class="trivia-action" data-action="panto" data-lat="35.40" data-lng="25.16" data-zoom="9">🏛️ Eneo la kasri la Knossos</button>
  </div>
  ...
  <p>Tumaini ni kwamba uchimbaji kwenye maeneo kama Zominthos au Petras hatimaye utatoa maandishi marefu ya lugha mbili — labda Minoan iliyounganishwa na Kimisri au Kiakkadian — au tu kibao cha Linear A kirefu cha kutosha kwa uchambuzi wa kitakwimu na wa kimofolojia kupata mvuto. Hadi wakati huo, Linear A inabaki kuwa kitabu kikubwa kisichosomwa cha kabla ya historia ya Ulaya, kikifichwa wazi kwenye vibao vya udongo tulivyokuwa tukishikilia kwa miaka mia moja.</p>
    `
  },

  'aymara-time-reversed': {
    title: 'Kiaymara — lugha ambapo wakati uliopita uko mbele yako',
    summary: 'Katika Kiaymara, wakati uliopita uko mbele (ambapo unaweza kuona) na wakati ujao uko nyuma (haoneki). Wasemaji huelekeza mbele kwa "jana" na juu ya bega kwa "mwaka ujao".',
    body: `
  <p>Iwapo unauliza msemaji wa Kiingereza kile kilicho "mbele", watakwambia kuhusu mikutano ya <em>wiki ijayo</em>, mwisho wa muda <em>mbele</em>, siku zijazo <em>za kutarajia</em>. Wakati ujao uko mbele; wakati uliopita uko nyuma. Karibu kila lugha ya Indo-Ulaya hupakia wakati hivi, na wanasayansi wengi wa fikra walidhani kwa miongo kwamba sitiari ilikuwa karibu ya ulimwengu wote ya fikra ya binadamu.</p>

  <p>Kisha mwaka 2006, Rafael Núñez na Eve Sweetser walichapisha utafiti wa makini wa shamba wa <strong>Kiaymara</strong>, lugha inayozungumzwa na takriban <strong>watu milioni 2–3</strong> katika Andes ya juu ya Bolivia, Peru na kaskazini mwa Chile — na walipata mapinduzi kabisa.</p>

  <div class="trivia-actions">
    <button type="button" class="trivia-action" data-action="focus" data-code="ay" data-zoom="6">🌍 Onyesha Kiaymara kwenye ramani</button>
    <button type="button" class="trivia-action" data-action="panto" data-lat="-16.5" data-lng="-68.15" data-zoom="6">🗺️ Ruka hadi La Paz</button>
  </div>

  <p>Katika Kiaymara, neno la msingi la "mbele" ni <em>nayra</em> — ambalo pia linamaanisha <strong>"jicho"</strong> na <strong>"mwoneko"</strong>. Neno la msingi la "nyuma" ni <em>qhipa</em>, ambalo pia linamaanisha <strong>"mgongo"</strong>. Mizizi hii ya kimwanya inatumika tena kwa wakati, na mpangilio ni:</p>

  <ul>
    <li><strong><em>nayra mara</em></strong> — kihalisi "mwaka wa jicho/mbele", ikimaanisha <strong>mwaka uliopita</strong>.</li>
    <li><strong><em>nayra pacha</em></strong> — "wakati wa jicho/mbele", ikimaanisha <strong>wakati uliopita</strong>, <strong>nyakati za kale</strong>.</li>
    <li><strong><em>qhipüru</em></strong> — kutoka "siku ya nyuma", ikimaanisha <strong>kesho / siku ya baadaye</strong>.</li>
    <li><strong><em>qhipa mara</em></strong> — "mwaka wa nyuma", ikimaanisha <strong>mwaka ujao</strong>.</li>
  </ul>

  <p>Mantiki, iliyotolewa mara kwa mara na wasemaji wa Kiaymara wakiulizwa, ni nzuri thabiti: <em>wakati uliopita ni kile ulichokwisha kuona, kwa hivyo lazima uwe mbele yako, ambapo macho yanaangalia. Wakati ujao haujaonekana, haujulikani — kwa hivyo uko nyuma ya mgongo wako, ambapo huwezi kuona.</em></p>

  <div class="trivia-actions">
    <button type="button" class="trivia-action" data-action="setword" data-word="sun" data-code="ay">☀️ Ona Kiaymara "Jua"</button>
  </div>

  <p>Núñez na Sweetser hawakuegemea tu kwenye glosses za leksika, ambazo zinaweza kupotosha. Walipiga filamu wasemaji wazee wa Kiaymara walipokuwa wakizungumza kuhusu matukio ya miongo nyingi nyuma na miongo katika siku zijazo. Ishara hazina utata: wakati wa kuelezea matukio yaliyopita, wasemaji huashiria <strong>mbele, ndani ya uwanja wa kuona mbele yao</strong> — wakati mwingine kwa kufagia, wakati mwingine kuelekeza mahali maalum panaowaza. Wakati wa kuelezea matukio yajayo, huashiria nyuma, wakati mwingine kwa kidole gumba kilichotupwa juu ya bega. Kadiri inavyozidi nyuma kwa wakati, ndivyo ishara ya mbele zaidi. Kadiri inavyozidi katika siku zijazo, ndivyo nyuma zaidi.</p>
  ...
  'tuyuca-evidentials': {
    title: 'Tuyuca — lugha ambapo lazima ufunue jinsi unavyojua',
    summary: 'Katika Kituyuca cha NW Amazoni, kila kitenzi cha mwisho hualamisha kwa lazima ushahidi: ulikiona, ulikisikia, ulikidhani, ulikitabiri, au uliambiwa? Huwezi kusema "John alicheza mpira wa miguu" bila kueleza ipi.',
    body: `
  <p>Fikiria unapaswa kusimulia tukio dogo — tuseme, kwamba John alicheza mpira wa miguu jana. Katika Kiingereza unaweza kusema tu "John alicheza mpira wa miguu", na msikilizaji wako hana wazo kama ulikuwa kwenye mstari wa upande, ulisikia kelele kutoka mtaa ujao, ulidhana kutoka kwa buti zake zenye matope, au uliambiwa na rafiki. Lugha za Ulaya huiacha <em>chanzo</em> cha habari karibu bila alama kabisa.</p>

  <p>Katika <strong>Tuyuca</strong> — lugha ya <strong>Tukanoan Mashariki</strong> yenye <strong>wasemaji 1,000</strong> katika eneo la Vaupés kwenye mpaka wa Brazili–Kolombia — huwezi kufanya hivyo. Kila kitenzi cha mwisho lazima kibebe kiambishi kidogo kinachoonyesha <em>jinsi unavyojua kile unachodai</em>. Hakuna fomu isiyo na upande. Zungumza bila ushahidi na haujasema sentensi ya kisarufi.</p>

  <div class="trivia-actions">
    <button type="button" class="trivia-action" data-action="focus" data-code="tue" data-zoom="6">🌍 Onyesha Tuyuca kwenye ramani</button>
    <button type="button" class="trivia-action" data-action="panto" data-lat="0.5" data-lng="-69" data-zoom="6">🗺️ Ruka hadi eneo la Vaupés</button>
  </div>

  <p>Maelezo ya upainia ni karatasi ya Janet Barnes ya 1984. Aliorodhesha <strong>kategoria tano za ushahidi</strong> katika Tuyuca, kila moja ikitokea kama mwisho tofauti wa kitenzi:</p>

  <ul>
    <li><strong>Wa kuona</strong> — msemaji aliona tukio kwa macho yake mwenyewe. Tuyuca: <em>díiga apé-wi</em> "alicheza mpira wa miguu (mimi niliona)".</li>
    <li><strong>Wa kihisi usio wa kuona</strong> — msemaji alisikia, alinusa, au alihisi tukio lakini hakuona. <em>díiga apé-ti</em> "alicheza mpira wa miguu (niliwasikia)".</li>
    <li><strong>Wa kudhani</strong> — msemaji hakuyaona tukio lakini aliona athari za kimwili. <em>díiga apé-yi</em> "alicheza mpira wa miguu (ninaona uwanja wenye matope)".</li>
    <li><strong>Wa kudhaniwa</strong> — msemaji anasababu kutoka kwa maarifa ya jumla: k.m. siku zote anacheza Jumamosi. <em>díiga apé-hĩyi</em>.</li>
    <li><strong>Wa kuambiwa</strong> — msemaji aliambiwa. <em>díiga apé-yigi</em> "alicheza mpira wa miguu (hivyo wanasema)".</li>
  </ul>

  <p>Mfumo ni zaidi ya mkataba wa adabu. Ni kizuizi kigumu cha kisarufi, kilichojifunzwa mapema na watoto, na kuheshimiwa hata katika mazungumzo ya kawaida. Msemaji wa Tuyuca anayesimulia ugomvi anahitajika kuonyesha — kila kifungu — kama walishuhudia, walisikia, au waliambiwa. Kuondoa kiambishi ni kuzalisha sentensi mbaya, kama kusema <em>"jana yeye kwenda duka"</em> katika Kiingereza.</p>

  <div class="trivia-actions">
    <button type="button" class="trivia-action" data-action="setword" data-word="eye" data-code="tue">👁️ Ona Tuyuca "Jicho"</button>
  </div>
  ...
  <div class="trivia-actions">
    <button type="button" class="trivia-action" data-action="setword" data-word="drink" data-code="tue">🥤 Ona Tuyuca "Kunywa" (sĩdĩ)</button>
  </div>

  <p>Kile kilicho wazi ni kwamba Tuyuca inafichua dhana iliyofichwa ya falsafa nyingi za lugha za Magharibi: kwamba kauli ni kwa msingi madai yasiyo na alama ya "ukweli". Kwa msemaji wa Tuyuca hakuna msingi kama huo. Kila sentensi, kwa ufanisi, inatangulizwa na sawa ya kiakili ya <em>"niliona"</em>, <em>"nilisikia"</em>, au <em>"niliambiwa"</em>. Sarufi ya chanzo imejengwa katika kila kitenzi.</p>
    `
  },

  'guugu-yimithirr-cardinal': {
    title: 'Guugu Yimithirr — lugha bila kushoto au kulia',
    summary: 'Lugha ya Aborigine wa Australia ya Mbali Kaskazini ya Queensland inayotumia tu maelekezo kamili ya kardinali — kaskazini, kusini, mashariki, magharibi — hata kwa vitu kwenye meza. Wasemaji huhifadhi mwelekeo wa <em>dead-reckoning</em> (urambazaji wa makadirio) wakati wote.',
    body: `
  <p>Iwapo unakaa kwenye meza na msemaji wa Kiingereza na wanataka uwapitishie kikombe, watasema "kikombe upande wako wa kushoto" au "kikombe mbele yako". Mfumo wa marejeleo ni <strong>egocentric</strong> — umewekwa kwenye mwili wako. Karibu kila lugha ya Kizungu hufanya kazi hivi.</p>

  <p>Iwapo unakaa na msemaji wa <strong>Guugu Yimithirr</strong> — lugha ya <strong>Pama-Nyungan</strong> ya Cape York Peninsula kaskazini mwa Queensland, Australia — wao badala yake watasema, kwa ufanisi, "kikombe kaskazini yako" au "kikombe mashariki yako". Guugu Yimithirr haipendi tu maelekezo ya kardinali. Haina <strong>msamiati wa uzalishaji wa kushoto au kulia kabisa</strong> wakati wa kuelezea eneo la vitu vya nje. Mhimili wa mwili haitumiki katika mfumo wa msingi wa kimwanya.</p>

  <div class="trivia-actions">
    <button type="button" class="trivia-action" data-action="focus" data-code="kky" data-zoom="6">🌍 Onyesha Guugu Yimithirr kwenye ramani</button>
    <button type="button" class="trivia-action" data-action="panto" data-lat="-15.5" data-lng="145.25" data-zoom="6">🗺️ Ruka hadi Hopevale, Cape York</button>
  </div>
  ...
  <p>Maneno haya yanaungana kwa uhuru na vitenzi, postpositions, na hata morphemes za mwendo. Unaweza kusema "Niliangushia <em>nagaalu</em>" — kumaanisha "Niliangushia upande wa mashariki". Mtu anayesimulia hadithi kuhusu mapigano hasemi "alimpiga ngumi usoni"; anasema "alimpiga ngumi kwenye shavu la upande wa kaskazini" — na muhimu, "kaskazini" hiyo ni kaskazini halisi ya dunia ya kompasi wakati wa mapigano, si wakati wa kusimulia.</p>

  <div class="trivia-actions">
    <button type="button" class="trivia-action" data-action="setword" data-word="hand" data-code="kky">✋ Ona Guugu Yimithirr "Mkono"</button>
  </div>
  ...
  <div class="trivia-actions">
    <button type="button" class="trivia-action" data-action="setword" data-word="sun" data-code="kky">☀️ Ona Guugu Yimithirr "Jua"</button>
  </div>

  <p>Guugu Yimithirr pia ina madai mengine ya umaarufu: ni lugha ambayo Kiingereza kilikopa neno <strong>"kangaroo"</strong>. Wafanyakazi wa James Cook walirekodi <em>gangurru</em> mwaka 1770 kama jina la aina maalum kubwa ya kangaroo ya kijivu — na neno likasafiri ulimwenguni. Lugha sasa ina chini ya wasemaji 1,000 wenye ufasaha, lakini somo lake la kifikra limefika mbali zaidi.</p>
    `
  },

  'mohawk-polysynthesis': {
    title: 'Mohawk — wakati neno moja ni sentensi nzima',
    summary: 'Mohawk, lugha ya Iroquoian ya misitu ya kaskazini-mashariki, ni polysynthetic — fomu moja ya kitenzi inaweza kusimba mhusika, kitu, mfaidikaji, wakati, hali, hisia, na hata nomino iliyounganishwa, ikifanya kazi ya sentensi nzima ya Kiingereza.',
    body: `
  <p><strong>Mohawk</strong> (<em>Kanien'kéha</em>, "lugha ya Watu wa Jiwe la Moto") ni mojawapo ya lugha sita za Muungano wa Haudenosaunee, inayozungumzwa katika jamii za kusini mwa Quebec, Ontario, na New York ya juu. Ni mwanachama anayezungumzwa zaidi wa familia ya <strong>Iroquoian</strong>, na wasemaji takriban 3,500 na harakati ya kuhuisha kwa shule za kuzama iliyoongozwa na jamii kama Kahnawà:ke na Akwesasne.</p>

  <div class="trivia-actions">
    <button type="button" class="trivia-action" data-action="focus" data-code="moh" data-zoom="6">🌍 Onyesha Mohawk kwenye ramani</button>
  </div>

  <p>Kiisimu Mohawk ni mfano wa kitabu cha kufundisha cha <strong>lugha ya polysynthetic</strong> — aina ambapo fomu moja ya kitenzi inajengwa kutoka kwa mlolongo mrefu wa viambishi vya lazima na vya hiari, mara nyingi kueleza kifungu kizima cha Kiingereza ndani ya neno moja. Mfano wa kawaida, ulinukuliwa mara kwa mara na Marianne Mithun:</p>

  <blockquote><em>washakotya'tawitsherahetkvhta'se'</em><br>
  "alimharibia gauni yake kwa ajili yake"</blockquote>

  <p>Kuvuta neno moja huko kutoka kwa kila mmoja kunatoa takriban:</p>
  ...
  <ul>
    ...
    <li><em>-e'</em> — punctual aspect (tukio moja lililokamilika)</li>
  </ul>

  <p>Muundo wa hoja wa sentensi nzima ya Kiingereza umepakwa katika mofolojia ya kitenzi kimoja. Mohawk pia inaonyesha <strong>kujumuisha kwa nomino</strong>: nomino ya kawaida ya kitu (hapa, "gauni") huingia ndani ya shina la kitenzi badala ya kuonekana kama neno tofauti. Wallace Chafe na Mithun wameonyesha kwamba kujumuisha kunatawaliwa na kanuni za kiwango cha mazungumzo — nomino zilizojumuishwa kawaida zinawekwa nyuma, wakati nomino za kujitegemea zinaonyesha mhusika.</p>

  <div class="trivia-actions">
    <button type="button" class="trivia-action" data-action="setword" data-word="house" data-code="moh">🏠 Ona Mohawk "Nyumba"</button>
  ...
  'nuxalk-vowelless': {
    title: 'Nuxalk — maneno yasiyokuwa na vokali kabisa',
    summary: 'Lugha ya Salishan ya pwani ya British Columbia ambayo maneno yake yanaweza kuwa ya konsonanti pekee — matamshi mazima bila vokali hata moja.',
    body: `
  <p>Kwenye ghuba zenye milima za kati ya British Columbia, watu wachache wenye umri mkubwa bado huzungumza <strong>Nuxalk</strong> (pia inayoitwa <em>Bella Coola</em>), lugha ya Salishan ambayo fonolojia yake imewashangaza wanaisimu kwa zaidi ya nusu karne. Madai yake ya umaarufu: <strong>maneno yasiyokuwa na vokali kabisa</strong>.</p>

  <div class="trivia-actions">
    <button type="button" class="trivia-action" data-action="focus" data-code="blc" data-zoom="6">🌍 Onyesha Nuxalk kwenye ramani</button>
    <button type="button" class="trivia-action" data-action="panto" data-lat="52.40" data-lng="-126.75" data-zoom="6">🗺️ Ruka hadi bonde la Bella Coola</button>
  </div>

  <p>Mfano wa kitabu cha kufundisha, ulioripotiwa kwanza na <strong>Hank Nater</strong> katika sarufi yake ya 1984, ni:</p>
  ...
  <div class="trivia-actions">
    <button type="button" class="trivia-action" data-action="setword" data-word="water" data-code="blc">💧 Ona Nuxalk "maji" (qla)</button>
  ...
  'hawaiian-13-phonemes': {
    title: 'Kihawaii — sauti 13 tu, na uhuishaji wa kushangaza',
    summary: 'Kihawaii kina mojawapo ya orodha ndogo zaidi za fonimu duniani — sauti 13 tu — na mara moja kilikuwa kwenye ukingo wa kutoweka. Leo ni mojawapo ya uhuishaji uliofanikiwa zaidi wa lugha za asili kuwahi kurekodiwa.',
    body: `
  <p><strong>ʻŌlelo Hawaiʻi</strong> — lugha ya Kihawaii — ina mojawapo ya orodha ndogo zaidi za sauti za lugha yoyote inayoishi. <strong>Fonimu 13 tu</strong>: konsonanti 8 (<em>p, k, ʻ, h, m, n, l, w</em>) na vokali 5 (<em>a, e, i, o, u</em>), kila moja inaweza kuwa fupi au ndefu. Ndio hicho. Unaweza kujifunza alfabeti nzima, ikiwa ni pamoja na simamizi la koo <em>ʻokina</em> na alama ya vokali ndefu <em>kahakō</em>, katika alasiri moja.</p>

  <div class="trivia-actions">
    <button type="button" class="trivia-action" data-action="focus" data-code="haw" data-zoom="5">🌍 Onyesha Kihawaii kwenye ramani</button>
  </div>
  ...
  <div class="trivia-actions">
    ...
    <button type="button" class="trivia-action" data-action="setword" data-word="hello" data-code="haw">👋 Ona Kihawaii "Hujambo"</button>
  </div>

  <p>Kisha ulikuja mporomoko. <strong>Kupinduliwa kwa Ufalme wa Kihawaii kwa 1893</strong> na unyakuzi wa U.S. wa 1898 ulianzisha kizazi cha ukandamizaji wa kitamaduni. Mwaka 1896 Jamhuri ya Hawaiʻi ilipitisha <strong>Sheria ya 57</strong>, ikihitaji Kiingereza kama njia pekee ya mafundisho katika shule. Watoto waliokamatwa wakizungumza Kihawaii waliadhibiwa kimwili. Kufikia 1980, wasemaji wa asili chini ya 2,000 walibaki, karibu wote ni wazee. Wanaisimu walikiandika kama kinachofa.</p>

  <p>Kile kilichotokea baadaye ni mojawapo ya hadithi kubwa katika sociolinguistics ya kisasa. Wakichochewa na <em>Kōhanga Reo</em> ya Kimaori ("viota vya lugha") huko New Zealand, kikundi cha waelimishaji wakiwa ni pamoja na <strong>Larry Kimura</strong>, <strong>William H. "Pila" Wilson</strong>, na <strong>Kauanoe Kamanā</strong> walianzisha <strong>ʻAha Pūnana Leo</strong> mwaka 1983 — vikundi vya watoto wachanga vya Kihawaii pekee ambapo wazee walizungumza chochote isipokuwa Kihawaii kwa watoto wachanga. Mwaka 1986, marufuku ya miaka 90 ya kufundisha kwa lugha ya Kihawaii hatimaye ilifutwa. Kufikia 1987 shule za kwanza za umma za kuzama za Kihawaii <strong>Kula Kaiapuni</strong> zilifunguliwa. Chuo cha Chuo Kikuu cha Hawaiʻi cha Hilo cha <strong>Ka Haka ʻUla O Keʻelikōlani</strong> sasa kinatoa kazi za PhD zinazoendeshwa kabisa kwa Kihawaii — lugha ya kwanza ya asili katika Marekani kufikia kiwango hicho.</p>
  ...
  'nicaraguan-sign-language': {
    title: 'Lugha ya Ishara ya Nicaragua — lugha iliyozaliwa kwa wakati halisi',
    summary: 'Mojawapo ya kesi zilizoandikwa kwa kina zaidi za lugha mpya ya binadamu ya asili ikichukua sura kwa wakati halisi — iliibuka miongoni mwa watoto wa Nicaragua viziwi wakati hatimaye walipoletwa pamoja katika miaka ya 1970 na 80.',
    body: `
  <p>Fikiria kuwa mwanaisimu na kupata kuangalia lugha mpya ya binadamu ikichukua sura kwa wakati halisi — isiyo iliyoundwa kutoka kwa lugha ya kuzungumzwa iliyopo, bali iliyozalishwa na watoto katika kizazi kimoja, kwa sehemu kubwa kuanzia mifumo yao wenyewe ya ishara za nyumbani na ishara za mwili. Hivi ndivyo, kwa kiasi kikubwa, ilivyotokea Managua, Nicaragua, kati ya 1977 na mapema miaka ya 1990, ikizalisha kile tunachoita sasa <strong>Idioma de Señas de Nicaragua (ISN)</strong>, Lugha ya Ishara ya Nicaragua. Lugha zingine za ishara zilizoundwa hivi karibuni (Lugha ya Ishara ya Wabedui wa Al-Sayyid huko Israel, Kata Kolok huko Bali) zimechunguzwa tangu wakati huo, lakini ISN bado ni kesi iliyoandikwa kwa kina zaidi ya kujitokeza kwa kizazi baada ya kizazi.</p>

  <div class="trivia-actions">
    <button type="button" class="trivia-action" data-action="focus" data-code="ncs" data-zoom="7">🌍 Onyesha Lugha ya Ishara ya Nicaragua kwenye ramani</button>
    <button type="button" class="trivia-action" data-action="panto" data-lat="12.13" data-lng="-86.25" data-zoom="7">🗺️ Ruka hadi Managua</button>
  </div>

  <p>Kabla ya 1977, Wanicaragua viziwi walikuwa wametengwa. Kila familia ilibuni "<strong>ishara za nyumbani</strong>" zake — mifumo ndogo ya ishara za kibinafsi zilizotumika kati ya mtoto kiziwi na jamaa wa karibu — lakini nchi haikuwa na jamii ya viziwi, hakuna lugha ya ishara, na karibu hakuna elimu kwa watoto viziwi. Kisha, mwaka 1977, <strong>Centro Nacional de Educación Especial</strong> mpya ilifunguliwa huko Managua, ikifuatiwa na shule ya ufundi huko Villa Libertad mwaka 1981. Kwa mara ya kwanza, mamia ya watoto viziwi waliletwa pamoja kila siku.</p>

  <p>Shule zilifundisha katika Kihispania kinachozungumzwa na kusoma midomo na kuandika kwa vidole. Rasmi, kufanya ishara hakuhimizwa. Watoto, hata hivyo, walifanya kile wanadamu daima hufanya wanapolazimishwa katika ukaribu: <strong>walifanya mawasiliano</strong>. Kwenye uwanja wa michezo na kwenye mabasi ya shule, walichanganya ishara zao za nyumbani, walibuni mpya, na ndani ya miaka michache walikuwa wamejenga <strong>mfumo wa pidgin wa ishara</strong> wa pamoja, sasa unaitwa <em>Lenguaje de Signos Nicaragüense (LSN)</em>.</p>

  <p>Kisha ikaja mapinduzi. Wakati watoto wadogo zaidi — wa shule za awali na wa shule ya msingi ya mapema — waliingia katika mfumo katikati ya miaka ya 1980, walichukua pidgin ya watoto wakubwa kama mchango na kufanya jambo ambalo watoto pekee wanaweza kufanya: <strong>waliifanyia kisarufi</strong>. Waliongeza makubaliano ya kimwanya yenye uthabiti, mofolojia ya kitenzi, na alama za mazungumzo. Kufikia mapema miaka ya 1990, kundi la wadogo lilikuwa likifanya ishara katika lugha kamili ya kisarufi, kamili ya asili — ISN — ambayo kundi la wakubwa lingeweza kufuata kwa sehemu tu.</p>
  ...
  <div class="trivia-actions">
    <button type="button" class="trivia-action" data-action="compare" data-codes="ja,ko,zh,en,eu,ar,hi,sw" data-word="mother">🗣 Linganisha "mama" katika lugha 8 zisizohusiana</button>
  </div>
  ...
  <ul>
    ...
    <li>Proto-silabi za kwanza kabisa ambazo mtoto hufanya kwa hivyo ni <em>ma</em>, <em>pa</em>, <em>ba</em>, zikirudiwa: <em>mama</em>, <em>papa</em>, <em>baba</em>.</li>
    <li>Watu wazima wakisikia babbling hii hudhani kwamba mtoto anawazungumzia. Kwa kuwa mtu ambaye karibu daima yupo wakati mtoto anatamka ni mama yake, <em>mama</em> hupata tafsiri ya "mama". Baba, mbali zaidi kidogo katika utunzaji wa jadi, hupata <em>papa</em>.</li>
    <li>Watu wazima <strong>hutia nguvu</strong> babbling kwa kuijibu, kwa hivyo fomu <em>inashika</em> kama neno la kawaida katika lugha hiyo — hata kama hakuna kitu katika muundo wa lugha kilikihitaji.</li>
  </ul>

  <div class="trivia-actions">
    <button type="button" class="trivia-action" data-action="setword" data-word="mother" data-code="en">👩 Ona "mama" duniani kote</button>
    <button type="button" class="trivia-action" data-action="setword" data-word="father" data-code="en">👨 Ona "baba" duniani kote</button>
  </div>

  <p>Maelezo ya Jakobson huelezea kwa uzuri isipokuwa, pia. <strong>Kigeorgia</strong> hubadilisha jozi kwa umaarufu: <em>mama</em> inamaanisha "baba" na <em>deda</em> inamaanisha "mama". Hii si fedheha kwa nadharia — hoja ya Jakobson ilikuwa kwamba <em>mama</em> ni neno la kwanza rahisi zaidi, si kwamba lazima limaanishe "mama". Kigeorgia tu kiliambatisha fomu rahisi zaidi kwa marejeleo yasiyotarajiwa kidogo. Vivyo hivyo, katika <strong>Kijapani cha Kale</strong>, "mama" ilifaurudishwa kama <em>papa</em> (kisasa <em>haha</em>, na mabadiliko ya kawaida ya sauti /p/ → /h/), na "baba" alikuwa <em>titi</em>.</p>

  <p>Kwa hivyo wakati mtoto wa Kiingereza anasema <em>mama</em>, mtoto wa Kimandarin anasema <em>māma</em>, na mtoto wa Kiswahili anasema <em>mama</em>, hakuna babu wa pamoja unaohitajika. Urahisi sawa wa kutamka hukutana na mlezi sawa, na neno sawa linazaliwa — kwa kujitegemea, mara kwa mara, kuvuka kila bara la historia ya binadamu.</p>
    `
  },

  'pie-reconstruction': {
    title: 'Proto-Indo-Ulaya — lugha ambayo hakuna mtu alipata kuiandika',
    summary: 'Nusu ya idadi ya watu wa dunia husema mzao wa Proto-Indo-Ulaya — lugha iliyozungumzwa takriban miaka 6,000 iliyopita ambayo haikuacha maandiko. Wanaisimu wameijenga upya neno kwa neno wakitumia mbinu ya kulinganisha, na hata walitabiri sauti ambazo zilithibitishwa kuwa za kweli.',
    body: `
  ...
  <div class="trivia-actions">
    <button type="button" class="trivia-action" data-action="setword" data-word="father" data-code="en">👨 Ona "baba" kuvuka Indo-Ulaya</button>
    <button type="button" class="trivia-action" data-action="setword" data-word="water" data-code="en">💧 Ona Kiingereza "Maji"</button>
  </div>

  <p>Kisha unakuja wakati ambao, kwa wanaisimu wengi, ulisuluhisha swali la iwapo kujengwa upya ni sayansi halisi. Mwaka 1879, mwanaisimu mdogo wa Kiswisi <strong>Ferdinand de Saussure</strong> — miaka ishirini na moja na bado hajawa maarufu kama mwanzilishi wa semiotics ya kisasa — alichapisha <em>Mémoire sur le système primitif des voyelles dans les langues indo-européennes</em>. Kufanya ubadilishaji wa vokali za PIE kufanya kazi vizuri, alipendekeza kwamba PIE ilikuwa imekuwa na <em>coefficients sonantiques</em> za ajabu za ziada ambazo zilikuwa zimetoweka tangu hapo katika kila lugha ya binti inayojulikana — sauti ambazo sasa tunaita <strong>laryngeals</strong> (<em>*h₁, *h₂, *h₃</em>).</p>

  <blockquote>"Lazima ilikuwepo zamani katika Indo-Ulaya fonimu A ambayo haijaacha athari ya moja kwa moja katika lugha za kihistoria..." — Saussure, 1879</blockquote>

  <p>Ulikuwa upunguzaji wa kipaji wenye ushahidi sifuri wa moja kwa moja. Kwa karibu miaka hamsini, wanaisimu wengi wa Indo-Ulaya walidhani ilikuwa kubahatisha kwa neema. Kisha, mwaka 1915, msomi wa Czech Bedřich Hrozný alichakua <strong>Kihiti</strong> — lugha ya Indo-Ulaya kutoka Enzi ya Shaba ambayo ilikuwa imezikwa chini ya Anatolia kwa miaka elfu tatu. Kufikia 1927, mwanaisimu wa Kipolishi <strong>Jerzy Kuryłowicz</strong> aligundua kwamba Kihiti kilihifadhi konsonanti, iliyoandikwa <em>ḫ</em>, katika <strong>nafasi hasa ambazo Saussure alitabiri sauti yake iliyokosekana</strong>. Saussure alikuwa amekufa kwa miaka kumi na nne. Mazimwi yake yalikuwa ya kweli kuanzia mwanzo.</p>

  <p>Leo kujengwa upya kwa PIE kuna mizizi mia kadhaa iliyothibitishwa vyema, sarufi changamano yenye kesi nane na jinsia tatu, ubadilishaji wa ablaut, na hata mashairi yaliyojengwa upya — vifungu kama <em>*ḱléwos n̥dʰgʷʰitóm</em> "umaarufu usioharibika", uliothibitishwa katika Kigiriki cha Homer (<em>kléos áphthiton</em>) na Kisanskrit cha Kivedic (<em>śrávas ákṣitam</em>). Lugha ambayo hakuna mtu alipata kuiandika inaweza kuwa lugha isiyoandikwa iliyosomwa vyema zaidi katika historia.</p>
    `
  },
};
