...
window.TRIVIA_I18N['sw'] = {
  'piraha-no-numbers': {
    ...
    body: `
<p>Ndani kabisa ya msitu wa Amazoni wa Brazili, watu wasiozidi 800 husema <strong>Pirahã</strong> (hutamkwa takriban <em>pii-da-HAN</em>). Ni lugha pekee — bila ndugu wowote waliothibitishwa duniani — na imekuwa mojawapo ya kesi zinazobishaniwa zaidi katika isimu ya kisasa.</p>
