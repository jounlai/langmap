...
WORDS.chocolate = {
  ...
  data: {
    ...
    yua: ["chukwaʼ", "tʃukwaʔ"],
    wa: ["tchocolåt", "tʃokoˈlɔː"],
    lij: ["cicolâta", "tʃikuˈlaːta"],
    cbk: ["chocolate", "tʃokoˈlate"],
    szl: ["szekulada", "ʂɛkuˈlada"],
    ...
    mh: ["jọkleej", "tʲɑkʷleːtʲ"],
    pon: ["sokoled", "sokoled"],
    en_ck: ["chocolate", "ˈtʃɒklɪʔ"],
    vep: ["šokolad", "ˈʃokolad"],
    ppl: ["chukulat", "tʃukulat"],
    lld: ["cicolata", "tʃikoˈlata"],
    atj: ["kokocimiko", "kokoʃimiko"],
    zts: ["nax", "naʃ"],
