...
WORDS.head = {
  ...
  data: {
    ...
    ers: ["vili", "vi˧˧li˥˥"],
    ess: ["насӄуӄ", "nasquq"],
    crk: ["ᒥᐢᑎᒁᐣ", "mistikwaːn"],
    lad: ["kavesa", "kaˈvesa"],
    nhx: ["tzontecon", "tsontekon"],
    otq: ["ñä", "ɲã"],
    mxv: ["xini", "ʃini"],
    car: ["upuʼpo", "upuʔpo"],
    tiw: ["pungintaga", "puŋintaɡa"],
    ja_rys: ["頭", "tsɨburu"],
    eve: ["дыл", "dɨl"],
    stq: ["Haud", "haːu̯d"],
    frr: ["hood", "hoːd"],
    ...
    agu: ["wiʼaj", "wiʔah"],
    pbb: ["dxikthe", "dʒiktʰe"],
    aer: ["akaperte", "akapəʈə"],
    esu: ["nasquq", "nasquq"],
    cr: ["ᒥᐢᑎᒁᐣ", "mistikwaːn"],
    ker: ["cəərə", "tʃəːɾə"],
    atj: ["octikwaninan", "oʃtikwaninan"],
    pyu: ["tranguruʼ", "ʈaŋuɾuʔ"],
    zts: ["guëcy", "ɡəkʲ"],
    mix: ["xini", "ʃini"],
    deg: ["utom", "utom"],
    cho: ["nushkobo", "noʃkobo"],
    mus: ["ekv", "ikə"],
    huv: ["omal", "omal"],
    chf: ["pam", "pam"],
    djk: ["ede", "ede"],
