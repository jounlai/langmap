...
WORDS.honey = {
  ...
  data: {
    ...
    xmf: ["თოფური", "tʰopʰuri"],
    nci: ["neuctli", "nekʷtɬi"],
    nv: ["tsísʼná bitłʼizh", "tsísʔná bitɬʼiʒ"],
    new: ["कस्ति", "kʌsti"],
    nrf: ["mié", "mje"],
    nrf_gg: ["miel", "mjɛl"],
    fra_jer: ["myi", "mji"],
    ...
    ee: ["anyitsi", "aɲitsi"],
    gun: ["ei", "ei"],
    meu: ["bada ranuna", "bada ɾanuna"],
    pon: ["sukehn loangalap", "sukeːn lɔŋalap"],
    chk: ["chönün chunen", "tʃənɨn tʃunen"],
    izz: ["manụ ẹnwu", "manʊ ɛŋwu"],
    ig: ["mmanụ aṅụ", "mːanʊ aŋʊ"],
    ln: ["mafuta ya nzoi", "mafuta ja nzoi"],
    yao: ["uci", "utʃi"],
    kde: ["uchi", "utʃi"],
    ses: ["yuu", "juː"],
    wal: ["eessaa", "eːsːaː"],
    ...
    emp: ["urrajõ", "uraˈhõ"],
    emi: ["iruena", "iɾuena"],
    hot: ["bio thôk", "bio tʰɔk"],
    bzh: ["beggoh", "beɡːoh"],
    bzd: ["bulali", "bulali"],
    aau: ["eirpow-hu", "eiɾpow hu"],
    tcs: ["ani", "ani"],
    cuk: ["achanis", "atʃanis"],
    quc: ["kabʼ", "kaɓ"],
    cak: ["kabʼ", "kaɓ"],
    ...
    toj: ["chab", "tʃaɓ"],
    agu: ["kabʼ", "kaɓ"],
    mam: ["taʼl xiiʼ", "taʔl ʃiːʔ"],
    lg: ["omubisi gwʼenjuki", "omubisi ɡweɲdʒuki"],
    sms: ["miõtt", "miətː"],
    sma: ["hååneske", "hoːnɛskɛ"],
    sjd: ["мӣдт", "mʲiːdt"],
    yrk: ["мяв", "mʲaw"],
    ket: ["меʼт", "mʲɛʔt"],
    gld: ["киаксо", "kiaksɔ"],
    ...
    kpj: ["bidi", "bədi"],
    kgp: ["mỹg", "mɨ̃ŋ"],
    shp: ["bona jene", "bona hene"],
    tue: ["bũbĩã oko", "bũbĩã oko"],
    tpy: ["aus tsʔa", "aus tsʔa"],
    crt: ["wonateʔ", "wonateʔ"],
    jup: ["nǽŋ", "nǽŋ"],
    kr: ["kəmagən", "kəmaɡən"],
    arn: ["müski", "mɨski"],
    ...
    udi: ["уч̍", "utʃʼ"],
    bm: ["li", "li"],
    acf: ["siwo myèl", "siwo mjɛl"],
    agr: ["dapa yumiji", "dapa jumihi"],
    aii: ["ܕܸܒ݂ܫܵܐ", "dɪwʃa"],
    bgc: ["शहद", "ʃəɦəd"],
    ch: ["miet", "miet"],
    dyu: ["li", "li"],
    ...
    hns: ["madh", "madʱ"],
    lbj: ["རང་རྩི", "raŋ tsi"],
    luo: ["mor kich", "mor kitʃ"],
    mai: ["मधु", "mədʱu"],
    mic: ["amuapu", "amuabu"],
    mni: ["ꯈꯣꯏꯍꯤ", "kʰoihi"],
    nag: ["mou pani", "mou pani"],
    otq: ["tꞌafi", "tʔafi"],
    pcm: ["honey", "hɔni"],
    pmy: ["madu", "ˈmadu"],
    rom: ["avdžin", "avdʒin"],
    ...
    chr: ["ᏩᏚᎵᏏ", "wadulisi"],
    dz: ["སྦྱང", "bjaŋ"],
    kl: ["tungusunnitsuut", "tuŋusunːitsuːt"],
    abq: ["цха", "tsʰχa"],
    bal: ["شہد", "ʃahad"],
    kok: ["मोवु", "moʋu"],
    mas: ["enaisho", "enaiʃo"],
    tyv: ["ары чигири", "arɯ tɕiɡiri"],
    kjh: ["мӧӧт", "møːt"],
    eve: ["мёд", "mʲod"],
    ess: ["ӄуӷля", "quɣlʲa"],
    xsr: ["སྦྲང", "raŋ"],
    bik: ["tangguli", "taŋɡuli"],
    ofs: ["hunich", "ˈhunix"],
    ...
    bjn: ["madu", "madu"],
    mak: ["jeʼneʼ bani", "dʒeʔneʔ bani"],
    ii: ["ꐚꒉ", "dʑi˧˧ʑɿ˧˧"],
    hmn: ["zib", "ʒi˥"],
    kru: ["तिनी रसी", "tiniː ɾasiː"],
    doi: ["शैहद", "ʃɛːɦəd"],
    kfy: ["मौ", "mɔu"],
    jam: ["oni", "ɔni"],
    dje: ["yu", "ju"],
    ...
    ksw: ["ကနဲစီ", "kanɛsɔ"],
    pwo: ["န့ၫစၩ့", "nɪ saɴ"],
    hni: ["biaqqul", "bja˧˩tɕʰu˥˥"],
    khg: ["སྦྲང་རྩི", "dʐaŋtsi"],
    abs: ["madu", "madu"],
    max: ["madu", "madu"],
    kha: ["ka ngap", "ka ŋap"],
    ve: ["mutoli", "mutoli"],
    ...
    drs: ["malebo", "malebo"],
    tmh: ["ⵜⵓⵔⴰⵡⵜ", "torawət"],
    gor: ["hula lo tiiʼa", "hula lo tiːʔa"],
    ljp: ["madu", "madu"],
    unr: ["hurum suku", "hurum suku"],
    hoc: ["hurum suku", "hurum suku"],
    grt: ["bija bitchi", "bidʒa bitʃi"],
    mnw: ["ဍာ်သာဲ", "ɗaʔ sai"],
    mtq: ["mêch ong", "mec ɔŋ"],
    ...
    aoz: ["oni", "oni"],
    nia: ["we wani", "we wani"],
    akb: ["aer ni loba", "aer ni loba"],
    kac: ["lagat ntsin", "ləkat˧˩ n̩tsin˧"],
    dtp: ["pahaʼ", "pahaʔ"],
    tji: ["cece", "tsʰe˧˥tsʰe˥˥"],
    sda: ["taniʼ enoan", "taniʔ enoan"],
    tzh: ["chab", "tʃab"],
    mixtec: ["nduxi", "nduʃi"],
    quy: ["miski", "miski"],
    dty: ["मह", "məɦ"],
    ...
    jiv: ["chinij", "tʃinih"],
    tkl: ["meli", "meli"],
    crk: ["ᐋᒧᐤ ᒣᔨ", "aːmow meːji"],
    nhx: ["necti", "nekti"],
    mxv: ["ñuñu", "ɲuɲu"],
    tiw: ["yingwati", "jiŋwati"],
    ekp: ["oga ogbenyi", "ɔɡa ɔɡbɛɲɨ"],
    bbo: ["yaarɩŋun", "jaːrɪŋun"],
    mzh: ["akäyek", "akɑjek"],
    arp: ["koohóʼokuukóúhuyooʼ", "koːhóʔokuːkóúhujoːʔ"],
    tar: ["amoo", "amoo"],
    tsu: ["sʉhsʉ", "səxsə"],
    pwn: ["alju", "aɭu"],
    cng: ["bəχʂ", "bəχʂ"],
