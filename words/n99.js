...
WORDS.n99 = {
  ...
  data: {
    ...
    ar_sy: ["تسعة وتسعون", "tisʕa wa tisʕuːn"],
    ar_lb: ["تسعة وتسعون", "tisʕa wa tisʕuːn"],
    ar_jo: ["تسعة وتسعون", "tisʕa wa tisʕuːn"],
    ar_ps: ["تسعة وتسعون", "tisʕa wa tisʕuːn"],
    ar_ye: ["تسعة وتسعون", "tisʕa wa tisʕuːn"],
    ar_sa: ["تسعة وتسعون", "tisʕa wa tisʕuːn"],
    ar_gulf: ["تسعة وتسعون", "tisʕa wa tisʕuːn"],
    ar_iq: ["تسعة وتسعون", "tisʕa wa tisʕuːn"],
    abv: ["تسعة وتسعون", "tisʕa wa tisʕuːn"],
    afb: ["تسعة وتسعون", "tisʕa wa tisʕuːn"],
    acw: ["تسعة وتسعون", "tisʕa wa tisʕuːn"],
    ...
    ayl: ["تسعة وتسعون", "tisʕa wa tisʕuːn"],
    ...
    en_za: ["ninety-nine", "ˈnaɪnti ˈnaɪn"],
    ...
    en_south: ["ninety-nine", "ˈnaɪnti ˈnaɪn"],
